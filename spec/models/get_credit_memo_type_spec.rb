...
# Unit tests for SwaggerClient::GETCreditMemoType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETCreditMemoType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETCreditMemoType.new
  end
  ...
  describe 'test an instance of GETCreditMemoType' do
    it 'should create an instance of GETCreditMemoType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETCreditMemoType)
    end
  end
