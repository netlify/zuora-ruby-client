...
# Unit tests for SwaggerClient::PUTSubscriptionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSubscriptionType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSubscriptionType.new
  end
  ...
  describe 'test an instance of PUTSubscriptionType' do
    it 'should create an instance of PUTSubscriptionType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSubscriptionType)
    end
  end
  ...
  describe 'test attribute "include_existing_draft_doc_items"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "include_existing_draft_invoice_items"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
