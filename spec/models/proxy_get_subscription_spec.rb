...
# Unit tests for SwaggerClient::ProxyGetSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetSubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetSubscription.new
  end
  ...
  describe 'test an instance of ProxyGetSubscription' do
    it 'should create an instance of ProxyGetSubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetSubscription)
    end
  end
