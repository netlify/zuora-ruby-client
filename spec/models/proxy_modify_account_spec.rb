...
# Unit tests for SwaggerClient::ProxyModifyAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyAccount.new
  end
  ...
  describe 'test an instance of ProxyModifyAccount' do
    it 'should create an instance of ProxyModifyAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyAccount)
    end
  end
