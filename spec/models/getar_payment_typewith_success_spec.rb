...
# Unit tests for Zuora::GETARPaymentTypewithSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETARPaymentTypewithSuccess' do
  before do
    # run before each test
    @instance = Zuora::GETARPaymentTypewithSuccess.new
  end
  ...
  describe 'test an instance of GETARPaymentTypewithSuccess' do
    it 'should create an instance of GETARPaymentTypewithSuccess' do
      expect(@instance).to be_instance_of(Zuora::GETARPaymentTypewithSuccess)
    end
  end
