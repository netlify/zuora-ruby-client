...
# Unit tests for SwaggerClient::ProxyGetPaymentMethodSnapshot
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetPaymentMethodSnapshot' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetPaymentMethodSnapshot.new
  end
  ...
  describe 'test an instance of ProxyGetPaymentMethodSnapshot' do
    it 'should create an instance of ProxyGetPaymentMethodSnapshot' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetPaymentMethodSnapshot)
    end
  end
