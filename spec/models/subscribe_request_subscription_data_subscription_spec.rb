...
# Unit tests for Zuora::SubscribeRequestSubscriptionDataSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscribeRequestSubscriptionDataSubscription' do
  before do
    # run before each test
    @instance = Zuora::SubscribeRequestSubscriptionDataSubscription.new
  end
  ...
  describe 'test an instance of SubscribeRequestSubscriptionDataSubscription' do
    it 'should create an instance of SubscribeRequestSubscriptionDataSubscription' do
      expect(@instance).to be_instance_of(Zuora::SubscribeRequestSubscriptionDataSubscription)
    end
  end
