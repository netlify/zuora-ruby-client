...
# Unit tests for SwaggerClient::ProxyGetRefund
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRefund' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRefund.new
  end
  ...
  describe 'test an instance of ProxyGetRefund' do
    it 'should create an instance of ProxyGetRefund' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRefund)
    end
  end
