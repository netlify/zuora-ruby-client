...
# Unit tests for SwaggerClient::POSTAccountType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountType.new
  end
  ...
  describe 'test an instance of POSTAccountType' do
    it 'should create an instance of POSTAccountType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountType)
    end
  end
  ...
  describe 'test attribute "hpm_credit_card_payment_method_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sold_to_contact"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
