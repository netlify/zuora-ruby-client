...
# Unit tests for SwaggerClient::POSTScCreateType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTScCreateType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTScCreateType.new
  end
  ...
  describe 'test an instance of POSTScCreateType' do
    it 'should create an instance of POSTScCreateType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTScCreateType)
    end
  end
