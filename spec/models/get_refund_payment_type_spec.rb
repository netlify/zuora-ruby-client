...
# Unit tests for SwaggerClient::GETRefundPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRefundPaymentType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRefundPaymentType.new
  end
  ...
  describe 'test an instance of GETRefundPaymentType' do
    it 'should create an instance of GETRefundPaymentType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRefundPaymentType)
    end
  end
