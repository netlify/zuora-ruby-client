...
# Unit tests for SwaggerClient::ProxyModifyPaymentMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyPaymentMethod' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyPaymentMethod.new
  end
  ...
  describe 'test an instance of ProxyModifyPaymentMethod' do
    it 'should create an instance of ProxyModifyPaymentMethod' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyPaymentMethod)
    end
  end
