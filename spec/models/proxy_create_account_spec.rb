...
# Unit tests for SwaggerClient::ProxyCreateAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateAccount.new
  end
  ...
  describe 'test an instance of ProxyCreateAccount' do
    it 'should create an instance of ProxyCreateAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateAccount)
    end
  end
