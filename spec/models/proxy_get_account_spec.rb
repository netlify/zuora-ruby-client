...
# Unit tests for SwaggerClient::ProxyGetAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetAccount.new
  end
  ...
  describe 'test an instance of ProxyGetAccount' do
    it 'should create an instance of ProxyGetAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetAccount)
    end
  end
