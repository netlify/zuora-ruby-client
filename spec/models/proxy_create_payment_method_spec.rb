...
# Unit tests for SwaggerClient::ProxyCreatePaymentMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreatePaymentMethod' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreatePaymentMethod.new
  end
  ...
  describe 'test an instance of ProxyCreatePaymentMethod' do
    it 'should create an instance of ProxyCreatePaymentMethod' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreatePaymentMethod)
    end
  end
