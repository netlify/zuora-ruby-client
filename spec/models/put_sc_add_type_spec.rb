...
# Unit tests for SwaggerClient::PUTScAddType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTScAddType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTScAddType.new
  end
  ...
  describe 'test an instance of PUTScAddType' do
    it 'should create an instance of PUTScAddType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTScAddType)
    end
  end
