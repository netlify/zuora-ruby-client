...
# Unit tests for SwaggerClient::GETSubscriptionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETSubscriptionType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETSubscriptionType.new
  end
  ...
  describe 'test an instance of GETSubscriptionType' do
    it 'should create an instance of GETSubscriptionType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETSubscriptionType)
    end
  end
