...
# Unit tests for SwaggerClient::ProxyGetInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetInvoice' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetInvoice.new
  end
  ...
  describe 'test an instance of ProxyGetInvoice' do
    it 'should create an instance of ProxyGetInvoice' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetInvoice)
    end
  end
