...
# Unit tests for Zuora::ProxyGetPayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetPayment' do
  before do
    # run before each test
    @instance = Zuora::ProxyGetPayment.new
  end
  ...
  describe 'test an instance of ProxyGetPayment' do
    it 'should create an instance of ProxyGetPayment' do
      expect(@instance).to be_instance_of(Zuora::ProxyGetPayment)
    end
  end
  ...
  describe 'test attribute "transferred_to_accounting"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Processing", "Yes", "Error", "Ignore"])
      # validator.allowable_values.each do |value|
