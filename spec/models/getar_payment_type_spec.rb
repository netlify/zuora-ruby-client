...
# Unit tests for SwaggerClient::GETARPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETARPaymentType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETARPaymentType.new
  end
  ...
  describe 'test an instance of GETARPaymentType' do
    it 'should create an instance of GETARPaymentType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETARPaymentType)
    end
  end
