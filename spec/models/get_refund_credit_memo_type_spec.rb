...
# Unit tests for SwaggerClient::GETRefundCreditMemoType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRefundCreditMemoType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRefundCreditMemoType.new
  end
  ...
  describe 'test an instance of GETRefundCreditMemoType' do
    it 'should create an instance of GETRefundCreditMemoType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRefundCreditMemoType)
    end
  end
