...
# Unit tests for SwaggerClient::ProxyGetRatePlanCharge
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRatePlanCharge' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRatePlanCharge.new
  end
  ...
  describe 'test an instance of ProxyGetRatePlanCharge' do
    it 'should create an instance of ProxyGetRatePlanCharge' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRatePlanCharge)
    end
  end
