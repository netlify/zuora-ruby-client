...
# Unit tests for SwaggerClient::ProxyGetPaymentMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetPaymentMethod' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetPaymentMethod.new
  end
  ...
  describe 'test an instance of ProxyGetPaymentMethod' do
    it 'should create an instance of ProxyGetPaymentMethod' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetPaymentMethod)
    end
  end
