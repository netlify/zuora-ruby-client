...
module Zuora
  class POSTScCreateType
    ...
    # Number of units. Must be a decimal >=`0`.   When using `chargeOverrides` for creating subscriptions with recurring charge types, the `quantity` field must be populated. This applies when the charge model is \"Tiered Pricing\" or \"Volume Pricing\". 
