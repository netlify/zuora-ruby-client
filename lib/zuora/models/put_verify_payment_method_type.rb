...
module Zuora
  ...
  class PUTVerifyPaymentMethodType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gatewayOptions')
        self.gateway_options = attributes[:'gatewayOptions']
      end

      if attributes.has_key?(:'paymentGatewayName')
        self.payment_gateway_name = attributes[:'paymentGatewayName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          gateway_options == o.gateway_options &&
          payment_gateway_name == o.payment_gateway_name &&
    ...
    def hash
      [gateway_options, payment_gateway_name, security_code].hash
    end
