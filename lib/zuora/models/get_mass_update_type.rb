...
module Zuora
  class GETMassUpdateType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inputSize')
        self.input_size = attributes[:'inputSize']
      end

      if attributes.has_key?(:'outputSize')
        self.output_size = attributes[:'outputSize']
      end
      ...
      if attributes.has_key?(:'processedCount')
        self.processed_count = attributes[:'processedCount']
      end
    ...
    def hash
      [action_type, ended_on, error_count, input_size, output_size, output_type, output_url, processed_count, started_on, status, success, success_count, total_count, uploaded_by, uploaded_on].hash
    end
