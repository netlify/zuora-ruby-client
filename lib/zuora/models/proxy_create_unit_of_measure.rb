...
module Zuora
  ...
  class ProxyCreateUnitOfMeasure
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DisplayedAs')
        self.displayed_as = attributes[:'DisplayedAs']
      end

      if attributes.has_key?(:'RoundingMode')
        self.rounding_mode = attributes[:'RoundingMode']
      end

      if attributes.has_key?(:'UomName')
        self.uom_name = attributes[:'UomName']
      end
    ...
    def list_invalid_properties
      ...
      if @decimal_places.nil?
        invalid_properties.push("invalid value for 'decimal_places', decimal_places cannot be nil.")
      end

      if @uom_name.nil?
        invalid_properties.push("invalid value for 'uom_name', uom_name cannot be nil.")
      end
    ...
    def valid?
      return false if @decimal_places.nil?
      return false if @uom_name.nil?
      return true
    end
    ...
    def hash
      [active, decimal_places, displayed_as, rounding_mode, uom_name].hash
    end
