...
module Zuora
  ...
  class GETJournalRunType
    ...
    attr_accessor :segmentation_rule_name
    ...
    attr_accessor :target_end_date

    # The target start date of the journal run. 
    attr_accessor :target_start_date

    # Total number of journal entries in the journal run. 
    attr_accessor :total_journal_entry_count
    ...
    def self.swagger_types
      {
        ...
        :'total_journal_entry_count' => :'Integer',
        :'transaction_types' => :'Array<GETJournalRunTransactionType>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'segmentationRuleName')
        self.segmentation_rule_name = attributes[:'segmentationRuleName']
      end
      ...
      if attributes.has_key?(:'targetEndDate')
        self.target_end_date = attributes[:'targetEndDate']
      end

      if attributes.has_key?(:'targetStartDate')
        self.target_start_date = attributes[:'targetStartDate']
      end

      if attributes.has_key?(:'totalJournalEntryCount')
        self.total_journal_entry_count = attributes[:'totalJournalEntryCount']
      end

      if attributes.has_key?(:'transactionTypes')
        if (value = attributes[:'transactionTypes']).is_a?(Array)
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["Pending", "Processing", "Completed", "Error", "CancelInprogress", "Cancelled", "DeleteInprogress"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Pending", "Processing", "Completed", "Error", "CancelInprogress", "Cancelled", "DeleteInprogress"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number == o.number &&
          segmentation_rule_name == o.segmentation_rule_name &&
          status == o.status &&
          success == o.success &&
          target_end_date == o.target_end_date &&
          target_start_date == o.target_start_date &&
          total_journal_entry_count == o.total_journal_entry_count &&
    ...
    def hash
      [aggregate_currency, executed_on, journal_entry_date, number, segmentation_rule_name, status, success, target_end_date, target_start_date, total_journal_entry_count, transaction_types].hash
    end
