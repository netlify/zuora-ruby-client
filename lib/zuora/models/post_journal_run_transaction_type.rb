...
module Zuora
  class POSTJournalRunTransactionType
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['Invoice Item', 'Taxation Item', 'Invoice Item Adjustment (Invoice)', 'Invoice Item Adjustment (tax)', 'Invoice Adjustment', 'Electronic Payment', 'External Payment', 'Electronic Refund', 'External Refund', 'Electronic Credit Balance Payment', 'External Credit Balance Payment', 'Electronic Credit Balance Refund', 'External Credit Balance Refund', 'Credit Balance Adjustment (Applied from Credit Balance)', 'Credit Balance Adjustment (Transferred to Credit Balance)', 'Revenue Event Item', 'Debit Memo Item (Charge)', 'Debit Memo Item (tax)', 'Credit Memo Item (Charge)', 'Credit Memo Item (tax)', 'Credit Memo Application Item', 'Electronic Payment Application', 'External Payment Application', 'Electronic Refund Application', 'External Refund Application', 'Electronic Payment Application Item', 'External Payment Application Item', 'Electronic Refund Application Item', 'External Refund Application Item'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['Invoice Item', 'Taxation Item', 'Invoice Item Adjustment (Invoice)', 'Invoice Item Adjustment (tax)', 'Invoice Adjustment', 'Electronic Payment', 'External Payment', 'Electronic Refund', 'External Refund', 'Electronic Credit Balance Payment', 'External Credit Balance Payment', 'Electronic Credit Balance Refund', 'External Credit Balance Refund', 'Credit Balance Adjustment (Applied from Credit Balance)', 'Credit Balance Adjustment (Transferred to Credit Balance)', 'Revenue Event Item', 'Debit Memo Item (Charge)', 'Debit Memo Item (tax)', 'Credit Memo Item (Charge)', 'Credit Memo Item (tax)', 'Credit Memo Application Item', 'Electronic Payment Application', 'External Payment Application', 'Electronic Refund Application', 'External Refund Application', 'Electronic Payment Application Item', 'External Payment Application Item', 'Electronic Refund Application Item', 'External Refund Application Item'])
