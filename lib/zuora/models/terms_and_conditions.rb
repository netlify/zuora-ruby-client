...
module Zuora
  # The JSON object containing the information related to the 'TermsAndConditions' type of request.
  class TermsAndConditions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastTerm')
        self.last_term = attributes[:'lastTerm']
      end
    ...
    def hash
      [auto_renew, last_term, renewal_setting, renewal_terms].hash
    end
