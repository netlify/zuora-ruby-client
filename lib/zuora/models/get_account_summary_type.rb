...
module Zuora
  class GETAccountSummaryType
    ...
    def self.swagger_types
      {
        ...
        :'invoices' => :'Array<GETAccountSummaryInvoiceType>',
        :'payments' => :'Array<GETAccountSummaryPaymentType>',
        :'sold_to_contact' => :'GETAccountSummaryTypeSoldToContact',
        :'subscriptions' => :'Array<GETAccountSummarySubscriptionType>',
        :'success' => :'BOOLEAN',
        :'tax_info' => :'GETAccountSummaryTypeTaxInfo',
        :'usage' => :'Array<GETAccountSummaryUsageType>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'basicInfo')
        self.basic_info = attributes[:'basicInfo']
      end
    ...
    def hash
      [basic_info, bill_to_contact, invoices, payments, sold_to_contact, subscriptions, success, tax_info, usage].hash
    end
