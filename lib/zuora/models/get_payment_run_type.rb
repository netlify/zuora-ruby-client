...
module Zuora
  class GETPaymentRunType
    ...
    # **Note:** This field is only available if you have the Credit Balance feature enabled and the Advanced AR Settlement feature disabled.  Whether to apply credit balances in the payment run. This field is only available when you have Advanced AR Settlement feature disabled. 
    attr_accessor :apply_credit_balance

    # **Note:** The Advanced AR Settlement feature is in **Limited Availability**. This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Whether to automatically apply a posted credit memo to one or more receivables in the payment run. 
    attr_accessor :auto_apply_credit_memo
    ...
    attr_accessor :auto_apply_unapplied_payment
    ...
    attr_accessor :process_payment_with_closed_pm
    ...
    def self.swagger_types
      {
        ...
        :'auto_apply_credit_memo' => :'BOOLEAN',
        :'auto_apply_unapplied_payment' => :'BOOLEAN',
        :'batch' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'autoApplyCreditMemo')
        self.auto_apply_credit_memo = attributes[:'autoApplyCreditMemo']
      end

      if attributes.has_key?(:'autoApplyUnappliedPayment')
        self.auto_apply_unapplied_payment = attributes[:'autoApplyUnappliedPayment']
      end
      ...
      if attributes.has_key?(:'billingRunId')
        self.billing_run_id = attributes[:'billingRunId']
      end
      ...
      if attributes.has_key?(:'consolidatedPayment')
        self.consolidated_payment = attributes[:'consolidatedPayment']
      end
      ...
      if attributes.has_key?(:'executedOn')
        self.executed_on = attributes[:'executedOn']
      end
      ...
      if attributes.has_key?(:'paymentGatewayId')
        self.payment_gateway_id = attributes[:'paymentGatewayId']
      end

      if attributes.has_key?(:'processPaymentWithClosedPM')
        self.process_payment_with_closed_pm = attributes[:'processPaymentWithClosedPM']
      end

      if attributes.has_key?(:'runDate')
        self.run_date = attributes[:'runDate']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['Pending', 'Processing', 'Completed', 'Error', 'Canceled'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['Pending', 'Processing', 'Completed', 'Error', 'Canceled'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_apply_credit_memo == o.auto_apply_credit_memo &&
          auto_apply_unapplied_payment == o.auto_apply_unapplied_payment &&
          batch == o.batch &&
          bill_cycle_day == o.bill_cycle_day &&
          billing_run_id == o.billing_run_id &&
          completed_on == o.completed_on &&
          consolidated_payment == o.consolidated_payment &&
          ...
          process_payment_with_closed_pm == o.process_payment_with_closed_pm &&
          run_date == o.run_date &&
          status == o.status &&
          success == o.success &&
    ...
    def hash
      [account_id, apply_credit_balance, auto_apply_credit_memo, auto_apply_unapplied_payment, batch, bill_cycle_day, billing_run_id, completed_on, consolidated_payment, created_by_id, created_date, currency, executed_on, id, number, payment_gateway_id, process_payment_with_closed_pm, run_date, status, success, target_date, updated_by_id, updated_date].hash
    end
