...
module Zuora
  class RatePlan
    ...
    attr_accessor :amendment_subscription_rate_plan_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AmendmentSubscriptionRatePlanId')
        self.amendment_subscription_rate_plan_id = attributes[:'AmendmentSubscriptionRatePlanId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amendment_subscription_rate_plan_id == o.amendment_subscription_rate_plan_id &&
    ...
    def hash
      [amendment_id, amendment_subscription_rate_plan_id, amendment_type, created_by_id, created_date, name, product_rate_plan_id, subscription_id, updated_by_id, updated_date].hash
    end
