...
module Zuora
  class ProxyModifyTaxationItem
    ...
    def hash
      [accounting_code, exempt_amount, jurisdiction, location_code, name, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type].hash
    end
