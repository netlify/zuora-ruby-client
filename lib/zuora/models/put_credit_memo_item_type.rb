...
module Zuora
  class PUTCreditMemoItemType
    ...
    def self.swagger_types
      {
        ...
        :'sku_name' => :'String',
        :'tax_items' => :'Array<PutCreditMemoTaxItemType>',
    ...
    def hash
      [amount, comment, custom_field__c, finance_information, id, service_end_date, service_start_date, sku_name, tax_items, unit_of_measure].hash
    end
