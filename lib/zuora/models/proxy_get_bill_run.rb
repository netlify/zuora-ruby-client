...
module Zuora
  class ProxyGetBillRun
    ...
    attr_accessor :no_email_for_zero_amount_invoice
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'invoice_date' => :'Date',
        :'invoices_emailed' => :'BOOLEAN',
        :'last_email_sent_time' => :'DateTime',
        :'no_email_for_zero_amount_invoice' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AutoEmail')
        self.auto_email = attributes[:'AutoEmail']
      end

      if attributes.has_key?(:'AutoPost')
        self.auto_post = attributes[:'AutoPost']
      end

      if attributes.has_key?(:'AutoRenewal')
        self.auto_renewal = attributes[:'AutoRenewal']
      end
      ...
      if attributes.has_key?(:'BillRunNumber')
        self.bill_run_number = attributes[:'BillRunNumber']
      end
      ...
      if attributes.has_key?(:'ExecutedDate')
        self.executed_date = attributes[:'ExecutedDate']
      end
      ...
      if attributes.has_key?(:'InvoicesEmailed')
        self.invoices_emailed = attributes[:'InvoicesEmailed']
      end

      if attributes.has_key?(:'LastEmailSentTime')
        self.last_email_sent_time = attributes[:'LastEmailSentTime']
      end

      if attributes.has_key?(:'NoEmailForZeroAmountInvoice')
        self.no_email_for_zero_amount_invoice = attributes[:'NoEmailForZeroAmountInvoice']
      end

      if attributes.has_key?(:'NumberOfAccounts')
        self.number_of_accounts = attributes[:'NumberOfAccounts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_email == o.auto_email &&
          auto_post == o.auto_post &&
          auto_renewal == o.auto_renewal &&
          batch == o.batch &&
          bill_cycle_day == o.bill_cycle_day &&
          bill_run_number == o.bill_run_number &&
          created_by_id == o.created_by_id &&
          created_date == o.created_date &&
          executed_date == o.executed_date &&
          id == o.id &&
          invoice_date == o.invoice_date &&
          invoices_emailed == o.invoices_emailed &&
          last_email_sent_time == o.last_email_sent_time &&
          no_email_for_zero_amount_invoice == o.no_email_for_zero_amount_invoice &&
          number_of_accounts == o.number_of_accounts &&
    ...
    def hash
      [account_id, auto_email, auto_post, auto_renewal, batch, bill_cycle_day, bill_run_number, created_by_id, created_date, executed_date, id, invoice_date, invoices_emailed, last_email_sent_time, no_email_for_zero_amount_invoice, number_of_accounts, number_of_invoices, status, target_date, updated_by_id, updated_date].hash
    end
