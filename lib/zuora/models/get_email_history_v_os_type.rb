...
module Zuora
  ...
  class GETEmailHistoryVOsType
    ...
    def self.swagger_types
      {
        :'email_histories' => :'Array<GETEmailHistoryVOType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emailHistories')
        if (value = attributes[:'emailHistories']).is_a?(Array)
    ...
    def hash
      [email_histories, next_page, success].hash
    end
