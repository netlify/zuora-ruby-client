...
module Zuora
  ...
  class POSTJournalRunResponseType
    # Journal run number. 
    attr_accessor :journal_run_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'journalRunNumber')
        self.journal_run_number = attributes[:'journalRunNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          journal_run_number == o.journal_run_number &&
          success == o.success
    end
    ...
    def hash
      [journal_run_number, success].hash
    end
