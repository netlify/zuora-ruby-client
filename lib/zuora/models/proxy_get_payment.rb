...
module Zuora
  class ProxyGetPayment
    ...
    def valid?
      ...
      source_validator = EnumAttributeValidator.new('String', ['PaymentRun', 'Import', 'Manually', 'API'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ['PaymentRun', 'Import', 'Manually', 'API'])
    ...
    def hash
      [account_id, accounting_code, amount, applied_credit_balance_amount, auth_transaction_id, bank_identification_number, cancelled_on, comment, created_by_id, created_date, effective_date, gateway, gateway_order_id, gateway_response, gateway_response_code, gateway_state, id, marked_for_submission_on, payment_method_id, payment_method_snapshot_id, payment_number, reference_id, refund_amount, second_payment_reference_id, settled_on, soft_descriptor, soft_descriptor_phone, source, source_name, status, submitted_on, transferred_to_accounting, type, updated_by_id, updated_date].hash
    end
