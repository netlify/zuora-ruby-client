...
module Zuora
  class GETRevenueEventDetailType
    ...
    def hash
      [account_id, created_on, currency, custom_field__c, event_type, notes, number, recognition_end, recognition_start, revenue_items, subscription_charge_id, subscription_id, success].hash
    end
