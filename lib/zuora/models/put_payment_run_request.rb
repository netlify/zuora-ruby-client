...
module Zuora
  class PUTPaymentRunRequest
    ...
    def hash
      [account_id, apply_credit_balance, auto_apply_credit_memo, auto_apply_unapplied_payment, batch, bill_cycle_day, billing_run_id, consolidated_payment, currency, payment_gateway_id, process_payment_with_closed_pm, run_date, target_date].hash
    end
