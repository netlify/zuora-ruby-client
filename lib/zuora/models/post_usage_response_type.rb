...
module Zuora
  ...
  class POSTUsageResponseType
    ...
    attr_accessor :check_import_status
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'checkImportStatus')
        self.check_import_status = attributes[:'checkImportStatus']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          check_import_status == o.check_import_status &&
          size == o.size &&
          success == o.success
    end
    ...
    def hash
      [check_import_status, size, success].hash
    end
