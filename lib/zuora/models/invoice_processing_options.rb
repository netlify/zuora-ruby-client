...
module Zuora
  ...
  class InvoiceProcessingOptions
    ...
    def list_invalid_properties
      ...
      if @invoice_target_date.nil?
        invalid_properties.push("invalid value for 'invoice_target_date', invoice_target_date cannot be nil.")
      end
    ...
    def valid?
      return false if @invoice_target_date.nil?
      return true
    end
    ...
    def hash
      [invoice_date, invoice_target_date].hash
    end
