...
module Zuora
  class GetRatedUsageResultsType
    # The number of data sets in the returned page of the response.  
    attr_accessor :count

    # The cursor indicator of the next page of data.    Pass the value of this field in as the `cursor` parameter for a subsequent call to get the next page of data. If there is no data after the current page, the cursor returns null.  
    ...
    def self.swagger_types
      {
        :'count' => :'Integer',
        :'cursor' => :'String',
        :'data_set' => :'Array<GetARatedUsageResultType>',
        :'has_more' => :'BOOLEAN'
      }
    end
