...
module Zuora
  class SubscribeRequest
    ...
    attr_accessor :subscribe_options
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SubscribeOptions')
        self.subscribe_options = attributes[:'SubscribeOptions']
      end

      if attributes.has_key?(:'SubscriptionData')
        self.subscription_data = attributes[:'SubscriptionData']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @subscription_data.nil?
        invalid_properties.push('invalid value for "subscription_data", subscription_data cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscribe_options == o.subscribe_options &&
    ...
    def hash
      [account, bill_to_contact, payment_method, preview_options, sold_to_contact, subscribe_options, subscription_data].hash
    end
