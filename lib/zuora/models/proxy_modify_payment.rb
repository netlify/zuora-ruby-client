...
module Zuora
  class ProxyModifyPayment
    ...
    def list_invalid_properties
      ...
      if !@account_id.nil? && @account_id.to_s.length > 32
    ...
    def valid?
      return false if !@account_id.nil? && @account_id.to_s.length > 32
      ...
      return false if !@payment_method_id.nil? && @payment_method_id.to_s.length > 32
      return false if !@payment_method_id.nil? && @payment_method_id.to_s.length < 0
    ...
    def hash
      [account_id, accounting_code, amount, comment, effective_date, payment_method_id, reference_id, status, transferred_to_accounting, type].hash
    end
