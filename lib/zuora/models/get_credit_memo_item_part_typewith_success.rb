...
module Zuora
  class GETCreditMemoItemPartTypewithSuccess
    ...
    def hash
      [amount, created_by_id, created_date, credit_memo_item_id, credit_tax_item_id, debit_memo_item_id, id, invoice_item_id, tax_item_id, updated_by_id, updated_date].hash
    end
