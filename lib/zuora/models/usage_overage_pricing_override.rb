...
module Zuora
  class UsageOveragePricingOverride
    # The options about how the charge price changes when renewed.
    ...
    # Specify only when the overageUnusedUnitsCreditOption is CreditBySpecificRate.
    ...
    def list_invalid_properties
      ...
      if !@price_increase_percentage.nil? && @price_increase_percentage < -100
        invalid_properties.push('invalid value for "price_increase_percentage", must be greater than or equal to -100.')
      end

      if !@included_units.nil? && @included_units < 0
        invalid_properties.push('invalid value for "included_units", must be greater than or equal to 0.')
      end

      if !@number_of_periods.nil? && @number_of_periods < 1
    ...
    def valid?
      price_change_option_validator = EnumAttributeValidator.new('String', ['NoChange', 'SpecificPercentageValue', 'UseLatestProductCatalogPricing'])
      return false unless price_change_option_validator.valid?(@price_change_option)
      return false if !@price_increase_percentage.nil? && @price_increase_percentage < -100
      return false if !@included_units.nil? && @included_units < 0
      return false if !@number_of_periods.nil? && @number_of_periods < 1
      overage_unused_units_credit_option_validator = EnumAttributeValidator.new('String', ['NoCredit', 'CreditBySpecificRate'])
      return false unless overage_unused_units_credit_option_validator.valid?(@overage_unused_units_credit_option)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] price_change_option Object to be assigned
    def price_change_option=(price_change_option)
      validator = EnumAttributeValidator.new('String', ['NoChange', 'SpecificPercentageValue', 'UseLatestProductCatalogPricing'])
      unless validator.valid?(price_change_option)
        fail ArgumentError, 'invalid value for "price_change_option", must be one of #{validator.allowable_values}.'
      end
      @price_change_option = price_change_option
    end

    # Custom attribute writer method with validation
    # @param [Object] price_increase_percentage Value to be assigned
    def price_increase_percentage=(price_increase_percentage)
      if !price_increase_percentage.nil? && price_increase_percentage < -100
        fail ArgumentError, 'invalid value for "price_increase_percentage", must be greater than or equal to -100.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] included_units Value to be assigned
    def included_units=(included_units)
      if !included_units.nil? && included_units < 0
        fail ArgumentError, 'invalid value for "included_units", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] overage_unused_units_credit_option Object to be assigned
    def overage_unused_units_credit_option=(overage_unused_units_credit_option)
      validator = EnumAttributeValidator.new('String', ['NoCredit', 'CreditBySpecificRate'])
      unless validator.valid?(overage_unused_units_credit_option)
        fail ArgumentError, 'invalid value for "overage_unused_units_credit_option", must be one of #{validator.allowable_values}.'
      end
    ...
    def hash
      [price_change_option, price_increase_percentage, included_units, number_of_periods, overage_price, overage_unused_units_credit_option, unused_units_credit_rates].hash
    end
