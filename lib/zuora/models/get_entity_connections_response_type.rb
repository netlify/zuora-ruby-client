...
module Zuora
  ...
  class GETEntityConnectionsResponseType
    ...
    attr_accessor :entity_connections
    ...
    def self.swagger_types
      {
        :'entity_connections' => :'Array<GETEntityConnectionsArrayItemsType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entityConnections')
        if (value = attributes[:'entityConnections']).is_a?(Array)
          self.entity_connections = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          entity_connections == o.entity_connections &&
    ...
    def hash
      [entity_connections, next_page, success].hash
    end
