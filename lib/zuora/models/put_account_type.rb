...
module Zuora
  class PUTAccountType
    ...
    def hash
      [additional_email_addresses, auto_pay, batch, bill_to_contact, communication_profile_id, crm_id, custom_field__c, invoice_delivery_prefs_email, invoice_delivery_prefs_print, invoice_template_id, name, notes, parent_id, payment_gateway, sales_rep, sold_to_contact, tagging, tax_info].hash
    end
