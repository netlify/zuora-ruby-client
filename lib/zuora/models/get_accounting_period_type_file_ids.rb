...
module Zuora
  ...
  class GETAccountingPeriodTypeFileIds
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountsReceivableAccountAgingDetailExportFileId')
        self.accounts_receivable_account_aging_detail_export_file_id = attributes[:'accountsReceivableAccountAgingDetailExportFileId']
      end

      if attributes.has_key?(:'accountsReceivableInvoiceAgingDetailExportFileId')
        self.accounts_receivable_invoice_aging_detail_export_file_id = attributes[:'accountsReceivableInvoiceAgingDetailExportFileId']
      end

      if attributes.has_key?(:'arRollForwardDetailExportFileId')
        self.ar_roll_forward_detail_export_file_id = attributes[:'arRollForwardDetailExportFileId']
      end

      if attributes.has_key?(:'fxRealizedGainAndLossDetailExportFileId')
        self.fx_realized_gain_and_loss_detail_export_file_id = attributes[:'fxRealizedGainAndLossDetailExportFileId']
      end

      if attributes.has_key?(:'fxUnrealizedGainAndLossDetailExportFileId')
        self.fx_unrealized_gain_and_loss_detail_export_file_id = attributes[:'fxUnrealizedGainAndLossDetailExportFileId']
      end

      if attributes.has_key?(:'revenueDetailCsvFileId')
        self.revenue_detail_csv_file_id = attributes[:'revenueDetailCsvFileId']
      end

      if attributes.has_key?(:'revenueDetailExcelFileId')
        self.revenue_detail_excel_file_id = attributes[:'revenueDetailExcelFileId']
      end

      if attributes.has_key?(:'unprocessedChargesFileId')
        self.unprocessed_charges_file_id = attributes[:'unprocessedChargesFileId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounts_receivable_account_aging_detail_export_file_id == o.accounts_receivable_account_aging_detail_export_file_id &&
          accounts_receivable_invoice_aging_detail_export_file_id == o.accounts_receivable_invoice_aging_detail_export_file_id &&
          ar_roll_forward_detail_export_file_id == o.ar_roll_forward_detail_export_file_id &&
          fx_realized_gain_and_loss_detail_export_file_id == o.fx_realized_gain_and_loss_detail_export_file_id &&
          fx_unrealized_gain_and_loss_detail_export_file_id == o.fx_unrealized_gain_and_loss_detail_export_file_id &&
          revenue_detail_csv_file_id == o.revenue_detail_csv_file_id &&
          revenue_detail_excel_file_id == o.revenue_detail_excel_file_id &&
          unprocessed_charges_file_id == o.unprocessed_charges_file_id
    end
    ...
    def hash
      [accounts_receivable_account_aging_detail_export_file_id, accounts_receivable_invoice_aging_detail_export_file_id, ar_roll_forward_detail_export_file_id, fx_realized_gain_and_loss_detail_export_file_id, fx_unrealized_gain_and_loss_detail_export_file_id, revenue_detail_csv_file_id, revenue_detail_excel_file_id, unprocessed_charges_file_id].hash
    end
