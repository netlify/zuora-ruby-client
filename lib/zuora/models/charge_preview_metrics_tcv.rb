...
module Zuora
  class ChargePreviewMetricsTcv
    ...
    attr_accessor :discount_delta

    attr_accessor :regular

    attr_accessor :regular_delta
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'discountDelta')
        self.discount_delta = attributes[:'discountDelta']
      end

      if attributes.has_key?(:'regular')
        self.regular = attributes[:'regular']
      end

      if attributes.has_key?(:'regularDelta')
        self.regular_delta = attributes[:'regularDelta']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          discount == o.discount &&
          discount_delta == o.discount_delta &&
          regular == o.regular &&
          regular_delta == o.regular_delta
    end
    ...
    def hash
      [discount, discount_delta, regular, regular_delta].hash
    end
