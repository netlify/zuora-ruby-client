...
module Zuora
  ...
  class PUTSubscriptionResponseType
    ...
    attr_accessor :charge_metrics

    attr_accessor :credit_memo

    # The credit memo ID, if a credit memo is generated during the subscription process.  **Note:** This field is only available if you have the Advanced AR Settlements feature enabled. 
    ...
    # 
    attr_accessor :preview_charge_metrics_response
    ...
    def self.swagger_types
      {
        ...
        :'invoice' => :'Object',
        :'invoice_id' => :'String',
        :'invoice_items' => :'Array<PUTSubscriptionPreviewInvoiceItemsType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeMetrics')
        self.charge_metrics = attributes[:'chargeMetrics']
      end

      if attributes.has_key?(:'creditMemo')
        self.credit_memo = attributes[:'creditMemo']
      end
      ...
      if attributes.has_key?(:'previewChargeMetricsResponse')
        self.preview_charge_metrics_response = attributes[:'previewChargeMetricsResponse']
      end
      ...
      if attributes.has_key?(:'totalDeltaMrr')
        self.total_delta_mrr = attributes[:'totalDeltaMrr']
      end

      if attributes.has_key?(:'totalDeltaTcv')
        self.total_delta_tcv = attributes[:'totalDeltaTcv']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          charge_metrics == o.charge_metrics &&
          credit_memo == o.credit_memo &&
          ...
          preview_charge_metrics_response == o.preview_charge_metrics_response &&
          subscription_id == o.subscription_id &&
          success == o.success &&
          target_date == o.target_date &&
          tax_amount == o.tax_amount &&
          total_delta_mrr == o.total_delta_mrr &&
          total_delta_tcv == o.total_delta_tcv
    end
    ...
    def hash
      [amount, amount_without_tax, charge_metrics, credit_memo, credit_memo_id, invoice, invoice_id, invoice_items, invoice_target_date, paid_amount, payment_id, preview_charge_metrics_response, subscription_id, success, target_date, tax_amount, total_delta_mrr, total_delta_tcv].hash
    end
