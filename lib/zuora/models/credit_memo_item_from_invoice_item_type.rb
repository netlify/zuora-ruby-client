...
module Zuora
  class CreditMemoItemFromInvoiceItemType
    ...
    def self.swagger_types
      {
        ...
        :'sku_name' => :'String',
        :'tax_items' => :'Array<CreditMemoTaxItemFromInvoiceTaxItemType>',
    ...
    def list_invalid_properties
      ...
      if @sku_name.nil?
        invalid_properties.push('invalid value for "sku_name", sku_name cannot be nil.')
      end
    ...
    def hash
      [amount, comment, custom_field__c, finance_information, invoice_item_id, service_end_date, service_start_date, sku_name, tax_items, unit_of_measure].hash
    end
