...
module Zuora
  class GETCreditMemoItemPartType
    ...
    def self.swagger_types
      {
        ...
        :'credit_tax_item_id' => :'String',
        :'debit_memo_item_id' => :'String',
        :'id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditTaxItemId')
        self.credit_tax_item_id = attributes[:'creditTaxItemId']
      end

      if attributes.has_key?(:'debitMemoItemId')
        self.debit_memo_item_id = attributes[:'debitMemoItemId']
      end
      ...
      if attributes.has_key?(:'taxItemId')
        self.tax_item_id = attributes[:'taxItemId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_tax_item_id == o.credit_tax_item_id &&
          debit_memo_item_id == o.debit_memo_item_id &&
          id == o.id &&
          invoice_item_id == o.invoice_item_id &&
          success == o.success &&
          tax_item_id == o.tax_item_id &&
    ...
    def hash
      [amount, created_by_id, created_date, credit_memo_item_id, credit_tax_item_id, debit_memo_item_id, id, invoice_item_id, success, tax_item_id, updated_by_id, updated_date].hash
    end
