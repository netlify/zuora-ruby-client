...
module Zuora
  class GETAccountingCodeItemType
    ...
    def valid?
      category_validator = EnumAttributeValidator.new('String', ['Assets', 'Liabilities', 'Equity', 'Revenue', 'Expenses'])
      return false unless category_validator.valid?(@category)
      status_validator = EnumAttributeValidator.new('String', ['Active', 'Inactive'])
      return false unless status_validator.valid?(@status)
      type_validator = EnumAttributeValidator.new('String', ['AccountsReceivable', 'On-Account Receivable', 'Cash', 'OtherAssets', 'CustomerCashOnAccount', 'DeferredRevenue', 'SalesTaxPayable', 'OtherLiabilities', 'SalesRevenue', 'SalesDiscounts', 'OtherRevenue', 'OtherEquity', 'BadDebt', 'OtherExpenses'])
    ...
    def category=(category)
      validator = EnumAttributeValidator.new('String', ['Assets', 'Liabilities', 'Equity', 'Revenue', 'Expenses'])
    ...
    def hash
      [category, created_by, created_on, custom_field__c, gl_account_name, gl_account_number, id, name, notes, status, success, type, updated_by, updated_on].hash
    end
