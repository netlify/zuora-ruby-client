...
module Zuora
  ...
  class GETTaxationItemListType
    ...
    def self.swagger_types
      {
        :'success' => :'BOOLEAN',
        :'taxation_items' => :'Array<GETTaxationItemTypewithSuccess>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taxationItems')
        if (value = attributes[:'taxationItems']).is_a?(Array)
          self.taxation_items = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          taxation_items == o.taxation_items
    end
