...
module Zuora
  ...
  class DiscountPricingOverride
    ...
    # Only applicable if the charge is a fixed-amount discount.
    attr_accessor :discount_amount

    attr_accessor :discount_level

    # Only applicable if the charge is a percentage discount.
    ...
    def valid?
      apply_discount_to_validator = EnumAttributeValidator.new('String', ["ONETIME", "RECURRING", "USAGE", "ONETIMERECURRING", "ONETIMEUSAGE", "RECURRINGUSAGE", "ONETIMERECURRINGUSAGE"])
      return false unless apply_discount_to_validator.valid?(@apply_discount_to)
      discount_level_validator = EnumAttributeValidator.new('String', ["rateplan", "subscription", "account"])
      return false unless discount_level_validator.valid?(@discount_level)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] apply_discount_to Object to be assigned
    def apply_discount_to=(apply_discount_to)
      validator = EnumAttributeValidator.new('String', ["ONETIME", "RECURRING", "USAGE", "ONETIMERECURRING", "ONETIMEUSAGE", "RECURRINGUSAGE", "ONETIMERECURRINGUSAGE"])
      unless validator.valid?(apply_discount_to)
        fail ArgumentError, "invalid value for 'apply_discount_to', must be one of #{validator.allowable_values}."
      end
      @apply_discount_to = apply_discount_to
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] discount_level Object to be assigned
    def discount_level=(discount_level)
      validator = EnumAttributeValidator.new('String', ["rateplan", "subscription", "account"])
      unless validator.valid?(discount_level)
        fail ArgumentError, "invalid value for 'discount_level', must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [apply_discount_to, discount_amount, discount_level, discount_percentage].hash
    end
