...
module Zuora
  ...
  class ProxyActionqueryMoreResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'queryLocator')
        self.query_locator = attributes[:'queryLocator']
      end
    ...
    def hash
      [done, query_locator, records, size].hash
    end
