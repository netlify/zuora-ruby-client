...
module Zuora
  ...
  class GETCMTaxItemType
    ...
    def hash
      [applied_amount, exempt_amount, finance_information, id, jurisdiction, location_code, name, refund_amount, source_tax_item_id, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type, unapplied_amount].hash
    end
