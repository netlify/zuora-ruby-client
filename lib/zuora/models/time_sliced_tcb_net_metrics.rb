...
module Zuora
  class TimeSlicedTcbNetMetrics
    ...
    attr_accessor :discount_charge_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'discountChargeNumber')
        self.discount_charge_number = attributes[:'discountChargeNumber']
      end
      ...
      if attributes.has_key?(:'termNumber')
        self.term_number = attributes[:'termNumber']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['Regular', 'Discount'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['Regular', 'Discount'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount == o.amount &&
          discount_charge_number == o.discount_charge_number &&
          end_date == o.end_date &&
    ...
    def hash
      [amount, discount_charge_number, end_date, start_date, tax, term_number, type].hash
    end
