...
module Zuora
  ...
  class GETAccountType
    ...
    attr_accessor :billing_and_payment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billingAndPayment')
        self.billing_and_payment = attributes[:'billingAndPayment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          billing_and_payment == o.billing_and_payment &&
          metrics == o.metrics &&
    ...
    def hash
      [basic_info, bill_to_contact, billing_and_payment, metrics, sold_to_contact, success, tax_info].hash
    end
