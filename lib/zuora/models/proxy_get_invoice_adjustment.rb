...
module Zuora
  ...
  class ProxyGetInvoiceAdjustment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ImpactAmount')
        self.impact_amount = attributes[:'ImpactAmount']
      end
    ...
    def hash
      [account_id, accounting_code, adjustment_date, adjustment_number, amount, cancelled_by_id, cancelled_on, comments, created_by_id, created_date, customer_name, customer_number, id, impact_amount, invoice_id, invoice_number, reason_code, reference_id, status, transferred_to_accounting, type, updated_by_id, updated_date].hash
    end
