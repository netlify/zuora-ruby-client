...
module Zuora
  ...
  class GETCreditMemoItemType
    ...
    def hash
      [amount, applied_amount, comment, created_by_id, created_date, credit_tax_items, finance_information, id, refund_amount, service_end_date, service_start_date, sku, sku_name, source_item_id, source_item_type, subscription_id, success, unapplied_amount, updated_by_id, updated_date].hash
    end
