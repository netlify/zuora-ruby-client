...
module Zuora
  class GETCreditMemoItemType
    ...
    attr_accessor :credit_tax_items
    ...
    attr_accessor :source_item_type
    ...
    def self.swagger_types
      {
        ...
        :'credit_tax_items' => :'Array<GETCMTaxItemType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditTaxItems')
        if (value = attributes[:'creditTaxItems']).is_a?(Array)
          self.credit_tax_items = value
        end
      end
      ...
      if attributes.has_key?(:'skuName')
        self.sku_name = attributes[:'skuName']
      end

      if attributes.has_key?(:'sourceItemId')
        self.source_item_id = attributes[:'sourceItemId']
      end

      if attributes.has_key?(:'sourceItemType')
        self.source_item_type = attributes[:'sourceItemType']
      end
    ...
    def valid?
      source_item_type_validator = EnumAttributeValidator.new('String', ['SubscriptionComponent', 'InvoiceDetail', 'ProductRatePlanCharge'])
      return false unless source_item_type_validator.valid?(@source_item_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] source_item_type Object to be assigned
    def source_item_type=(source_item_type)
      validator = EnumAttributeValidator.new('String', ['SubscriptionComponent', 'InvoiceDetail', 'ProductRatePlanCharge'])
      unless validator.valid?(source_item_type)
        fail ArgumentError, 'invalid value for "source_item_type", must be one of #{validator.allowable_values}.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_tax_items == o.credit_tax_items &&
          ...
          source_item_type == o.source_item_type &&
    ...
    def hash
      [amount, applied_amount, comment, created_by_id, created_date, credit_tax_items, custom_field__c, finance_information, id, refund_amount, service_end_date, service_start_date, sku, sku_name, source_item_id, source_item_type, subscription_id, success, unapplied_amount, updated_by_id, updated_date].hash
    end
