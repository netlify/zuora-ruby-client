...
module Zuora
  ...
  class POSTInvoiceCollectResponseType
    ...
    def self.swagger_types
      {
        ...
        :'credit_memos' => :'Array<POSTInvoiceCollectCreditMemosType>',
        :'invoices' => :'Array<POSTInvoiceCollectInvoicesType>',
        :'payment_id' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'amountCollected')
        self.amount_collected = attributes[:'amountCollected']
      end
    ...
    def hash
      [amount_collected, credit_memos, invoices, payment_id, success].hash
    end
