...
module Zuora
  # The default payment method of the account. Only credit card type payment method is supported.
  class CreditCard
    attr_accessor :card_holder_info

    attr_accessor :card_number

    # The credit card type, such as Visa, MasterCard, AmericanExpress, Discover, JCB, CUP, Diners.
    attr_accessor :card_type

    # The range is from 1 to 12.
    attr_accessor :expiration_month

    # The range is from 1980 to 2500
    ...
    def hash
      [card_holder_info, card_number, card_type, expiration_month, expiration_year, security_code].hash
    end
