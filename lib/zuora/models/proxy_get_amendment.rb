...
module Zuora
  ...
  class ProxyGetAmendment
    ...
    #  The date when the new terms and conditions take effect.   **Version notes**: -- 
    ...
    def hash
      [auto_renew, code, contract_effective_date, created_by_id, created_date, current_term, current_term_period_type, customer_acceptance_date, description, effective_date, id, name, renewal_setting, renewal_term, renewal_term_period_type, service_activation_date, specific_update_date, status, subscription_id, term_start_date, term_type, type, updated_by_id, updated_date].hash
    end
