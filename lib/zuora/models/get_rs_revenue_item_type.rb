...
module Zuora
  ...
  class GETRsRevenueItemType
    ...
    attr_accessor :accounting_period_end_date
    ...
    attr_accessor :accounting_period_start_date
    ...
    attr_accessor :is_accounting_period_closed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingPeriodEndDate')
        self.accounting_period_end_date = attributes[:'accountingPeriodEndDate']
      end
      ...
      if attributes.has_key?(:'accountingPeriodStartDate')
        self.accounting_period_start_date = attributes[:'accountingPeriodStartDate']
      end
      ...
      if attributes.has_key?(:'isAccountingPeriodClosed')
        self.is_accounting_period_closed = attributes[:'isAccountingPeriodClosed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounting_period_end_date == o.accounting_period_end_date &&
          accounting_period_name == o.accounting_period_name &&
          accounting_period_start_date == o.accounting_period_start_date &&
          amount == o.amount &&
          currency == o.currency &&
          ...
          is_accounting_period_closed == o.is_accounting_period_closed &&
    ...
    def hash
      [accounting_period_end_date, accounting_period_name, accounting_period_start_date, amount, currency, custom_field__c, deferred_revenue_accounting_code, deferred_revenue_accounting_code_type, is_accounting_period_closed, recognized_revenue_accounting_code, recognized_revenue_accounting_code_type].hash
    end
