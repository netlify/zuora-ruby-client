...
module Zuora
  ...
  class POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent
    ...
    def list_invalid_properties
      ...
      if !@event_type.nil? && @event_type.to_s.length > 50
        invalid_properties.push("invalid value for 'event_type', the character length must be smaller than or equal to 50.")
      end

      if !@event_type.nil? && @event_type.to_s.length < 0
        invalid_properties.push("invalid value for 'event_type', the character length must be great than or equal to 0.")
      end

      if !@event_type_system_id.nil? && @event_type_system_id.to_s.length > 50
        invalid_properties.push("invalid value for 'event_type_system_id', the character length must be smaller than or equal to 50.")
      end

      if !@event_type_system_id.nil? && @event_type_system_id.to_s.length < 0
        invalid_properties.push("invalid value for 'event_type_system_id', the character length must be great than or equal to 0.")
      end
    ...
    def valid?
      return false if !@event_type.nil? && @event_type.to_s.length > 50
      return false if !@event_type.nil? && @event_type.to_s.length < 0
      return false if !@event_type_system_id.nil? && @event_type_system_id.to_s.length > 50
      return false if !@event_type_system_id.nil? && @event_type_system_id.to_s.length < 0
    ...
    def event_type=(event_type)
      ...
      if !event_type.nil? && event_type.to_s.length > 50
        fail ArgumentError, "invalid value for 'event_type', the character length must be smaller than or equal to 50."
      end

      if !event_type.nil? && event_type.to_s.length < 0
        fail ArgumentError, "invalid value for 'event_type', the character length must be great than or equal to 0."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] event_type_system_id Value to be assigned
    def event_type_system_id=(event_type_system_id)

      if !event_type_system_id.nil? && event_type_system_id.to_s.length > 50
        fail ArgumentError, "invalid value for 'event_type_system_id', the character length must be smaller than or equal to 50."
      end

      if !event_type_system_id.nil? && event_type_system_id.to_s.length < 0
        fail ArgumentError, "invalid value for 'event_type_system_id', the character length must be great than or equal to 0."
      end

      @event_type_system_id = event_type_system_id
    end
    ...
    def hash
      [custom_fields_values, event_type, event_type_system_id, notes].hash
    end
