...
module Zuora
  ...
  class GetOrderRatedResultResponseType
    # Indicates if the order creation has succeeded.
    attr_accessor :success

    attr_accessor :order_rated_result
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderRatedResult')
        self.order_rated_result = attributes[:'orderRatedResult']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          order_rated_result == o.order_rated_result
    end
    ...
    def hash
      [success, order_rated_result].hash
    end
