...
module Zuora
  class RatePlanChargeTier
    ...
    #  The end number of a range of units for the tier. This field is only required if the charge mode is `Tiered Pricing` or `Tierred with Overage Pricing`.   **Character limit**: 16   **Values**: any positive decimal value 
    attr_accessor :ending_unit
    ...
    attr_accessor :is_overage_price
    ...
    #  The start number of a range of units for the tier. This field is only required if the charge mode is `Tiered Pricing` or `Tierred with Overage Pricing`.   **Character limit**: 16   **Values**: any positive decimal value 
    attr_accessor :starting_unit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EndingUnit')
        self.ending_unit = attributes[:'EndingUnit']
      end

      if attributes.has_key?(:'IsOveragePrice')
        self.is_overage_price = attributes[:'IsOveragePrice']
      end
      ...
      if attributes.has_key?(:'PriceFormat')
        self.price_format = attributes[:'PriceFormat']
      end
      ...
      if attributes.has_key?(:'StartingUnit')
        self.starting_unit = attributes[:'StartingUnit']
      end
    ...
    def list_invalid_properties
      ...
      if @rate_plan_charge_id.nil?
        invalid_properties.push('invalid value for "rate_plan_charge_id", rate_plan_charge_id cannot be nil.')
      end
    ...
    def valid?
      return false if @rate_plan_charge_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ending_unit == o.ending_unit &&
          is_overage_price == o.is_overage_price &&
          price == o.price &&
          price_format == o.price_format &&
          rate_plan_charge_id == o.rate_plan_charge_id &&
          starting_unit == o.starting_unit &&
          tier == o.tier &&
    ...
    def hash
      [created_by_id, created_date, ending_unit, is_overage_price, price, price_format, rate_plan_charge_id, starting_unit, tier, updated_by_id, updated_date].hash
    end
