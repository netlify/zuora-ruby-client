...
module Zuora
  class ProxyModifyPaymentMethod
    ...
    def hash
      [account_id, ach_aba_code, ach_account_name, ach_account_type, ach_address1, ach_address2, ach_bank_name, bank_branch_code, bank_check_digit, bank_city, bank_code, bank_name, bank_postal_code, bank_street_name, bank_street_number, bank_transfer_account_name, business_identification_code, city, country, credit_card_address1, credit_card_address2, credit_card_city, credit_card_country, credit_card_expiration_month, credit_card_expiration_year, credit_card_holder_name, credit_card_postal_code, credit_card_state, credit_card_type, device_session_id, email, existing_mandate, first_name, iban, ip_address, last_name, last_transaction_date_time, last_transaction_status, mandate_creation_date, mandate_id, mandate_received, mandate_update_date, max_consecutive_payment_failures, num_consecutive_failures, payment_method_status, payment_retry_window, phone, postal_code, state, street_name, street_number, use_default_retry_rule].hash
    end
