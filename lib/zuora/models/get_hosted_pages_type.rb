...
module Zuora
  ...
  class GetHostedPagesType
    ...
    def self.swagger_types
      {
        :'hostedpages' => :'Array<GetHostedPageType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hostedpages')
        if (value = attributes[:'hostedpages']).is_a?(Array)
          self.hostedpages = value
        end
      end
    ...
    def hash
      [hostedpages, next_page, success].hash
    end
