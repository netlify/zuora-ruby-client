...
module Zuora
  ...
  class GetOrderBillingInfoResponseTypeBillingInfo
    attr_accessor :billed_amount

    # Currency code.
    attr_accessor :currency

    # Total contracted billing of this order.
    attr_accessor :tcb

    attr_accessor :unbilled_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billedAmount')
        self.billed_amount = attributes[:'billedAmount']
      end
      ...
      if attributes.has_key?(:'tcb')
        self.tcb = attributes[:'tcb']
      end

      if attributes.has_key?(:'unbilledAmount')
        self.unbilled_amount = attributes[:'unbilledAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          currency == o.currency &&
          tcb == o.tcb &&
          unbilled_amount == o.unbilled_amount
    end
    ...
    def hash
      [billed_amount, currency, tcb, unbilled_amount].hash
    end
