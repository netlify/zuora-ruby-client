...
module Zuora
  class POSTBillingPreviewCreditMemoItem
    ...
    def hash
      [amount, charge_date, charge_number, charge_type, comment, id, processing_type, quantity, rate_plan_charge_id, service_end_date, service_start_date, sku, sku_name, subscription_id, subscription_number, unit_of_measure].hash
    end
