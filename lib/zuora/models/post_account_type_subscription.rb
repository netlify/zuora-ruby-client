...
module Zuora
  ...
  class POSTAccountTypeSubscription
    ...
    def hash
      [cpq_bundle_json_id__qt, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, auto_renew, contract_effective_date, custom_field__c, customer_acceptance_date, initial_term, invoice_owner_account_key, invoice_separately, notes, renewal_term, service_activation_date, subscribe_to_rate_plans, subscription_number, term_start_date, term_type].hash
    end
