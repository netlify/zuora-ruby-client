...
module Zuora
  class AccountCreditCardHolder
    ...
    def list_invalid_properties
      ...
      if !@card_holder_name.nil? && @card_holder_name.to_s.length > 50
        invalid_properties.push('invalid value for "card_holder_name", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@card_holder_name.nil? && @card_holder_name.to_s.length > 50
    ...
    def card_holder_name=(card_holder_name)
      if !card_holder_name.nil? && card_holder_name.to_s.length > 50
        fail ArgumentError, 'invalid value for "card_holder_name", the character length must be smaller than or equal to 50.'
      end
    ...
    def hash
      [address_line1, address_line2, card_holder_name, city, country, email, phone, state, zip_code].hash
    end
