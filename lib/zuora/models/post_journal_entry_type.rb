...
module Zuora
  class POSTJournalEntryType
    ...
    def self.swagger_types
      {
        ...
        :'journal_entry_items' => :'Array<POSTJournalEntryItemType>',
        :'notes' => :'String',
        :'segments' => :'Array<POSTJournalEntrySegmentType>',
    ...
    def list_invalid_properties
      ...
      if @accounting_period_name.nil?
        invalid_properties.push('invalid value for "accounting_period_name", accounting_period_name cannot be nil.')
      end
      ...
      if @journal_entry_date.nil?
        invalid_properties.push('invalid value for "journal_entry_date", journal_entry_date cannot be nil.')
      end

      if @journal_entry_items.nil?
        invalid_properties.push('invalid value for "journal_entry_items", journal_entry_items cannot be nil.')
      end
    ...
    def valid?
      return false if @accounting_period_name.nil?
      return false if @currency.nil?
      return false if @journal_entry_date.nil?
      return false if @journal_entry_items.nil?
    ...
    def hash
      [accounting_period_name, currency, custom_field__c, journal_entry_date, journal_entry_items, notes, segments, transferred_to_accounting].hash
    end
