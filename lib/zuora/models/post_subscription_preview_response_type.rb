...
module Zuora
  class POSTSubscriptionPreviewResponseType
    ...
    def self.swagger_types
      {
        ...
        :'invoice' => :'Object',
        :'invoice_items' => :'Array<POSTSubscriptionPreviewInvoiceItemsType>',
    ...
    def hash
      [amount, amount_without_tax, charge_metrics, contracted_mrr, credit_memo, invoice, invoice_items, invoice_target_date, preview_charge_metrics_response, success, target_date, tax_amount, total_contracted_value].hash
    end
