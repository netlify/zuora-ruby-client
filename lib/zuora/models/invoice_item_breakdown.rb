...
module Zuora
  ...
  class InvoiceItemBreakdown
    attr_accessor :amount

    # Available only when the invoice item represents a discount invoice item.
    ...
    def hash
      [amount, apply_to_charge_number, breakdown_details, charge_number, end_date, invoice_item_id, start_date, subscription_number].hash
    end
