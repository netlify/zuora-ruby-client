...
module Zuora
  ...
  class PUTScUpdateType
    ...
    def hash
      [billing_period_alignment, custom_field__c, description, included_units, overage_price, price, price_change_option, price_increase_percentage, quantity, rate_plan_charge_id, tiers, trigger_date, trigger_event].hash
    end
