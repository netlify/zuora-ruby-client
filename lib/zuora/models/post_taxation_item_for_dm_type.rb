...
module Zuora
  class POSTTaxationItemForDMType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memoItemId')
        self.memo_item_id = attributes[:'memoItemId']
      end
    ...
    def list_invalid_properties
      ...
      if @jurisdiction.nil?
        invalid_properties.push('invalid value for "jurisdiction", jurisdiction cannot be nil.')
      end
    ...
    def hash
      [custom_field__c, exempt_amount, finance_information, jurisdiction, location_code, memo_item_id, name, source_tax_item_id, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type].hash
    end
