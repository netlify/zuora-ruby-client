...
module Zuora
  class PutCreditMemoTaxItemType
    ...
    def hash
      [amount, finance_information, id, jurisdiction, location_code, tax_code, tax_code_description, tax_date, tax_exempt_amount, tax_name, tax_rate, tax_rate_description, tax_rate_type].hash
    end
