...
module Zuora
  class CreatePaymentType
    ...
    def self.swagger_types
      {
        ...
        :'debit_memos' => :'Array<PaymentDebitMemoApplicationCreateRequestType>',
        :'effective_date' => :'Date',
        :'finance_information' => :'CreatePaymentTypeFinanceInformation',
        :'gateway_id' => :'String',
        :'invoices' => :'Array<PaymentInvoiceApplicationCreateRequestType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'debitMemos')
        if (value = attributes[:'debitMemos']).is_a?(Array)
          self.debit_memos = value
        end
      end
    ...
    def hash
      [account_id, amount, comment, currency, custom_field__c, debit_memos, effective_date, finance_information, gateway_id, invoices, payment_method_id, reference_id, type].hash
    end
