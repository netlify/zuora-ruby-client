...
module Zuora
  class PostNonRefRefundType
    ...
    def self.swagger_types
      {
        ...
        :'items' => :'Array<RefundCreditMemoItemType>',
        :'method_type' => :'String',
    ...
    def list_invalid_properties
      ...
      if !@second_refund_reference_id.nil? && @second_refund_reference_id.to_s.length > 60
        invalid_properties.push('invalid value for "second_refund_reference_id", the character length must be smaller than or equal to 60.')
      end

      if !@second_refund_reference_id.nil? && @second_refund_reference_id.to_s.length < 0
        invalid_properties.push('invalid value for "second_refund_reference_id", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@second_refund_reference_id.nil? && @second_refund_reference_id.to_s.length > 60
      return false if !@second_refund_reference_id.nil? && @second_refund_reference_id.to_s.length < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] second_refund_reference_id Value to be assigned
    def second_refund_reference_id=(second_refund_reference_id)
      if !second_refund_reference_id.nil? && second_refund_reference_id.to_s.length > 60
        fail ArgumentError, 'invalid value for "second_refund_reference_id", the character length must be smaller than or equal to 60.'
      end

      if !second_refund_reference_id.nil? && second_refund_reference_id.to_s.length < 0
        fail ArgumentError, 'invalid value for "second_refund_reference_id", the character length must be great than or equal to 0.'
      end
    ...
    def hash
      [comment, custom_field__c, finance_information, items, method_type, payment_method_id, reason_code, reference_id, refund_date, second_refund_reference_id, total_amount, type].hash
    end
