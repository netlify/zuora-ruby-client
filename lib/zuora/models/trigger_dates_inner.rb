...
module Zuora
  class TriggerDatesInner
    # The name of the trigger date.
    attr_accessor :name
    ...
    def valid?
      name_validator = EnumAttributeValidator.new('String', ['ContractEffective', 'ServiceActivation', 'CustomerAcceptance'])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ['ContractEffective', 'ServiceActivation', 'CustomerAcceptance'])
