...
module Zuora
  class GETARatedResultType
    # A unique number that identifies the account. 
    attr_accessor :account_number

    attr_accessor :additional_info

    # The rating amount of the charge. 
    attr_accessor :amount

    # A unique number that identifies the charge. 
    attr_accessor :charge_number

    # The type of the currency used in the charge. 
    attr_accessor :currency

    # The end date of the rating result. 
    attr_accessor :end_date

    # The unique ID of the rating result item. 
    attr_accessor :id

    # The date and time when the charge is rated. 
    attr_accessor :rated_time

    # The start date of the rating result. 
    attr_accessor :start_date

    # A unique number that identifies the subscription. 
    ...
    def self.swagger_types
      {
        ...
        :'additional_info' => :'GETARatedResultTypeAdditionalInfo',
        :'amount' => :'Float',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ratedTime')
        self.rated_time = attributes[:'ratedTime']
      end
    ...
    def hash
      [account_number, additional_info, amount, charge_number, currency, end_date, id, rated_time, start_date, subscription_number].hash
    end
