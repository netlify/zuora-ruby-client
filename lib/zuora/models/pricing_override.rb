...
module Zuora
  ...
  class PricingOverride
    ...
    attr_accessor :one_time_flat_fee

    attr_accessor :one_time_per_unit

    attr_accessor :one_time_tiered

    attr_accessor :one_time_volume

    attr_accessor :recurring_flat_fee

    attr_accessor :recurring_per_unit

    attr_accessor :recurring_tiered

    attr_accessor :recurring_volume

    attr_accessor :usage_flat_fee

    attr_accessor :usage_overage

    attr_accessor :usage_per_unit

    attr_accessor :usage_tiered

    attr_accessor :usage_tiered_with_overage

    attr_accessor :usage_volume
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'oneTimeFlatFee')
        self.one_time_flat_fee = attributes[:'oneTimeFlatFee']
      end

      if attributes.has_key?(:'oneTimePerUnit')
        self.one_time_per_unit = attributes[:'oneTimePerUnit']
      end

      if attributes.has_key?(:'oneTimeTiered')
        self.one_time_tiered = attributes[:'oneTimeTiered']
      end

      if attributes.has_key?(:'oneTimeVolume')
        self.one_time_volume = attributes[:'oneTimeVolume']
      end

      if attributes.has_key?(:'recurringFlatFee')
        self.recurring_flat_fee = attributes[:'recurringFlatFee']
      end

      if attributes.has_key?(:'recurringPerUnit')
        self.recurring_per_unit = attributes[:'recurringPerUnit']
      end

      if attributes.has_key?(:'recurringTiered')
        self.recurring_tiered = attributes[:'recurringTiered']
      end

      if attributes.has_key?(:'recurringVolume')
        self.recurring_volume = attributes[:'recurringVolume']
      end

      if attributes.has_key?(:'usageFlatFee')
        self.usage_flat_fee = attributes[:'usageFlatFee']
      end

      if attributes.has_key?(:'usageOverage')
        self.usage_overage = attributes[:'usageOverage']
      end

      if attributes.has_key?(:'usagePerUnit')
        self.usage_per_unit = attributes[:'usagePerUnit']
      end

      if attributes.has_key?(:'usageTiered')
        self.usage_tiered = attributes[:'usageTiered']
      end

      if attributes.has_key?(:'usageTieredWithOverage')
        self.usage_tiered_with_overage = attributes[:'usageTieredWithOverage']
      end

      if attributes.has_key?(:'usageVolume')
        self.usage_volume = attributes[:'usageVolume']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          discount == o.discount &&
          one_time_flat_fee == o.one_time_flat_fee &&
          one_time_per_unit == o.one_time_per_unit &&
          one_time_tiered == o.one_time_tiered &&
          one_time_volume == o.one_time_volume &&
          recurring_flat_fee == o.recurring_flat_fee &&
          recurring_per_unit == o.recurring_per_unit &&
          recurring_tiered == o.recurring_tiered &&
          recurring_volume == o.recurring_volume &&
          usage_flat_fee == o.usage_flat_fee &&
          usage_overage == o.usage_overage &&
          usage_per_unit == o.usage_per_unit &&
          usage_tiered == o.usage_tiered &&
          usage_tiered_with_overage == o.usage_tiered_with_overage &&
          usage_volume == o.usage_volume
    end
    ...
    def hash
      [discount, one_time_flat_fee, one_time_per_unit, one_time_tiered, one_time_volume, recurring_flat_fee, recurring_per_unit, recurring_tiered, recurring_volume, usage_flat_fee, usage_overage, usage_per_unit, usage_tiered, usage_tiered_with_overage, usage_volume].hash
    end
