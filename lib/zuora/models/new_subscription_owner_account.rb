...
module Zuora
  # The information of the new Subscription owner account to be created.    **Note:** This object field is only available if you have enabled the Owner Transfer feature. 
  class NewSubscriptionOwnerAccount
    ...
    def hash
      [account_number, auto_pay, batch, bill_cycle_day, bill_to_contact, communication_profile_id, credit_card, crm_id, currency, custom_fields, hpm_credit_card_payment_method_id, invoice_template_id, name, notes, payment_gateway, payment_term, sold_to_contact, tax_info].hash
    end
