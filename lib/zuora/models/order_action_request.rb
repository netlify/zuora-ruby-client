...
module Zuora
  # For each specific type of order actions, corresponding parameters need to be specified. For example, if the 'updateProduct' node provided for the 'AddProduct' type, an error response will return. 'RenewSubscription' does not have have a specific parameter. 
  class OrderActionRequest
    attr_accessor :add_product

    attr_accessor :cancel_subscription

    attr_accessor :create_subscription

    attr_accessor :custom_fields

    attr_accessor :owner_transfer

    attr_accessor :remove_product

    attr_accessor :terms_and_conditions

    attr_accessor :trigger_dates

    # Type of the order action. For each specific type of order actions, corresponding parameters need to be specified. For example, if the 'updateProduct' node provided for the 'AddProduct' type, an error response will return. The 'RenewSubscription' type does not require any parameter.
    attr_accessor :type

    attr_accessor :update_product
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'addProduct')
        self.add_product = attributes[:'addProduct']
      end

      if attributes.has_key?(:'cancelSubscription')
        self.cancel_subscription = attributes[:'cancelSubscription']
      end

      if attributes.has_key?(:'createSubscription')
        self.create_subscription = attributes[:'createSubscription']
      end
      ...
      if attributes.has_key?(:'ownerTransfer')
        self.owner_transfer = attributes[:'ownerTransfer']
      end

      if attributes.has_key?(:'removeProduct')
        self.remove_product = attributes[:'removeProduct']
      end
      ...
      if attributes.has_key?(:'triggerDates')
        self.trigger_dates = attributes[:'triggerDates']
      end
      ...
      if attributes.has_key?(:'updateProduct')
        self.update_product = attributes[:'updateProduct']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['CreateSubscription', 'TermsAndConditions', 'AddProduct', 'UpdateProduct', 'RemoveProduct', 'RenewSubscription', 'CancelSubscription', 'OwnerTransfer'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['CreateSubscription', 'TermsAndConditions', 'AddProduct', 'UpdateProduct', 'RemoveProduct', 'RenewSubscription', 'CancelSubscription', 'OwnerTransfer'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          add_product == o.add_product &&
          cancel_subscription == o.cancel_subscription &&
          create_subscription == o.create_subscription &&
          custom_fields == o.custom_fields &&
          owner_transfer == o.owner_transfer &&
          remove_product == o.remove_product &&
          terms_and_conditions == o.terms_and_conditions &&
          trigger_dates == o.trigger_dates &&
          type == o.type &&
          update_product == o.update_product
    end
    ...
    def hash
      [add_product, cancel_subscription, create_subscription, custom_fields, owner_transfer, remove_product, terms_and_conditions, trigger_dates, type, update_product].hash
    end
