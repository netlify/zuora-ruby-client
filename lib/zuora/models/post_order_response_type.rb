...
module Zuora
  ...
  class PostOrderResponseType
    # Indicates if the order creation has succeeded.
    attr_accessor :success

    # The account number for the order.
    attr_accessor :account_number

    # An array of the credit memo numbers generated in this order request. The credit memo is only available if you have the Avdanced AR Settlement feature enabled.
    attr_accessor :credit_memo_numbers
    ...
    # The number of the order created.
    ...
    # An array of number of subscriptions included in this order.
    attr_accessor :subscription_numbers
    ...
    def self.swagger_types
      {
        ...
        :'credit_memo_numbers' => :'Array<String>',
        :'invoice_numbers' => :'Array<String>',
        :'order_number' => :'String',
        :'paid_amount' => :'String',
        :'payment_number' => :'String',
        :'subscription_numbers' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditMemoNumbers')
        if (value = attributes[:'creditMemoNumbers']).is_a?(Array)
          self.credit_memo_numbers = value
        end
      end

      if attributes.has_key?(:'invoiceNumbers')
        if (value = attributes[:'invoiceNumbers']).is_a?(Array)
          self.invoice_numbers = value
        end
      end
      ...
      if attributes.has_key?(:'subscriptionNumbers')
        if (value = attributes[:'subscriptionNumbers']).is_a?(Array)
          self.subscription_numbers = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_memo_numbers == o.credit_memo_numbers &&
          invoice_numbers == o.invoice_numbers &&
          order_number == o.order_number &&
          paid_amount == o.paid_amount &&
          payment_number == o.payment_number &&
          subscription_numbers == o.subscription_numbers
    end
    ...
    def hash
      [success, account_number, credit_memo_numbers, invoice_numbers, order_number, paid_amount, payment_number, subscription_numbers].hash
    end
