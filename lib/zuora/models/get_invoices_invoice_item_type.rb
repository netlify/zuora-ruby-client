...
module Zuora
  class GETInvoicesInvoiceItemType
    ...
    def hash
      [charge_amount, charge_description, charge_id, charge_name, custom_field__c, id, product_name, quantity, service_end_date, service_start_date, subscription_id, subscription_name, success, tax_amount, unit_of_measure].hash
    end
