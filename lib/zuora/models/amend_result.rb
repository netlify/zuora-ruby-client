...
module Zuora
  class AmendResult
    ...
    attr_accessor :charge_metrics_data
    ...
    def self.swagger_types
      {
        :'amendment_ids' => :'Array<String>',
        :'charge_metrics_data' => :'ChargeMetricsData',
        :'errors' => :'Array<ActionsErrorResponse>',
        :'gateway_response' => :'String',
        :'gateway_response_code' => :'String',
        :'invoice_datas' => :'Array<InvoiceData>',
        :'invoice_id' => :'String',
        :'payment_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AmendmentIds')
        if (value = attributes[:'AmendmentIds']).is_a?(Array)
          self.amendment_ids = value
        end
      end

      if attributes.has_key?(:'ChargeMetricsData')
        self.charge_metrics_data = attributes[:'ChargeMetricsData']
      end
      ...
      if attributes.has_key?(:'InvoiceDatas')
        if (value = attributes[:'InvoiceDatas']).is_a?(Array)
          self.invoice_datas = value
        end
      end
      ...
      if attributes.has_key?(:'PaymentTransactionNumber')
        self.payment_transaction_number = attributes[:'PaymentTransactionNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amendment_ids == o.amendment_ids &&
          charge_metrics_data == o.charge_metrics_data &&
          errors == o.errors &&
          gateway_response == o.gateway_response &&
          gateway_response_code == o.gateway_response_code &&
          invoice_datas == o.invoice_datas &&
    ...
    def hash
      [amendment_ids, charge_metrics_data, errors, gateway_response, gateway_response_code, invoice_datas, invoice_id, payment_id, payment_transaction_number, subscription_id, success, total_delta_mrr, total_delta_tcv].hash
    end
