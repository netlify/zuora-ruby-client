...
module Zuora
  ...
  class OrderAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderMetrics')
        self.order_metrics = attributes[:'orderMetrics']
      end
    ...
    def hash
      [add_product, cancel_subscription, create_subscription, custom_fields, order_metrics, owner_transfer, remove_product, sequence, terms_and_conditions, trigger_dates, type, update_product].hash
    end
