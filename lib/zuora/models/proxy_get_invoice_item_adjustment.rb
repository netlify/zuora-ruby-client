...
module Zuora
  ...
  class ProxyGetInvoiceItemAdjustment
    ...
    attr_accessor :adjustment_number
    ...
    attr_accessor :invoice_item_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdjustmentNumber')
        self.adjustment_number = attributes[:'AdjustmentNumber']
      end
      ...
      if attributes.has_key?(:'InvoiceItemName')
        self.invoice_item_name = attributes[:'InvoiceItemName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          adjustment_number == o.adjustment_number &&
          amount == o.amount &&
          ...
          invoice_item_name == o.invoice_item_name &&
    ...
    def hash
      [account_id, accounting_code, adjustment_date, adjustment_number, amount, cancelled_by_id, cancelled_date, comment, created_by_id, created_date, customer_name, customer_number, id, invoice_id, invoice_item_name, invoice_number, reason_code, reference_id, service_end_date, service_start_date, source_id, source_type, status, transferred_to_accounting, type, updated_by_id, updated_date].hash
    end
