...
module Zuora
  ...
  class SubscribeRequestSubscriptionDataSubscription
    ...
    attr_accessor :ancestor_account_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AncestorAccountId')
        self.ancestor_account_id = attributes[:'AncestorAccountId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ancestor_account_id == o.ancestor_account_id &&
