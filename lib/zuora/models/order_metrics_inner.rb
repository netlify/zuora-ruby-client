...
module Zuora
  ...
  class OrderMetricsInner
    attr_accessor :charge_number

    attr_accessor :mrr

    attr_accessor :origin_rate_plan_id
    ...
    def self.swagger_types
      {
        ...
        :'mrr' => :'Array<TimeSlicedNetMetrics>',
        :'origin_rate_plan_id' => :'String',
        :'product_rate_plan_charge_id' => :'String',
        :'product_rate_plan_id' => :'String',
        :'quantity' => :'Array<TimeSlicedMetrics>',
        :'tcb' => :'Array<TimeSlicedTcbNetMetrics>',
        :'tcv' => :'Array<TimeSlicedNetMetrics>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mrr')
        if (value = attributes[:'mrr']).is_a?(Array)
          self.mrr = value
        end
      end

      if attributes.has_key?(:'originRatePlanId')
        self.origin_rate_plan_id = attributes[:'originRatePlanId']
      end
      ...
      if attributes.has_key?(:'quantity')
        if (value = attributes[:'quantity']).is_a?(Array)
          self.quantity = value
        end
      end

      if attributes.has_key?(:'tcb')
        if (value = attributes[:'tcb']).is_a?(Array)
          self.tcb = value
        end
      end

      if attributes.has_key?(:'tcv')
        if (value = attributes[:'tcv']).is_a?(Array)
          self.tcv = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mrr == o.mrr &&
          origin_rate_plan_id == o.origin_rate_plan_id &&
    ...
    def hash
      [charge_number, mrr, origin_rate_plan_id, product_rate_plan_charge_id, product_rate_plan_id, quantity, tcb, tcv].hash
    end
