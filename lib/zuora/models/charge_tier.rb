...
module Zuora
  class ChargeTier
    ...
    def list_invalid_properties
      ...
      if @starting_unit.nil?
        invalid_properties.push('invalid value for "starting_unit", starting_unit cannot be nil.')
      end
      ...
      if @tier < 1
        invalid_properties.push('invalid value for "tier", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      price_format_validator = EnumAttributeValidator.new('String', ['FlatFee', 'PerUnit'])
      return false unless price_format_validator.valid?(@price_format)
      return false if @starting_unit.nil?
      return false if @tier.nil?
      return false if @tier < 1
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] price_format Object to be assigned
    def price_format=(price_format)
      validator = EnumAttributeValidator.new('String', ['FlatFee', 'PerUnit'])
      unless validator.valid?(price_format)
        fail ArgumentError, 'invalid value for "price_format", must be one of #{validator.allowable_values}.'
      end
    ...
    def tier=(tier)
      ...
      if tier < 1
        fail ArgumentError, 'invalid value for "tier", must be greater than or equal to 1.'
      end
    ...
    def hash
      [ending_unit, price, price_format, starting_unit, tier].hash
    end
