...
module Zuora
  ...
  class ProxyGetContact
    ...
    #  The county. May optionally be used by Zuora Tax to calculate county tax. **Character limit**: 32 **Values**: a string of 32 characters or fewer 
    ...
    def hash
      [account_id, address1, address2, city, country, county, created_by_id, created_date, description, fax, first_name, home_phone, id, last_name, mobile_phone, nick_name, other_phone, other_phone_type, personal_email, postal_code, state, tax_region, updated_by_id, updated_date, work_email, work_phone].hash
    end
