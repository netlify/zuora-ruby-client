...
module Zuora
  ...
  class POSTTaxationItemForCMTypeFinanceInformation
    ...
    attr_accessor :sales_tax_payable_accounting_code
    ...
    def self.swagger_types
      {
        ...
        :'sales_tax_payable_accounting_code' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'salesTaxPayableAccountingCode')
        self.sales_tax_payable_accounting_code = attributes[:'salesTaxPayableAccountingCode']
      end
    ...
    def list_invalid_properties
      ...
      if !@sales_tax_payable_accounting_code.nil? && @sales_tax_payable_accounting_code.to_s.length > 100
        invalid_properties.push("invalid value for 'sales_tax_payable_accounting_code', the character length must be smaller than or equal to 100.")
      end

      if !@sales_tax_payable_accounting_code.nil? && @sales_tax_payable_accounting_code.to_s.length < 0
        invalid_properties.push("invalid value for 'sales_tax_payable_accounting_code', the character length must be great than or equal to 0.")
      end
    ...
    def valid?
      ...
      return false if !@sales_tax_payable_accounting_code.nil? && @sales_tax_payable_accounting_code.to_s.length > 100
      return false if !@sales_tax_payable_accounting_code.nil? && @sales_tax_payable_accounting_code.to_s.length < 0
      return true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] sales_tax_payable_accounting_code Value to be assigned
    def sales_tax_payable_accounting_code=(sales_tax_payable_accounting_code)

      if !sales_tax_payable_accounting_code.nil? && sales_tax_payable_accounting_code.to_s.length > 100
        fail ArgumentError, "invalid value for 'sales_tax_payable_accounting_code', the character length must be smaller than or equal to 100."
      end

      if !sales_tax_payable_accounting_code.nil? && sales_tax_payable_accounting_code.to_s.length < 0
        fail ArgumentError, "invalid value for 'sales_tax_payable_accounting_code', the character length must be great than or equal to 0."
      end

      @sales_tax_payable_accounting_code = sales_tax_payable_accounting_code
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sales_tax_payable_accounting_code == o.sales_tax_payable_accounting_code
    end
    ...
    def hash
      [on_account_accounting_code, sales_tax_payable_accounting_code].hash
    end
