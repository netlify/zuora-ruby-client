...
module Zuora
  ...
  class PUTRevenueScheduleResponseType
    ...
    attr_accessor :revenue_event_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'revenueEventNumber')
        self.revenue_event_number = attributes[:'revenueEventNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          revenue_event_number == o.revenue_event_number &&
          success == o.success
    end
    ...
    def hash
      [revenue_event_number, success].hash
    end
