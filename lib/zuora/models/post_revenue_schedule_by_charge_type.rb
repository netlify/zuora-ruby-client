...
module Zuora
  class POSTRevenueScheduleByChargeType
    ...
    attr_accessor :deferred_revenue_accounting_code_type
    ...
    attr_accessor :override_charge_accounting_codes
    ...
    attr_accessor :recognized_revenue_accounting_code_type
    ...
    attr_accessor :revenue_distributions

    attr_accessor :revenue_event
    ...
    attr_accessor :revenue_schedule_date
    ...
    def self.swagger_types
      {
        ...
        :'notes' => :'String',
        :'override_charge_accounting_codes' => :'BOOLEAN',
        :'recognized_revenue_accounting_code' => :'String',
        :'recognized_revenue_accounting_code_type' => :'String',
        :'reference_id' => :'String',
        :'revenue_distributions' => :'Array<POSTDistributionItemType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deferredRevenueAccountingCodeType')
        self.deferred_revenue_accounting_code_type = attributes[:'deferredRevenueAccountingCodeType']
      end
      ...
      if attributes.has_key?(:'overrideChargeAccountingCodes')
        self.override_charge_accounting_codes = attributes[:'overrideChargeAccountingCodes']
      else
        self.override_charge_accounting_codes = false
      end
      ...
      if attributes.has_key?(:'recognizedRevenueAccountingCodeType')
        self.recognized_revenue_accounting_code_type = attributes[:'recognizedRevenueAccountingCodeType']
      end
      ...
      if attributes.has_key?(:'revenueDistributions')
        if (value = attributes[:'revenueDistributions']).is_a?(Array)
          self.revenue_distributions = value
        end
      end

      if attributes.has_key?(:'revenueEvent')
        self.revenue_event = attributes[:'revenueEvent']
      end

      if attributes.has_key?(:'revenueScheduleDate')
        self.revenue_schedule_date = attributes[:'revenueScheduleDate']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @revenue_schedule_date.nil?
        invalid_properties.push('invalid value for "revenue_schedule_date", revenue_schedule_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @revenue_schedule_date.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deferred_revenue_accounting_code_type == o.deferred_revenue_accounting_code_type &&
          notes == o.notes &&
          override_charge_accounting_codes == o.override_charge_accounting_codes &&
          recognized_revenue_accounting_code == o.recognized_revenue_accounting_code &&
          recognized_revenue_accounting_code_type == o.recognized_revenue_accounting_code_type &&
          reference_id == o.reference_id &&
          revenue_distributions == o.revenue_distributions &&
          revenue_event == o.revenue_event &&
          revenue_schedule_date == o.revenue_schedule_date
    end
    ...
    def hash
      [amount, custom_field__c, deferred_revenue_accounting_code, deferred_revenue_accounting_code_type, notes, override_charge_accounting_codes, recognized_revenue_accounting_code, recognized_revenue_accounting_code_type, reference_id, revenue_distributions, revenue_event, revenue_schedule_date].hash
    end
