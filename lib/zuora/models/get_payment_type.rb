...
module Zuora
  ...
  class GETPaymentType
    ...
    attr_accessor :gateway_transaction_number
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'paid_invoices' => :'Array<GETPaidInvoicesType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gatewayTransactionNumber')
        self.gateway_transaction_number = attributes[:'gatewayTransactionNumber']
      end
      ...
      if attributes.has_key?(:'paidInvoices')
        if (value = attributes[:'paidInvoices']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gateway_transaction_number == o.gateway_transaction_number &&
          id == o.id &&
    ...
    def hash
      [account_id, account_name, account_number, amount, custom_field__c, effective_date, gateway_transaction_number, id, paid_invoices, payment_method_id, payment_number, status, type].hash
    end
