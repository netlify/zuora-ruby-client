...
module Zuora
  # The JSON object containing the information for a charge override in the 'AddProduct' type order action.
  class ChargeOverride
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uniqueToken')
        self.unique_token = attributes[:'uniqueToken']
      end
    ...
    def list_invalid_properties
      ...
      if !@charge_number.nil? && @charge_number.to_s.length > 50
        invalid_properties.push("invalid value for 'charge_number', the character length must be smaller than or equal to 50.")
      end
      ...
      if !@unique_token.nil? && @unique_token.to_s.length > 50
        invalid_properties.push("invalid value for 'unique_token', the character length must be smaller than or equal to 50.")
      end
    ...
    def valid?
      return false if !@charge_number.nil? && @charge_number.to_s.length > 50
      return false if !@description.nil? && @description.to_s.length > 500
      return false if @product_rate_plan_charge_id.nil?
      return false if !@unique_token.nil? && @unique_token.to_s.length > 50
      return true
    end

    # Custom attribute writer method with validation
    # @param [Object] charge_number Value to be assigned
    def charge_number=(charge_number)

      if !charge_number.nil? && charge_number.to_s.length > 50
        fail ArgumentError, "invalid value for 'charge_number', the character length must be smaller than or equal to 50."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] unique_token Value to be assigned
    def unique_token=(unique_token)

      if !unique_token.nil? && unique_token.to_s.length > 50
        fail ArgumentError, "invalid value for 'unique_token', the character length must be smaller than or equal to 50."
      end
    ...
    def hash
      [billing, charge_number, custom_fields, description, end_date, pricing, product_rate_plan_charge_id, start_date, unique_token].hash
    end
