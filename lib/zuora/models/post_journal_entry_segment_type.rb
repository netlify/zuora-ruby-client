...
module Zuora
  ...
  class POSTJournalEntrySegmentType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'segmentValue')
        self.segment_value = attributes[:'segmentValue']
      end
    ...
    def list_invalid_properties
      ...
      if @segment_value.nil?
        invalid_properties.push("invalid value for 'segment_value', segment_value cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @segment_value.nil?
      return true
    end
    ...
    def hash
      [segment_name, segment_value].hash
    end
