...
module Zuora
  ...
  class SubscribeRequestSubscribeOptions
    ...
    attr_accessor :electronic_payment_options

    attr_accessor :external_payment_options

    # 
    attr_accessor :generate_invoice

    # 
    attr_accessor :process_payments

    attr_accessor :subscribe_invoice_processing_options
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ElectronicPaymentOptions')
        self.electronic_payment_options = attributes[:'ElectronicPaymentOptions']
      end

      if attributes.has_key?(:'ExternalPaymentOptions')
        self.external_payment_options = attributes[:'ExternalPaymentOptions']
      end

      if attributes.has_key?(:'GenerateInvoice')
        self.generate_invoice = attributes[:'GenerateInvoice']
      end

      if attributes.has_key?(:'ProcessPayments')
        self.process_payments = attributes[:'ProcessPayments']
      end

      if attributes.has_key?(:'SubscribeInvoiceProcessingOptions')
        self.subscribe_invoice_processing_options = attributes[:'SubscribeInvoiceProcessingOptions']
      end
    ...
    def list_invalid_properties
      ...
      if @generate_invoice.nil?
        invalid_properties.push("invalid value for 'generate_invoice', generate_invoice cannot be nil.")
      end

      if @process_payments.nil?
        invalid_properties.push("invalid value for 'process_payments', process_payments cannot be nil.")
      end
    ...
    def valid?
      return false if @generate_invoice.nil?
      return false if @process_payments.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          electronic_payment_options == o.electronic_payment_options &&
          external_payment_options == o.external_payment_options &&
          generate_invoice == o.generate_invoice &&
          process_payments == o.process_payments &&
          subscribe_invoice_processing_options == o.subscribe_invoice_processing_options
    end
    ...
    def hash
      [apply_credit_balance, electronic_payment_options, external_payment_options, generate_invoice, process_payments, subscribe_invoice_processing_options].hash
    end
