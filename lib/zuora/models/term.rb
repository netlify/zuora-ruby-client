...
module Zuora
  ...
  class Term
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isEvergreen')
        self.is_evergreen = attributes[:'isEvergreen']
      end
    ...
    def hash
      [end_date, is_evergreen, start_date, term_number].hash
    end
