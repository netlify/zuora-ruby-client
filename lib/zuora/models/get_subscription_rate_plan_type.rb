...
module Zuora
  ...
  class GETSubscriptionRatePlanType
    ...
    attr_accessor :last_change_type
    ...
    attr_accessor :subscription_product_features
    ...
    def self.swagger_types
      {
        ...
        :'product_sku' => :'String',
        :'rate_plan_charges' => :'Array<GETSubscriptionRatePlanChargesType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastChangeType')
        self.last_change_type = attributes[:'lastChangeType']
      end
      ...
      if attributes.has_key?(:'ratePlanCharges')
        if (value = attributes[:'ratePlanCharges']).is_a?(Array)
          self.rate_plan_charges = value
        end
      end

      if attributes.has_key?(:'ratePlanName')
        self.rate_plan_name = attributes[:'ratePlanName']
      end

      if attributes.has_key?(:'subscriptionProductFeatures')
        if (value = attributes[:'subscriptionProductFeatures']).is_a?(Array)
          self.subscription_product_features = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          last_change_type == o.last_change_type &&
          product_id == o.product_id &&
          product_name == o.product_name &&
          product_rate_plan_id == o.product_rate_plan_id &&
          product_sku == o.product_sku &&
          rate_plan_charges == o.rate_plan_charges &&
          rate_plan_name == o.rate_plan_name &&
          subscription_product_features == o.subscription_product_features
    end
    ...
    def hash
      [custom_field__c, id, last_change_type, product_id, product_name, product_rate_plan_id, product_sku, rate_plan_charges, rate_plan_name, subscription_product_features].hash
    end
