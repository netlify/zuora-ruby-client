...
module Zuora
  ...
  class POSTRevenueScheduleByChargeTypeRevenueEvent
    ...
    def list_invalid_properties
      ...
      if @event_type_system_id.nil?
        invalid_properties.push('invalid value for "event_type_system_id", event_type_system_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @event_type_system_id.nil?
      true
    end
    ...
    def hash
      [custom_field__c, event_type, event_type_system_id, notes].hash
    end
