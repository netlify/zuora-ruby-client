...
module Zuora
  class POSTUsageType
    # The account number associated with the usage record. The customer account must be the subscription owner. 
    ...
    # The start date and time when the usage is consumed.   See [supported date and time format](https://knowledgecenter.zuora.com/CB_Billing/WA_Dates_in_Zuora/A_Date_and_dateTime_Format#section_2). 
    ...
    # A unique key of the usage record. You can define the unique key for each usage record.  
    ...
    def list_invalid_properties
      ...
      if @account_number.to_s.length > 70
      ...
      if @unit_of_measure.to_s.length > 50
    ...
    def valid?
      ...
      return false if @account_number.to_s.length > 70
      ...
      return false if @unit_of_measure.to_s.length > 50
      true
    end
    ...
    def unit_of_measure=(unit_of_measure)
      if unit_of_measure.nil?
        fail ArgumentError, 'unit_of_measure cannot be nil'
      end
    ...
    def hash
      [account_number, custom_fields, description, group_id, quantity, start_date_time, tag, unique_key, unit_of_measure].hash
    end
