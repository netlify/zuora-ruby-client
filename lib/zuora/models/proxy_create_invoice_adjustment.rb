...
module Zuora
  ...
  class ProxyCreateInvoiceAdjustment
    ...
    def hash
      [account_id, accounting_code, adjustment_date, adjustment_number, amount, comments, customer_name, customer_number, impact_amount, invoice_id, invoice_number, reason_code, reference_id, status, type].hash
    end
