...
module Zuora
  class GetRatedResultsType
    # The number of data sets in the returned page of the response.  
    attr_accessor :count

    # The cursor indicator of the next page of data.   You can pass the value of the `cursor` field in as the cursor parameter for a subsequent call to get the next page of data. If there is no data after the current page, the cursor returns `null`.  
    attr_accessor :cursor

    attr_accessor :data_set

    # Whether the query results have more data after the current page. 
    ...
    def self.swagger_types
      {
        :'count' => :'Integer',
        :'cursor' => :'String',
        :'data_set' => :'Array<GETARatedResultType>',
        :'has_more' => :'BOOLEAN'
      }
    end
    ...
    def hash
      [count, cursor, data_set, has_more].hash
    end
