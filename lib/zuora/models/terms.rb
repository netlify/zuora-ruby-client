...
module Zuora
  ...
  class Terms
    ...
    def self.swagger_types
      {
        ...
        :'renewal_terms' => :'Array<RenewalTerm>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'renewalTerms')
        if (value = attributes[:'renewalTerms']).is_a?(Array)
          self.renewal_terms = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @initial_term.nil?
        invalid_properties.push("invalid value for 'initial_term', initial_term cannot be nil.")
      end

      if @renewal_terms.nil?
        invalid_properties.push("invalid value for 'renewal_terms', renewal_terms cannot be nil.")
      end
    ...
    def valid?
      return false if @initial_term.nil?
      renewal_setting_validator = EnumAttributeValidator.new('String', ["RENEW_WITH_SPECIFIC_TERM", "RENEW_TO_EVERGREEN"])
      return false unless renewal_setting_validator.valid?(@renewal_setting)
      return false if @renewal_terms.nil?
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] renewal_setting Object to be assigned
    def renewal_setting=(renewal_setting)
      validator = EnumAttributeValidator.new('String', ["RENEW_WITH_SPECIFIC_TERM", "RENEW_TO_EVERGREEN"])
      unless validator.valid?(renewal_setting)
        fail ArgumentError, "invalid value for 'renewal_setting', must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [auto_renew, initial_term, renewal_setting, renewal_terms].hash
    end
