...
module Zuora
  ...
  class PUTCreditMemoType
    ...
    def self.swagger_types
      {
        ...
        :'items' => :'Array<PUTCreditMemoItemType>',
        :'reason_code' => :'String',
    ...
    def hash
      [auto_apply_upon_posting, comment, custom_field__c, effective_date, exclude_from_auto_apply_rules, items, reason_code, transferred_to_accounting].hash
    end
