...
module Zuora
  ...
  class PUTSubscriptionResumeType
    ...
    def list_invalid_properties
      ...
      if @resume_policy.nil?
        invalid_properties.push("invalid value for 'resume_policy', resume_policy cannot be nil.")
      end
    ...
    def valid?
      return false if @resume_policy.nil?
      return true
    end
    ...
    def hash
      [apply_credit_balance, collect, contract_effective_date, extends_term, invoice, invoice_collect, invoice_target_date, resume_periods, resume_periods_type, resume_policy, resume_specific_date, run_billing, target_date].hash
    end
