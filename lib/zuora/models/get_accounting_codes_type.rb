...
module Zuora
  ...
  class GETAccountingCodesType
    ...
    attr_accessor :accounting_codes
    ...
    def self.swagger_types
      {
        :'accounting_codes' => :'Array<GETAccountingCodeItemWithoutSuccessType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingCodes')
        if (value = attributes[:'accountingCodes']).is_a?(Array)
          self.accounting_codes = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounting_codes == o.accounting_codes &&
    ...
    def hash
      [accounting_codes, next_page, success].hash
    end
