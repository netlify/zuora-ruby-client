...
module Zuora
  class GETDebitMemoItemTypewithSuccess
    ...
    def hash
      [amount, balance, be_applied_amount, comment, created_by_id, created_date, custom_field__c, finance_information, id, service_end_date, service_start_date, sku, sku_name, source_item_id, source_item_type, subscription_id, tax_items, updated_by_id, updated_date].hash
    end
