...
module Zuora
  ...
  class POSTJournalEntryItemType
    ...
    def list_invalid_properties
      ...
      if @accounting_code_name.nil?
        invalid_properties.push("invalid value for 'accounting_code_name', accounting_code_name cannot be nil.")
      end
    ...
    def valid?
      return false if @accounting_code_name.nil?
    ...
    def hash
      [accounting_code_name, accounting_code_type, amount, custom_field__c, home_currency_amount, type].hash
    end
