...
module Zuora
  # The JSON object containing the information for the 'UpdateProduct' type order action.
  class RatePlanUpdate
    attr_accessor :charge_updates
    ...
    # Used for the 'update before update' and 'update before remove' cases.
    ...
    def self.swagger_types
      {
        :'charge_updates' => :'Array<ChargeUpdate>',
        :'custom_fields' => :'CustomFields',
        :'rate_plan_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeUpdates')
        if (value = attributes[:'chargeUpdates']).is_a?(Array)
          self.charge_updates = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          charge_updates == o.charge_updates &&
    ...
    def hash
      [charge_updates, custom_fields, rate_plan_id, specific_update_date, unique_token].hash
    end
