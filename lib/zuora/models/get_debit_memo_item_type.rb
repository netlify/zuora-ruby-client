...
module Zuora
  class GETDebitMemoItemType
    ...
    def self.swagger_types
      {
        ...
        :'success' => :'BOOLEAN',
        :'tax_items' => :'Array<GETDMTaxItemType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taxItems')
        if (value = attributes[:'taxItems']).is_a?(Array)
    ...
    def hash
      [amount, balance, be_applied_amount, comment, created_by_id, created_date, custom_field__c, finance_information, id, service_end_date, service_start_date, sku, sku_name, source_item_id, source_item_type, subscription_id, success, tax_items, updated_by_id, updated_date].hash
    end
