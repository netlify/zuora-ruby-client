...
module Zuora
  ...
  class PUTSpecificDateAllocationType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'distributeOn')
        self.distribute_on = attributes[:'distributeOn']
      end
    ...
    def list_invalid_properties
      ...
      if @distribute_on.nil?
        invalid_properties.push("invalid value for 'distribute_on', distribute_on cannot be nil.")
      end
    ...
    def valid?
      return false if @distribute_on.nil?
      return false if @distribution_type.nil?
      distribution_type_validator = EnumAttributeValidator.new('String', ["specific date (delta fixed amount)", "specific date (delta percent total)", "specific date (delta percent undistributed)"])
    ...
    def distribution_type=(distribution_type)
      validator = EnumAttributeValidator.new('String', ["specific date (delta fixed amount)", "specific date (delta percent total)", "specific date (delta percent undistributed)"])
    ...
    def hash
      [amount, custom_field__c, distribute_on, distribution_type, event_type, event_type_system_id, notes, percentage].hash
    end
