...
module Zuora
  # Container for rate plan data. This field is only required if the `Type` field is set to `NewProduct`, `RemoveProduct`, or `UpdateProduct`. 
  class ProxyCreateAmendmentRatePlanData
    ...
    def self.swagger_types
      {
        :'rate_plan' => :'ProxyCreateAmendmentRatePlanDataRatePlan',
        :'rate_plan_charge_data' => :'Array<AmendmentRatePlanChargeData>'
      }
    end
    ...
    def hash
      [rate_plan, rate_plan_charge_data].hash
    end
