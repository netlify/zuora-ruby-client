...
module Zuora
  class POSTDecryptResponseType
    ...
    attr_accessor :decrypted_signature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'decryptedSignature')
        self.decrypted_signature = attributes[:'decryptedSignature']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          decrypted_signature == o.decrypted_signature &&
    ...
    def hash
      [decrypted_signature, public_key, signature, success].hash
    end
