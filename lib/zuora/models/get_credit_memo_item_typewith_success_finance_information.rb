...
module Zuora
  ...
  class GETCreditMemoItemTypewithSuccessFinanceInformation
    ...
    attr_accessor :on_account_accounting_code_type
    ...
    attr_accessor :revenue_schedule_number
    ...
    def self.swagger_types
      {
        ...
        :'on_account_accounting_code_type' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'onAccountAccountingCodeType')
        self.on_account_accounting_code_type = attributes[:'onAccountAccountingCodeType']
      end
      ...
      if attributes.has_key?(:'revenueScheduleNumber')
        self.revenue_schedule_number = attributes[:'revenueScheduleNumber']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          on_account_accounting_code_type == o.on_account_accounting_code_type &&
          ...
          revenue_schedule_number == o.revenue_schedule_number
    end
    ...
    def hash
      [deferred_revenue_accounting_code, deferred_revenue_accounting_code_type, on_account_accounting_code, on_account_accounting_code_type, recognized_revenue_accounting_code, recognized_revenue_accounting_code_type, revenue_recognition_rule_name, revenue_schedule_number].hash
    end
