...
module Zuora
  ...
  class OrderRatedResult
    attr_accessor :order_number

    # An array of subscription changes included in this order.
    attr_accessor :subscription_rated_results
    ...
    def self.swagger_types
      {
        :'order_number' => :'String',
        :'subscription_rated_results' => :'Array<SubscriptionRatedResult>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subscriptionRatedResults')
        if (value = attributes[:'subscriptionRatedResults']).is_a?(Array)
          self.subscription_rated_results = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscription_rated_results == o.subscription_rated_results
    end
    ...
    def hash
      [order_number, subscription_rated_results].hash
    end
