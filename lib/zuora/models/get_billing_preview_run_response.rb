...
module Zuora
  ...
  class GetBillingPreviewRunResponse
    ...
    attr_accessor :succeeded_accounts
    ...
    def self.swagger_types
      {
        ...
        :'including_evergreen_subscription' => :'BOOLEAN',
        :'result_file_url' => :'String',
        :'run_number' => :'String',
        :'start_date' => :'String',
        :'status' => :'String',
        :'succeeded_accounts' => :'Integer',
        :'success' => :'BOOLEAN',
        :'target_date' => :'Date',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assumeRenewal')
        self.assume_renewal = attributes[:'assumeRenewal']
      end
      ...
      if attributes.has_key?(:'includingEvergreenSubscription')
        self.including_evergreen_subscription = attributes[:'includingEvergreenSubscription']
      end

      if attributes.has_key?(:'resultFileUrl')
        self.result_file_url = attributes[:'resultFileUrl']
      end

      if attributes.has_key?(:'runNumber')
        self.run_number = attributes[:'runNumber']
      end
      ...
      if attributes.has_key?(:'succeededAccounts')
        self.succeeded_accounts = attributes[:'succeededAccounts']
      end
      ...
      if attributes.has_key?(:'totalAccounts')
        self.total_accounts = attributes[:'totalAccounts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          assume_renewal == o.assume_renewal &&
          batch == o.batch &&
          ...
          including_evergreen_subscription == o.including_evergreen_subscription &&
          result_file_url == o.result_file_url &&
          run_number == o.run_number &&
          start_date == o.start_date &&
          status == o.status &&
          succeeded_accounts == o.succeeded_accounts &&
          success == o.success &&
    ...
    def hash
      [assume_renewal, batch, charge_type_to_exclude, created_by_id, created_date, end_date, error_message, including_evergreen_subscription, result_file_url, run_number, start_date, status, succeeded_accounts, success, target_date, total_accounts, updated_by_id, updated_date].hash
    end
