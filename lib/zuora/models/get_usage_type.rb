...
module Zuora
  class GETUsageType
    ...
    def hash
      [account_id, account_name, account_number, charge_number, custom_field__c, id, quantity, source_name, start_date_time, status, submission_date_time, subscription_number, unit_of_measure].hash
    end
