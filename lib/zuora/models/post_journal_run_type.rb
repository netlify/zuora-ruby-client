...
module Zuora
  ...
  class POSTJournalRunType
    ...
    def self.swagger_types
      {
        ...
        :'transaction_types' => :'Array<POSTJournalRunTransactionType>'
      }
    end
    ...
    def hash
      [accounting_period_name, journal_entry_date, target_end_date, target_start_date, transaction_types].hash
    end
