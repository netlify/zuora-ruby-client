...
module Zuora
  class Errors1
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rejectedValue')
        self.rejected_value = attributes[:'rejectedValue']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reason == o.reason &&
          rejected_value == o.rejected_value
    end
    ...
    def hash
      [message, object_name, reason, rejected_value].hash
    end
