...
module Zuora
  class CreditMemoUnapplyDebitMemoRequestType
    ...
    def self.swagger_types
      {
        ...
        :'items' => :'Array<CreditMemoUnapplyDebitMemoItemRequestType>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'debitMemoId')
        self.debit_memo_id = attributes[:'debitMemoId']
      end
    ...
    def list_invalid_properties
      ...
      if @debit_memo_id.nil?
        invalid_properties.push('invalid value for "debit_memo_id", debit_memo_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @debit_memo_id.nil?
      true
    end
    ...
    def hash
      [amount, debit_memo_id, items].hash
    end
