...
module Zuora
  class GETDebitMemoType
    ...
    attr_accessor :be_applied_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'beAppliedAmount')
        self.be_applied_amount = attributes[:'beAppliedAmount']
      end
      ...
      if attributes.has_key?(:'debitMemoDate')
        self.debit_memo_date = attributes[:'debitMemoDate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_pay == o.auto_pay &&
          balance == o.balance &&
          be_applied_amount == o.be_applied_amount &&
          ...
          debit_memo_date == o.debit_memo_date &&
          due_date == o.due_date &&
          id == o.id &&
    ...
    def hash
      [account_id, amount, auto_pay, balance, be_applied_amount, cancelled_by_id, cancelled_on, comment, created_by_id, created_date, custom_field__c, debit_memo_date, due_date, id, latest_pdf_file_id, number, posted_by_id, posted_on, reason_code, referred_invoice_id, status, success, target_date, tax_amount, total_tax_exempt_amount, transferred_to_accounting, updated_by_id, updated_date].hash
    end
