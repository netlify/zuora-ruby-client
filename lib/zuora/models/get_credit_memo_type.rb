...
module Zuora
  ...
  class GETCreditMemoType
    ...
    attr_accessor :auto_apply_upon_posting

    # The ID of the Zuora user who cancelled the credit memo. 
    attr_accessor :cancelled_by_id
    ...
    attr_accessor :credit_memo_date
    ...
    attr_accessor :referred_invoice_id
    ...
    attr_accessor :total_tax_exempt_amount
    ...
    def self.swagger_types
      {
        ...
        :'auto_apply_upon_posting' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appliedAmount')
        self.applied_amount = attributes[:'appliedAmount']
      end

      if attributes.has_key?(:'autoApplyUponPosting')
        self.auto_apply_upon_posting = attributes[:'autoApplyUponPosting']
      end

      if attributes.has_key?(:'cancelledById')
        self.cancelled_by_id = attributes[:'cancelledById']
      end
      ...
      if attributes.has_key?(:'creditMemoDate')
        self.credit_memo_date = attributes[:'creditMemoDate']
      end
      ...
      if attributes.has_key?(:'excludeFromAutoApplyRules')
        self.exclude_from_auto_apply_rules = attributes[:'excludeFromAutoApplyRules']
      end
      ...
      if attributes.has_key?(:'latestPDFFileId')
        self.latest_pdf_file_id = attributes[:'latestPDFFileId']
      end
      ...
      if attributes.has_key?(:'postedById')
        self.posted_by_id = attributes[:'postedById']
      end

      if attributes.has_key?(:'postedOn')
        self.posted_on = attributes[:'postedOn']
      end
      ...
      if attributes.has_key?(:'referredInvoiceId')
        self.referred_invoice_id = attributes[:'referredInvoiceId']
      end
      ...
      if attributes.has_key?(:'totalTaxExemptAmount')
        self.total_tax_exempt_amount = attributes[:'totalTaxExemptAmount']
      end
      ...
      if attributes.has_key?(:'unappliedAmount')
        self.unapplied_amount = attributes[:'unappliedAmount']
      end
    ...
    def valid?
      source_validator = EnumAttributeValidator.new('String', ["API", "BillRun", "AdhocFromPrpc", "AdhocFromInvoice"])
      return false unless source_validator.valid?(@source)
      status_validator = EnumAttributeValidator.new('String', ["Draft", "Posted", "Canceled", "Error", "PendingForTax", "Generating", "CancelInProgress"])
      return false unless status_validator.valid?(@status)
      transferred_to_accounting_validator = EnumAttributeValidator.new('String', ["Processing", "Yes", "Error", "Ignore"])
      return false unless transferred_to_accounting_validator.valid?(@transferred_to_accounting)
      return true
    end
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ["API", "BillRun", "AdhocFromPrpc", "AdhocFromInvoice"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Draft", "Posted", "Canceled", "Error", "PendingForTax", "Generating", "CancelInProgress"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] transferred_to_accounting Object to be assigned
    def transferred_to_accounting=(transferred_to_accounting)
      validator = EnumAttributeValidator.new('String', ["Processing", "Yes", "Error", "Ignore"])
      unless validator.valid?(transferred_to_accounting)
        fail ArgumentError, "invalid value for 'transferred_to_accounting', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_apply_upon_posting == o.auto_apply_upon_posting &&
          cancelled_by_id == o.cancelled_by_id &&
          cancelled_on == o.cancelled_on &&
          comment == o.comment &&
          created_by_id == o.created_by_id &&
          created_date == o.created_date &&
          credit_memo_date == o.credit_memo_date &&
          currency == o.currency &&
          custom_field__c == o.custom_field__c &&
          exclude_from_auto_apply_rules == o.exclude_from_auto_apply_rules &&
          id == o.id &&
          latest_pdf_file_id == o.latest_pdf_file_id &&
          number == o.number &&
          posted_by_id == o.posted_by_id &&
          posted_on == o.posted_on &&
          reason_code == o.reason_code &&
          referred_invoice_id == o.referred_invoice_id &&
          ...
          total_tax_exempt_amount == o.total_tax_exempt_amount &&
          transferred_to_accounting == o.transferred_to_accounting &&
          unapplied_amount == o.unapplied_amount &&
    ...
    def hash
      [account_id, amount, applied_amount, auto_apply_upon_posting, cancelled_by_id, cancelled_on, comment, created_by_id, created_date, credit_memo_date, currency, custom_field__c, exclude_from_auto_apply_rules, id, latest_pdf_file_id, number, posted_by_id, posted_on, reason_code, referred_invoice_id, refund_amount, source, source_id, status, success, target_date, tax_amount, total_tax_exempt_amount, transferred_to_accounting, unapplied_amount, updated_by_id, updated_date].hash
    end
