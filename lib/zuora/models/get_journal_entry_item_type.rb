...
module Zuora
  ...
  class GETJournalEntryItemType
    ...
    attr_accessor :gl_account_number

    # Journal entry item amount in home currency. 
    attr_accessor :home_currency_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingCodeName')
        self.accounting_code_name = attributes[:'accountingCodeName']
      end

      if attributes.has_key?(:'accountingCodeType')
        self.accounting_code_type = attributes[:'accountingCodeType']
      end
      ...
      if attributes.has_key?(:'glAccountName')
        self.gl_account_name = attributes[:'glAccountName']
      end

      if attributes.has_key?(:'glAccountNumber')
        self.gl_account_number = attributes[:'glAccountNumber']
      end

      if attributes.has_key?(:'homeCurrencyAmount')
        self.home_currency_amount = attributes[:'homeCurrencyAmount']
      end
    ...
    def valid?
      accounting_code_type_validator = EnumAttributeValidator.new('String', ["AccountsReceivable", "On-Account Receivable", "Cash", "OtherAssets", "CustomerCashOnAccount", "DeferredRevenue", "SalesTaxPayable", "OtherLiabilities", "SalesRevenue", "SalesDiscounts", "OtherRevenue", "OtherEquity", "BadDebt", "OtherExpenses"])
      return false unless accounting_code_type_validator.valid?(@accounting_code_type)
    ...
    # @param [Object] accounting_code_type Object to be assigned
    def accounting_code_type=(accounting_code_type)
      validator = EnumAttributeValidator.new('String', ["AccountsReceivable", "On-Account Receivable", "Cash", "OtherAssets", "CustomerCashOnAccount", "DeferredRevenue", "SalesTaxPayable", "OtherLiabilities", "SalesRevenue", "SalesDiscounts", "OtherRevenue", "OtherEquity", "BadDebt", "OtherExpenses"])
      unless validator.valid?(accounting_code_type)
        fail ArgumentError, "invalid value for 'accounting_code_type', must be one of #{validator.allowable_values}."
      end
      @accounting_code_type = accounting_code_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounting_code_name == o.accounting_code_name &&
          accounting_code_type == o.accounting_code_type &&
          amount == o.amount &&
          custom_field__c == o.custom_field__c &&
          gl_account_name == o.gl_account_name &&
          gl_account_number == o.gl_account_number &&
          home_currency_amount == o.home_currency_amount &&
          type == o.type
    end
    ...
    def hash
      [accounting_code_name, accounting_code_type, amount, custom_field__c, gl_account_name, gl_account_number, home_currency_amount, type].hash
    end
