...
module Zuora
  ...
  class RatePlanChargeDataRatePlanCharge
    ...
    attr_accessor :rollover_balance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RolloverBalance')
        self.rollover_balance = attributes[:'RolloverBalance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rollover_balance == o.rollover_balance &&
          segment == o.segment &&
    ...
    def hash
      [accounting_code, apply_discount_to, bill_cycle_day, bill_cycle_type, billing_period, billing_period_alignment, billing_timing, charge_model, charge_number, charge_type, charged_through_date, created_by_id, created_date, dmrc, dtcv, description, discount_amount, discount_level, discount_percentage, effective_end_date, effective_start_date, end_date_condition, included_units, is_last_segment, list_price_base, mrr, name, number_of_periods, original_id, overage_calculation_option, overage_price, overage_unused_units_credit_option, price, price_change_option, price_increase_percentage, processed_through_date, product_rate_plan_charge_id, quantity, rate_plan_id, rev_rec_code, rev_rec_trigger_condition, revenue_recognition_rule_name, rollover_balance, segment, specific_billing_period, specific_end_date, tcv, trigger_date, trigger_event, uom, unused_units_credit_rates, up_to_periods, up_to_periods_type, updated_by_id, updated_date, usage_record_rating_option, use_discount_specific_accounting_code, version, weekly_bill_cycle_day].hash
    end
