...
module Zuora
  # The JSON object containing the information related to the 'CreateSubscription' type of request.
  class CreateSubscription
    attr_accessor :invoice_separately

    attr_accessor :new_subscription_owner_account

    attr_accessor :notes

    attr_accessor :subscribe_to_rate_plans

    # The subscription number for the new subscription.
    attr_accessor :subscription_number

    # The subscription owner account number this subscription will be created under. It can be either the subscriptionOwnerAccountNumber or the newSubscriptionOwnerAccount info provided. It will return an error if both are specified. 
    attr_accessor :subscription_owner_account_number
    ...
    def self.swagger_types
      {
        ...
        :'new_subscription_owner_account' => :'NewSubscriptionOwnerAccount',
        :'notes' => :'String',
        :'subscribe_to_rate_plans' => :'Array<RatePlanOverride>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invoiceSeparately')
        self.invoice_separately = attributes[:'invoiceSeparately']
      end

      if attributes.has_key?(:'newSubscriptionOwnerAccount')
        self.new_subscription_owner_account = attributes[:'newSubscriptionOwnerAccount']
      end
      ...
      if attributes.has_key?(:'subscribeToRatePlans')
        if (value = attributes[:'subscribeToRatePlans']).is_a?(Array)
          self.subscribe_to_rate_plans = value
        end
      end

      if attributes.has_key?(:'subscriptionNumber')
        self.subscription_number = attributes[:'subscriptionNumber']
      end

      if attributes.has_key?(:'subscriptionOwnerAccountNumber')
        self.subscription_owner_account_number = attributes[:'subscriptionOwnerAccountNumber']
      end
    ...
    def list_invalid_properties
      ...
      if !@subscription_number.nil? && @subscription_number.to_s.length > 100
        invalid_properties.push('invalid value for "subscription_number", the character length must be smaller than or equal to 100.')
      end

      if !@subscription_owner_account_number.nil? && @subscription_owner_account_number.to_s.length > 70
        invalid_properties.push('invalid value for "subscription_owner_account_number", the character length must be smaller than or equal to 70.')
      end
    ...
    def valid?
      ...
      return false if !@subscription_number.nil? && @subscription_number.to_s.length > 100
      return false if !@subscription_owner_account_number.nil? && @subscription_owner_account_number.to_s.length > 70
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] subscription_number Value to be assigned
    def subscription_number=(subscription_number)
      if !subscription_number.nil? && subscription_number.to_s.length > 100
        fail ArgumentError, 'invalid value for "subscription_number", the character length must be smaller than or equal to 100.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] subscription_owner_account_number Value to be assigned
    def subscription_owner_account_number=(subscription_owner_account_number)
      if !subscription_owner_account_number.nil? && subscription_owner_account_number.to_s.length > 70
        fail ArgumentError, 'invalid value for "subscription_owner_account_number", the character length must be smaller than or equal to 70.'
      end

      @subscription_owner_account_number = subscription_owner_account_number
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          invoice_separately == o.invoice_separately &&
          new_subscription_owner_account == o.new_subscription_owner_account &&
          notes == o.notes &&
          subscribe_to_rate_plans == o.subscribe_to_rate_plans &&
          subscription_number == o.subscription_number &&
          subscription_owner_account_number == o.subscription_owner_account_number &&
          terms == o.terms
    end
    ...
    def hash
      [invoice_separately, new_subscription_owner_account, notes, subscribe_to_rate_plans, subscription_number, subscription_owner_account_number, terms].hash
    end
