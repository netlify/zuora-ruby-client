...
module Zuora
  ...
  class GETSubscriptionTypeWithSuccess
    ...
    # 
    attr_accessor :invoice_owner_account_id

    # 
    attr_accessor :invoice_owner_account_name

    # 
    attr_accessor :invoice_owner_account_number
    ...
    attr_accessor :total_contracted_value
    ...
    def self.swagger_types
      {
        ...
        :'notes' => :'String',
        :'order_number' => :'String',
        :'rate_plans' => :'Array<GETSubscriptionRatePlanType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contractedMrr')
        self.contracted_mrr = attributes[:'contractedMrr']
      end
      ...
      if attributes.has_key?(:'invoiceOwnerAccountId')
        self.invoice_owner_account_id = attributes[:'invoiceOwnerAccountId']
      end

      if attributes.has_key?(:'invoiceOwnerAccountName')
        self.invoice_owner_account_name = attributes[:'invoiceOwnerAccountName']
      end

      if attributes.has_key?(:'invoiceOwnerAccountNumber')
        self.invoice_owner_account_number = attributes[:'invoiceOwnerAccountNumber']
      end
      ...
      if attributes.has_key?(:'ratePlans')
        if (value = attributes[:'ratePlans']).is_a?(Array)
          self.rate_plans = value
        end
      end
      ...
      if attributes.has_key?(:'totalContractedValue')
        self.total_contracted_value = attributes[:'totalContractedValue']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contracted_mrr == o.contracted_mrr &&
          ...
          invoice_owner_account_id == o.invoice_owner_account_id &&
          invoice_owner_account_name == o.invoice_owner_account_name &&
          invoice_owner_account_number == o.invoice_owner_account_number &&
          invoice_separately == o.invoice_separately &&
          notes == o.notes &&
          order_number == o.order_number &&
          rate_plans == o.rate_plans &&
          ...
          total_contracted_value == o.total_contracted_value
    end
    ...
    def hash
      [cpq_bundle_json_id__qt, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, account_id, account_name, account_number, auto_renew, contract_effective_date, contracted_mrr, current_term, current_term_period_type, custom_field__c, customer_acceptance_date, id, initial_term, initial_term_period_type, invoice_owner_account_id, invoice_owner_account_name, invoice_owner_account_number, invoice_separately, notes, order_number, rate_plans, renewal_setting, renewal_term, renewal_term_period_type, service_activation_date, status, subscription_number, subscription_start_date, success, term_end_date, term_start_date, term_type, total_contracted_value].hash
    end
