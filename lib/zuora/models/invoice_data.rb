...
module Zuora
  ...
  class InvoiceData
    ...
    def self.swagger_types
      {
        ...
        :'invoice_item' => :'Array<InvoiceItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InvoiceItem')
        if (value = attributes[:'InvoiceItem']).is_a?(Array)
          self.invoice_item = value
        end
      end
