...
module Zuora
  ...
  class BillingUpdate
    ...
    def list_invalid_properties
      ...
      if @billing_period_alignment.nil?
        invalid_properties.push("invalid value for 'billing_period_alignment', billing_period_alignment cannot be nil.")
      end
    ...
    def valid?
      return false if @billing_period_alignment.nil?
