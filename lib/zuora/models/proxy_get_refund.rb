...
module Zuora
  ...
  class ProxyGetRefund
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RefundNumber')
        self.refund_number = attributes[:'RefundNumber']
      end
    ...
    def hash
      [account_id, accounting_code, amount, cancelled_on, comment, created_by_id, created_date, gateway, gateway_response, gateway_response_code, gateway_state, id, marked_for_submission_on, method_type, payment_method_id, payment_method_snapshot_id, reason_code, reference_id, refund_date, refund_number, refund_transaction_time, second_refund_reference_id, settled_on, soft_descriptor, soft_descriptor_phone, source_type, status, submitted_on, transferred_to_accounting, type, updated_by_id, updated_date].hash
    end
