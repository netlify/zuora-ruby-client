  ...
  class SubscribeResult
    ...
    def self.swagger_types
      {
        ...
        :'invoice_data' => :'Array<InvoiceData>',
        :'invoice_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InvoiceData')
        if (value = attributes[:'InvoiceData']).is_a?(Array)
          self.invoice_data = value
        end
      end
      ...
      if attributes.has_key?(:'InvoiceResult')
        self.invoice_result = attributes[:'InvoiceResult']
      end
      ...
      if attributes.has_key?(:'TotalMrr')
        self.total_mrr = attributes[:'TotalMrr']
      end

      if attributes.has_key?(:'TotalTcv')
        self.total_tcv = attributes[:'TotalTcv']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invoice_result == o.invoice_result &&
    ...
    def hash
      [account_id, account_number, charge_metrics_data, errors, gateway_response, gateway_response_code, invoice_data, invoice_id, invoice_number, invoice_result, payment_id, payment_transaction_number, subscription_id, subscription_number, success, total_mrr, total_tcv].hash
    end
