...
module Zuora
  ...
  class POSTRevenueScheduleByDateRangeType
    ...
    def list_invalid_properties
      ...
      if @revenue_event.nil?
        invalid_properties.push("invalid value for 'revenue_event', revenue_event cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @revenue_event.nil?
      return true
    end
    ...
    def hash
      [custom_field__c, distribution_type, notes, recognition_end, recognition_start, revenue_event].hash
    end
