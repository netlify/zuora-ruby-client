...
module Zuora
  class ProxyModifySubscription
    ...
    def hash
      [account_id, auto_renew, cancelled_date, contract_acceptance_date, contract_effective_date, cpq_bundle_json_id__qt, current_term_period_type, initial_term, initial_term_period_type, invoice_owner_id, is_invoice_separate, name, notes, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, renewal_setting, renewal_term, renewal_term_period_type, service_activation_date, status, term_start_date, term_type, version].hash
    end
