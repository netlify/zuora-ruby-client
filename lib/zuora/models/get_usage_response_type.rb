...
module Zuora
  class GETUsageResponseType
    # The account number associated with this usage record. 
    attr_accessor :account_number

    # The ID of the user who created this usage record. 
    attr_accessor :created_by

    # The start date and time when this usage record is created. 
    attr_accessor :created_on

    attr_accessor :custom_fields

    # The description of this usage record. 
    attr_accessor :description

    # The name of the import file when the usage record is imported from the file. 
    attr_accessor :file_name

    # The group ID used for [usage rating by group](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/Usage/Usage_Rating_by_Group). Zuora groups the usage records based on the group ID when you choose the Custom Group option for usage rating.      **Note:** The Usage Rating by Group feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). 
    attr_accessor :group_id

    # The ID of this usage record. 
    attr_accessor :id

    # The ID of the usage import if this usage record is imported through a usage file.  
    attr_accessor :import_id

    # The number of units this usage record is used. 
    attr_accessor :quantity

    # The start date and time when this usage is consumed. 
    attr_accessor :start_date_time

    # The status of this usage record. 
    attr_accessor :status

    # Specifies which subscription, charge, or account this usage record is related to. 
    attr_accessor :tag

    # A unique key of this usage record. You can define the unique key for each usage record.  
    attr_accessor :unique_key

    # The unit used to measure the usage. 
    attr_accessor :unit_of_measure

    # The ID of the user who last updated this usage record. 
    attr_accessor :updated_by

    # The date and time when this usage record is last updated. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uniqueKey')
        self.unique_key = attributes[:'uniqueKey']
      end
    ...
    def list_invalid_properties
      ...
      if !@created_by.nil? && @created_by.to_s.length > 36
        invalid_properties.push('invalid value for "created_by", the character length must be smaller than or equal to 36.')
      end
      ...
      if !@file_name.nil? && @file_name.to_s.length > 50
        invalid_properties.push('invalid value for "file_name", the character length must be smaller than or equal to 50.')
      end

      if !@group_id.nil? && @group_id.to_s.length > 50
        invalid_properties.push('invalid value for "group_id", the character length must be smaller than or equal to 50.')
      end
      ...
      if !@unique_key.nil? && @unique_key.to_s.length > 50
        invalid_properties.push('invalid value for "unique_key", the character length must be smaller than or equal to 50.')
      end

      if !@unit_of_measure.nil? && @unit_of_measure.to_s.length > 50
        invalid_properties.push('invalid value for "unit_of_measure", the character length must be smaller than or equal to 50.')
      end

      if !@updated_by.nil? && @updated_by.to_s.length > 36
        invalid_properties.push('invalid value for "updated_by", the character length must be smaller than or equal to 36.')
      end
    ...
    def valid?
      ...
      return false if !@created_by.nil? && @created_by.to_s.length > 36
      return false if !@description.nil? && @description.to_s.length > 200
      return false if !@file_name.nil? && @file_name.to_s.length > 50
      return false if !@group_id.nil? && @group_id.to_s.length > 50
      return false if !@id.nil? && @id.to_s.length > 36
      return false if !@import_id.nil? && @import_id.to_s.length > 36
      status_validator = EnumAttributeValidator.new('String', ['Pending', 'Rated', 'Billed'])
      return false unless status_validator.valid?(@status)
      return false if !@tag.nil? && @tag.to_s.length > 50
      return false if !@unique_key.nil? && @unique_key.to_s.length > 50
      return false if !@unit_of_measure.nil? && @unit_of_measure.to_s.length > 50
      return false if !@updated_by.nil? && @updated_by.to_s.length > 36
      true
    end
    ...
    def created_by=(created_by)
      if !created_by.nil? && created_by.to_s.length > 36
        fail ArgumentError, 'invalid value for "created_by", the character length must be smaller than or equal to 36.'
      end
    ...
    def file_name=(file_name)
      if !file_name.nil? && file_name.to_s.length > 50
        fail ArgumentError, 'invalid value for "file_name", the character length must be smaller than or equal to 50.'
      end
    ...
    def group_id=(group_id)
      if !group_id.nil? && group_id.to_s.length > 50
        fail ArgumentError, 'invalid value for "group_id", the character length must be smaller than or equal to 50.'
      end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['Pending', 'Rated', 'Billed'])
    ...
    def unique_key=(unique_key)
      if !unique_key.nil? && unique_key.to_s.length > 50
        fail ArgumentError, 'invalid value for "unique_key", the character length must be smaller than or equal to 50.'
      end
    ...
    def unit_of_measure=(unit_of_measure)
      if !unit_of_measure.nil? && unit_of_measure.to_s.length > 50
        fail ArgumentError, 'invalid value for "unit_of_measure", the character length must be smaller than or equal to 50.'
      end
    ...
    def updated_by=(updated_by)
      if !updated_by.nil? && updated_by.to_s.length > 36
        fail ArgumentError, 'invalid value for "updated_by", the character length must be smaller than or equal to 36.'
      end
    ...
    def hash
      [account_number, created_by, created_on, custom_fields, description, file_name, group_id, id, import_id, quantity, start_date_time, status, tag, unique_key, unit_of_measure, updated_by, updated_on].hash
    end
