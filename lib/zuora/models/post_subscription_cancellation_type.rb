...
module Zuora
  class POSTSubscriptionCancellationType
    ...
    def list_invalid_properties
      ...
      if @invoice_collect.nil?
        invalid_properties.push('invalid value for "invoice_collect", invoice_collect cannot be nil.')
      end
    ...
    def hash
      [opportunity_close_date_qt, opportunity_name_qt, quote_business_type_qt, quote_number_qt, quote_type_qt, apply_credit_balance, cancellation_effective_date, cancellation_policy, collect, invoice, invoice_collect, invoice_target_date, run_billing, target_date].hash
    end
