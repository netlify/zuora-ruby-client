...
module Zuora
  ...
  class GETJournalEntryDetailType
    ...
    attr_accessor :accounting_period_name
    ...
    attr_accessor :aggregate_currency
    ...
    attr_accessor :journal_entry_date

    # Key name that represents the list of journal entry items. 
    attr_accessor :journal_entry_items
    ...
    attr_accessor :transfer_date_time
    ...
    def self.swagger_types
      {
        ...
        :'journal_entry_items' => :'Array<GETJournalEntryItemType>',
        :'notes' => :'String',
        :'number' => :'String',
        :'segments' => :'Array<GETJournalEntrySegmentType>',
        :'status' => :'String',
        :'success' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingPeriodName')
        self.accounting_period_name = attributes[:'accountingPeriodName']
      end

      if attributes.has_key?(:'aggregateCurrency')
        self.aggregate_currency = attributes[:'aggregateCurrency']
      end
      ...
      if attributes.has_key?(:'homeCurrency')
        self.home_currency = attributes[:'homeCurrency']
      end

      if attributes.has_key?(:'journalEntryDate')
        self.journal_entry_date = attributes[:'journalEntryDate']
      end

      if attributes.has_key?(:'journalEntryItems')
        if (value = attributes[:'journalEntryItems']).is_a?(Array)
          self.journal_entry_items = value
        end
      end
      ...
      if attributes.has_key?(:'timePeriodEnd')
        self.time_period_end = attributes[:'timePeriodEnd']
      end

      if attributes.has_key?(:'timePeriodStart')
        self.time_period_start = attributes[:'timePeriodStart']
      end
      ...
      if attributes.has_key?(:'transferDateTime')
        self.transfer_date_time = attributes[:'transferDateTime']
      end

      if attributes.has_key?(:'transferredBy')
        self.transferred_by = attributes[:'transferredBy']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["Created", "Cancelled"])
      return false unless status_validator.valid?(@status)
      transferred_to_accounting_validator = EnumAttributeValidator.new('String', ["No", "Processing", "Yes", "Error", "Ignore"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Created", "Cancelled"])
    ...
    def transferred_to_accounting=(transferred_to_accounting)
      validator = EnumAttributeValidator.new('String', ["No", "Processing", "Yes", "Error", "Ignore"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounting_period_name == o.accounting_period_name &&
          aggregate_currency == o.aggregate_currency &&
          currency == o.currency &&
          custom_field__c == o.custom_field__c &&
          home_currency == o.home_currency &&
          journal_entry_date == o.journal_entry_date &&
          journal_entry_items == o.journal_entry_items &&
          notes == o.notes &&
          number == o.number &&
          segments == o.segments &&
          status == o.status &&
          ...
          transfer_date_time == o.transfer_date_time &&
    ...
    def hash
      [accounting_period_name, aggregate_currency, currency, custom_field__c, home_currency, journal_entry_date, journal_entry_items, notes, number, segments, status, success, time_period_end, time_period_start, transaction_type, transfer_date_time, transferred_by, transferred_to_accounting].hash
    end
