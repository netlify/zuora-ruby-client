...
module Zuora
  ...
  class GETProductType
    ...
    def self.swagger_types
      {
        ...
        :'product_rate_plans' => :'Array<GETProductRatePlanType>',
        :'sku' => :'String',
        :'tags' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productFeatures')
        if (value = attributes[:'productFeatures']).is_a?(Array)
          self.product_features = value
        end
      end

      if attributes.has_key?(:'productRatePlans')
        if (value = attributes[:'productRatePlans']).is_a?(Array)
          self.product_rate_plans = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          name == o.name &&
          product_features == o.product_features &&
          product_rate_plans == o.product_rate_plans &&
          sku == o.sku &&
          tags == o.tags
    end
    ...
    def hash
      [category, custom_field__c, description, effective_end_date, effective_start_date, id, name, product_features, product_rate_plans, sku, tags].hash
    end
