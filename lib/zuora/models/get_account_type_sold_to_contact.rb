...
module Zuora
  ...
  class GETAccountTypeSoldToContact
    ...
    def hash
      [address1, address2, city, country, county, custom_field__c, fax, first_name, home_phone, last_name, mobile_phone, nickname, other_phone, other_phone_type, personal_email, state, tax_region, work_email, work_phone, zip_code].hash
    end
