...
module Zuora
  ...
  class AmendRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AmendOptions')
        self.amend_options = attributes[:'AmendOptions']
      end

      if attributes.has_key?(:'Amendments')
        if (value = attributes[:'Amendments']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @amendments.nil?
        invalid_properties.push("invalid value for 'amendments', amendments cannot be nil.")
      end
    ...
    def valid?
      return false if @amendments.nil?
      return true
    end
    ...
    def hash
      [amend_options, amendments, preview_options].hash
    end
