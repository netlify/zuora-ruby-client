...
module Zuora
  ...
  class ProxyCreateTaxationItem
    ...
    def list_invalid_properties
      ...
      if @tax_date.nil?
        invalid_properties.push("invalid value for 'tax_date', tax_date cannot be nil.")
      end
    ...
    def hash
      [accounting_code, exempt_amount, invoice_item_id, jurisdiction, location_code, name, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type].hash
    end
