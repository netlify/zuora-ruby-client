...
module Zuora
  class GETTaxationItemType
    ...
    def hash
      [created_by_id, created_date, custom_field__c, exempt_amount, finance_information, id, jurisdiction, location_code, memo_item_id, name, source_tax_item_id, success, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type, updated_by_id, updated_date].hash
    end
