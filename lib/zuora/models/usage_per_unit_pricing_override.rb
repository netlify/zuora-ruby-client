...
module Zuora
  class UsagePerUnitPricingOverride
    ...
    def valid?
      ...
      rating_group_validator = EnumAttributeValidator.new('String', ['ByBillingPeriod', 'ByUsageStartDate', 'ByUsageRecord', 'ByUsageUpload'])
      return false unless rating_group_validator.valid?(@rating_group)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] rating_group Object to be assigned
    def rating_group=(rating_group)
      validator = EnumAttributeValidator.new('String', ['ByBillingPeriod', 'ByUsageStartDate', 'ByUsageRecord', 'ByUsageUpload'])
      unless validator.valid?(rating_group)
        fail ArgumentError, 'invalid value for "rating_group", must be one of #{validator.allowable_values}.'
      end
    ...
    def hash
      [price_change_option, price_increase_percentage, list_price, rating_group].hash
    end
