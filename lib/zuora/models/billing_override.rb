...
module Zuora
  class BillingOverride
    # Specify only when the billCycleType is 'SpecificDayofMonth'.
    attr_accessor :bill_cycle_day

    # Specifies how the charge's bill cycle date is determined.
    attr_accessor :bill_cycle_type

    # Specify the billing frequency of the charge.
    ...
    # Specify only when the billingPeriod is 'Specific_Months' or 'Specific_Weeks'.
    attr_accessor :specific_billing_period

    # Specify only when the billCycleType is 'SpecificDayofWeek'.
    ...
    def valid?
      return false if !@bill_cycle_day.nil? && @bill_cycle_day > 31
      return false if !@bill_cycle_day.nil? && @bill_cycle_day < 1
      bill_cycle_type_validator = EnumAttributeValidator.new('String', ['DefaultFromCustomer', 'SpecificDayofMonth', 'SubscriptionStartDay', 'ChargeTriggerDay', 'SpecificDayofWeek'])
      return false unless bill_cycle_type_validator.valid?(@bill_cycle_type)
      billing_period_validator = EnumAttributeValidator.new('String', ['Month', 'Quarter', 'Semi_Annual', 'Annual', 'Eighteen_Months', 'Two_Years', 'Three_Years', 'Five_Years', 'Specific_Months', 'Subscription_Term', 'Week', 'Specific_Weeks'])
      return false unless billing_period_validator.valid?(@billing_period)
      billing_period_alignment_validator = EnumAttributeValidator.new('String', ['AlignToCharge', 'AlignToSubscriptionStart', 'AlignToTermStart'])
      return false unless billing_period_alignment_validator.valid?(@billing_period_alignment)
      billing_timing_validator = EnumAttributeValidator.new('String', ['IN_ADVANCE', 'IN_ARREARS'])
      return false unless billing_timing_validator.valid?(@billing_timing)
      true
    end
    ...
    # @param [Object] bill_cycle_type Object to be assigned
    def bill_cycle_type=(bill_cycle_type)
      validator = EnumAttributeValidator.new('String', ['DefaultFromCustomer', 'SpecificDayofMonth', 'SubscriptionStartDay', 'ChargeTriggerDay', 'SpecificDayofWeek'])
      unless validator.valid?(bill_cycle_type)
        fail ArgumentError, 'invalid value for "bill_cycle_type", must be one of #{validator.allowable_values}.'
      end
    ...
    def billing_period=(billing_period)
      validator = EnumAttributeValidator.new('String', ['Month', 'Quarter', 'Semi_Annual', 'Annual', 'Eighteen_Months', 'Two_Years', 'Three_Years', 'Five_Years', 'Specific_Months', 'Subscription_Term', 'Week', 'Specific_Weeks'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] billing_period_alignment Object to be assigned
    def billing_period_alignment=(billing_period_alignment)
      validator = EnumAttributeValidator.new('String', ['AlignToCharge', 'AlignToSubscriptionStart', 'AlignToTermStart'])
      unless validator.valid?(billing_period_alignment)
        fail ArgumentError, 'invalid value for "billing_period_alignment", must be one of #{validator.allowable_values}.'
      end
      @billing_period_alignment = billing_period_alignment
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] billing_timing Object to be assigned
    def billing_timing=(billing_timing)
      validator = EnumAttributeValidator.new('String', ['IN_ADVANCE', 'IN_ARREARS'])
      unless validator.valid?(billing_timing)
        fail ArgumentError, 'invalid value for "billing_timing", must be one of #{validator.allowable_values}.'
      end
    ...
    def hash
      [bill_cycle_day, bill_cycle_type, billing_period, billing_period_alignment, billing_timing, specific_billing_period, weekly_bill_cycle_day].hash
    end
