...
module Zuora
  ...
  class InlineResponse200
    ...
    attr_accessor :billing_preview_run_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billingPreviewRunId')
        self.billing_preview_run_id = attributes[:'billingPreviewRunId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          billing_preview_run_id == o.billing_preview_run_id
    end
    ...
    def hash
      [success, billing_preview_run_id].hash
    end
