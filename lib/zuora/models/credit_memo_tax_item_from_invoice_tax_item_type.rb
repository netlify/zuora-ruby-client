...
module Zuora
  ...
  class CreditMemoTaxItemFromInvoiceTaxItemType
    ...
    def hash
      [amount, finance_information, jurisdiction, location_code, source_tax_item_id, tax_code, tax_code_description, tax_date, tax_exempt_amount, tax_name, tax_rate, tax_rate_description, tax_rate_type].hash
    end
