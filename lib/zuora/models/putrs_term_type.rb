...
module Zuora
  class PUTRSTermType
    ...
    attr_accessor :event_type_system_id
    ...
    attr_accessor :recognition_start
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'distributionType')
        self.distribution_type = attributes[:'distributionType']
      end
      ...
      if attributes.has_key?(:'eventTypeSystemId')
        self.event_type_system_id = attributes[:'eventTypeSystemId']
      end
      ...
      if attributes.has_key?(:'recognitionEnd')
        self.recognition_end = attributes[:'recognitionEnd']
      end

      if attributes.has_key?(:'recognitionStart')
        self.recognition_start = attributes[:'recognitionStart']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @recognition_end.nil?
        invalid_properties.push('invalid value for "recognition_end", recognition_end cannot be nil.')
      end

      if @recognition_start.nil?
        invalid_properties.push('invalid value for "recognition_start", recognition_start cannot be nil.')
      end
    ...
    def valid?
      distribution_type_validator = EnumAttributeValidator.new('String', ['Daily Distribution', 'Monthly Distribution (Back Load)', 'Monthly Distribution (Front Load)', 'Monthly Distribution (Proration by Days)'])
      return false unless distribution_type_validator.valid?(@distribution_type)
      event_type_validator = EnumAttributeValidator.new('String', ['Invoice Posted', 'Invoice Item Adjustment Created', 'Invoice Canceled', 'Invoice Item Adjustment Canceled', 'Revenue Distributed', 'Credit Memo Posted', 'Debit Memo Posted'])
      return false unless event_type_validator.valid?(@event_type)
      return false if @recognition_end.nil?
      return false if @recognition_start.nil?
      true
    end
    ...
    def distribution_type=(distribution_type)
      validator = EnumAttributeValidator.new('String', ['Daily Distribution', 'Monthly Distribution (Back Load)', 'Monthly Distribution (Front Load)', 'Monthly Distribution (Proration by Days)'])
      unless validator.valid?(distribution_type)
        fail ArgumentError, 'invalid value for "distribution_type", must be one of #{validator.allowable_values}.'
      end
    ...
    def event_type=(event_type)
      validator = EnumAttributeValidator.new('String', ['Invoice Posted', 'Invoice Item Adjustment Created', 'Invoice Canceled', 'Invoice Item Adjustment Canceled', 'Revenue Distributed', 'Credit Memo Posted', 'Debit Memo Posted'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          event_type_system_id == o.event_type_system_id &&
          notes == o.notes &&
          recognition_end == o.recognition_end &&
          recognition_start == o.recognition_start
    end
    ...
    def hash
      [custom_field__c, distribution_type, event_type, event_type_system_id, notes, recognition_end, recognition_start].hash
    end
