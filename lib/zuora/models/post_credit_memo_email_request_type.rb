...
module Zuora
  ...
  class PostCreditMemoEmailRequestType
    ...
    attr_accessor :include_additional_email_addresses
    ...
    attr_accessor :use_email_template_setting
    ...
    def self.swagger_types
      {
        ...
        :'include_additional_email_addresses' => :'BOOLEAN',
        :'use_email_template_setting' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emailAddresses')
        self.email_addresses = attributes[:'emailAddresses']
      end

      if attributes.has_key?(:'includeAdditionalEmailAddresses')
        self.include_additional_email_addresses = attributes[:'includeAdditionalEmailAddresses']
      else
        self.include_additional_email_addresses = false
      end

      if attributes.has_key?(:'useEmailTemplateSetting')
        self.use_email_template_setting = attributes[:'useEmailTemplateSetting']
      else
        self.use_email_template_setting = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_additional_email_addresses == o.include_additional_email_addresses &&
          use_email_template_setting == o.use_email_template_setting
    end
    ...
    def hash
      [email_addresses, include_additional_email_addresses, use_email_template_setting].hash
    end
