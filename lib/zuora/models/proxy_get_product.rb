...
module Zuora
  class ProxyGetProduct
    ...
    def hash
      [allow_feature_changes, category, created_by_id, created_date, description, effective_end_date, effective_start_date, id, name, sku, updated_by_id, updated_date].hash
    end
