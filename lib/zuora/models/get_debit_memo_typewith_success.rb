...
module Zuora
  ...
  class GETDebitMemoTypewithSuccess
    ...
    def hash
      [account_id, amount, balance, be_applied_amount, cancelled_by_id, cancelled_on, comment, created_by_id, created_date, custom_field__c, debit_memo_date, due_date, id, latest_pdf_file_id, number, posted_by_id, posted_on, reason_code, referred_invoice_id, status, target_date, tax_amount, total_tax_exempt_amount, transferred_to_accounting, updated_by_id, updated_date].hash
    end
