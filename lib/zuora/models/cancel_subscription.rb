...
module Zuora
  # The JSON object containing the information related to the 'CancelSubscription' type of request.
  class CancelSubscription
    ...
    def list_invalid_properties
      ...
      if @cancellation_policy.nil?
        invalid_properties.push('invalid value for "cancellation_policy", cancellation_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      cancellation_policy_validator = EnumAttributeValidator.new('String', ['EndOfCurrentTerm', 'EndOfLastInvoicePeriod', 'SpecificDate'])
      return false unless cancellation_policy_validator.valid?(@cancellation_policy)
      true
    end
    ...
    def cancellation_policy=(cancellation_policy)
      validator = EnumAttributeValidator.new('String', ['EndOfCurrentTerm', 'EndOfLastInvoicePeriod', 'SpecificDate'])
      unless validator.valid?(cancellation_policy)
        fail ArgumentError, 'invalid value for "cancellation_policy", must be one of #{validator.allowable_values}.'
      end
    ...
    def hash
      [cancellation_effective_date, cancellation_policy].hash
    end
