...
module Zuora
  class GETPaymentRunSummaryResponse
    ...
    attr_accessor :number_of_credit_balance_adjustments

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The total number of credit memos that are successfully processed in the payment run. 
    attr_accessor :number_of_credit_memos

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The total number of debit memos that are picked up for processing in the payment run. 
    attr_accessor :number_of_debit_memos

    # The number of payments with the status of `Error` and `Processing`. 
    attr_accessor :number_of_errors

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The total number of invoices that are picked up for processing in the payment run. 
    ...
    attr_accessor :number_of_receivables

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The number of unapplied payments that are successfully processed in the payment run. 
    attr_accessor :number_of_unapplied_payments

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The number of debit memos with remaining positive balances after the payment run is completed. 
    attr_accessor :number_of_unprocessed_debit_memos

    # **Note:** This field is only available if you have the Advanced AR Settlement feature enabled.  The number of invoices with remaining positive balances after the payment run is completed. 
    attr_accessor :number_of_unprocessed_invoices

    # The number of receivables with remaining positive balances after the payment run is completed. 
    attr_accessor :number_of_unprocessed_receivables

    # Returns `true` if the request was processed successfully. 
    attr_accessor :success

    # Container for total values. 
    attr_accessor :total_values
    ...
    def self.swagger_types
      {
        :'number_of_credit_balance_adjustments' => :'Integer',
        :'number_of_credit_memos' => :'Integer',
        :'number_of_debit_memos' => :'Integer',
        :'number_of_errors' => :'Integer',
        :'number_of_invoices' => :'Integer',
        :'number_of_payments' => :'Integer',
        :'number_of_receivables' => :'Integer',
        :'number_of_unapplied_payments' => :'Integer',
        :'number_of_unprocessed_debit_memos' => :'Integer',
        :'number_of_unprocessed_invoices' => :'Integer',
        :'number_of_unprocessed_receivables' => :'Integer',
        :'success' => :'BOOLEAN',
        :'total_values' => :'Array<GETPaymentRunSummaryTotalValues>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'numberOfCreditBalanceAdjustments')
        self.number_of_credit_balance_adjustments = attributes[:'numberOfCreditBalanceAdjustments']
      end

      if attributes.has_key?(:'numberOfCreditMemos')
        self.number_of_credit_memos = attributes[:'numberOfCreditMemos']
      end

      if attributes.has_key?(:'numberOfDebitMemos')
        self.number_of_debit_memos = attributes[:'numberOfDebitMemos']
      end

      if attributes.has_key?(:'numberOfErrors')
        self.number_of_errors = attributes[:'numberOfErrors']
      end

      if attributes.has_key?(:'numberOfInvoices')
        self.number_of_invoices = attributes[:'numberOfInvoices']
      end
      ...
      if attributes.has_key?(:'numberOfReceivables')
        self.number_of_receivables = attributes[:'numberOfReceivables']
      end

      if attributes.has_key?(:'numberOfUnappliedPayments')
        self.number_of_unapplied_payments = attributes[:'numberOfUnappliedPayments']
      end

      if attributes.has_key?(:'numberOfUnprocessedDebitMemos')
        self.number_of_unprocessed_debit_memos = attributes[:'numberOfUnprocessedDebitMemos']
      end

      if attributes.has_key?(:'numberOfUnprocessedInvoices')
        self.number_of_unprocessed_invoices = attributes[:'numberOfUnprocessedInvoices']
      end

      if attributes.has_key?(:'numberOfUnprocessedReceivables')
        self.number_of_unprocessed_receivables = attributes[:'numberOfUnprocessedReceivables']
      end
      ...
      if attributes.has_key?(:'totalValues')
        if (value = attributes[:'totalValues']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          number_of_credit_balance_adjustments == o.number_of_credit_balance_adjustments &&
          number_of_credit_memos == o.number_of_credit_memos &&
          number_of_debit_memos == o.number_of_debit_memos &&
          number_of_errors == o.number_of_errors &&
          number_of_invoices == o.number_of_invoices &&
          number_of_payments == o.number_of_payments &&
          number_of_receivables == o.number_of_receivables &&
          number_of_unapplied_payments == o.number_of_unapplied_payments &&
          number_of_unprocessed_debit_memos == o.number_of_unprocessed_debit_memos &&
          number_of_unprocessed_invoices == o.number_of_unprocessed_invoices &&
          number_of_unprocessed_receivables == o.number_of_unprocessed_receivables &&
          success == o.success &&
    ...
    def hash
      [number_of_credit_balance_adjustments, number_of_credit_memos, number_of_debit_memos, number_of_errors, number_of_invoices, number_of_payments, number_of_receivables, number_of_unapplied_payments, number_of_unprocessed_debit_memos, number_of_unprocessed_invoices, number_of_unprocessed_receivables, success, total_values].hash
    end
