...
module Zuora
  class GETAccountSummarySubscriptionType
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'initial_term' => :'String',
        :'rate_plans' => :'Array<GETAccountSummarySubscriptionRatePlanType>',
        :'renewal_term' => :'String',
        :'status' => :'String',
    ...
    def hash
      [cpq_bundle_json_id__qt, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, auto_renew, custom_field__c, id, initial_term, rate_plans, renewal_term, status, subscription_number, subscription_start_date, term_end_date, term_start_date, term_type].hash
    end
