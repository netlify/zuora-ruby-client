...
module Zuora
  ...
  class AmendRequestPreviewOptions
    ...
    attr_accessor :enable_preview_mode
    ...
    attr_accessor :preview_through_term_end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EnablePreviewMode')
        self.enable_preview_mode = attributes[:'EnablePreviewMode']
      end
      ...
      if attributes.has_key?(:'PreviewThroughTermEnd')
        self.preview_through_term_end = attributes[:'PreviewThroughTermEnd']
      end
    ...
    def hash
      [enable_preview_mode, include_existing_draft_invoice_items, number_of_periods, preview_through_term_end, preview_type].hash
    end
