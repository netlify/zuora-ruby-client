...
module Zuora
  ...
  class ProxyGetSubscriptionProductFeature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FeatureCode')
        self.feature_code = attributes[:'FeatureCode']
      end

      if attributes.has_key?(:'FeatureId')
        self.feature_id = attributes[:'FeatureId']
      end
    ...
    def hash
      [created_by_id, created_date, description, feature_code, feature_id, id, name, rate_plan_id, updated_by_id, updated_date].hash
    end
