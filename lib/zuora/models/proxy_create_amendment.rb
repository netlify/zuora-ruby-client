...
module Zuora
  class ProxyCreateAmendment
    ...
    def self.swagger_types
      {
        ...
        :'effective_date' => :'Date',
        :'name' => :'String',
        :'rate_plan_data' => :'ProxyCreateAmendmentRatePlanData',
    ...
    def hash
      [auto_renew, contract_effective_date, current_term, current_term_period_type, customer_acceptance_date, description, effective_date, name, rate_plan_data, renewal_setting, renewal_term, renewal_term_period_type, service_activation_date, specific_update_date, status, subscription_id, term_start_date, term_type, type].hash
    end
