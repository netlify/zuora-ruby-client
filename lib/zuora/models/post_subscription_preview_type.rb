...
module Zuora
  ...
  class POSTSubscriptionPreviewType
    ...
    attr_accessor :invoice_owner_account_key
    ...
    attr_accessor :preview_account_info
    ...
    def self.swagger_types
      {
        ...
        :'include_existing_draft_doc_items' => :'BOOLEAN',
        ...
        :'subscribe_to_rate_plans' => :'Array<POSTSrpCreateType>',
        :'target_date' => :'Date',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountKey')
        self.account_key = attributes[:'accountKey']
      end
      ...
      if attributes.has_key?(:'includeExistingDraftDocItems')
        self.include_existing_draft_doc_items = attributes[:'includeExistingDraftDocItems']
      end

      if attributes.has_key?(:'includeExistingDraftInvoiceItems')
        self.include_existing_draft_invoice_items = attributes[:'includeExistingDraftInvoiceItems']
      end
      ...
      if attributes.has_key?(:'invoiceOwnerAccountKey')
        self.invoice_owner_account_key = attributes[:'invoiceOwnerAccountKey']
      end
      ...
      if attributes.has_key?(:'previewAccountInfo')
        self.preview_account_info = attributes[:'previewAccountInfo']
      end

      if attributes.has_key?(:'previewType')
        self.preview_type = attributes[:'previewType']
      end
    ...
    def list_invalid_properties
      ...
      if @contract_effective_date.nil?
        invalid_properties.push("invalid value for 'contract_effective_date', contract_effective_date cannot be nil.")
      end

      if @subscribe_to_rate_plans.nil?
        invalid_properties.push("invalid value for 'subscribe_to_rate_plans', subscribe_to_rate_plans cannot be nil.")
      end

      if @term_type.nil?
        invalid_properties.push("invalid value for 'term_type', term_type cannot be nil.")
      end
    ...
    def valid?
      return false if @contract_effective_date.nil?
      return false if @subscribe_to_rate_plans.nil?
      return false if @term_type.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_existing_draft_doc_items == o.include_existing_draft_doc_items &&
          include_existing_draft_invoice_items == o.include_existing_draft_invoice_items &&
          initial_term == o.initial_term &&
          initial_term_period_type == o.initial_term_period_type &&
          invoice_owner_account_key == o.invoice_owner_account_key &&
          invoice_target_date == o.invoice_target_date &&
          notes == o.notes &&
          preview_account_info == o.preview_account_info &&
    ...
    def hash
      [opportunity_close_date_qt, opportunity_name_qt, quote_business_type_qt, quote_number_qt, quote_type_qt, account_key, contract_effective_date, customer_acceptance_date, include_existing_draft_doc_items, include_existing_draft_invoice_items, initial_term, initial_term_period_type, invoice_owner_account_key, invoice_target_date, notes, preview_account_info, preview_type, service_activation_date, subscribe_to_rate_plans, target_date, term_start_date, term_type].hash
    end
