...
module Zuora
  ...
  class OrderSubscriptions
    ...
    def self.swagger_types
      {
        ...
        :'new_version' => :'Integer',
        :'order_actions' => :'Array<OrderAction>',
        :'sequence' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'baseVersion')
        self.base_version = attributes[:'baseVersion']
      end

      if attributes.has_key?(:'newVersion')
        self.new_version = attributes[:'newVersion']
      end

      if attributes.has_key?(:'orderActions')
        if (value = attributes[:'orderActions']).is_a?(Array)
          self.order_actions = value
        end
      end
    ...
    def hash
      [base_version, new_version, order_actions, sequence, subscription_number].hash
    end
