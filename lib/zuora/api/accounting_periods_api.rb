...
module Zuora
  class AccountingPeriodsApi
    ...
    def delete_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = delete_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    def delete_accounting_period_with_http_info(ap_id, opts = {})
      ...
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.delete_accounting_period"
      end
      # resource path
    ...
    def get_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = get_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    def get_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.get_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.get_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}".sub('{' + 'ap-id' + '}', ap_id.to_s)
    ...
    def get_all_accounting_periods(opts = {})
      data, _status_code, _headers = get_all_accounting_periods_with_http_info(opts)
      return data
    end
    ...
    def get_all_accounting_periods_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.get_all_accounting_periods ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AccountingPeriodsApi.get_all_accounting_periods, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#get_all_accounting_periods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_accounting_period(request, opts = {})
      data, _status_code, _headers = post_accounting_period_with_http_info(request, opts)
      return data
    end
    ...
    def post_accounting_period_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.post_accounting_period ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingPeriodsApi.post_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#post_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_close_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = put_close_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_close_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.put_close_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.put_close_accounting_period"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#put_close_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_pending_close_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = put_pending_close_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_pending_close_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.put_pending_close_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.put_pending_close_accounting_period"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#put_pending_close_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_reopen_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = put_reopen_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_reopen_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.put_reopen_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.put_reopen_accounting_period"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#put_reopen_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_run_trial_balance(ap_id, opts = {})
      data, _status_code, _headers = put_run_trial_balance_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_run_trial_balance_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.put_run_trial_balance ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.put_run_trial_balance"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#put_run_trial_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_update_accounting_period(ap_id, request, opts = {})
      data, _status_code, _headers = put_update_accounting_period_with_http_info(ap_id, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_update_accounting_period_with_http_info(ap_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.put_update_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.put_update_accounting_period"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingPeriodsApi.put_update_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#put_update_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
