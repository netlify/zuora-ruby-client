...
module Zuora
  class AccountingCodesApi
    ...
    def delete_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = delete_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    def delete_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.delete_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.delete_accounting_code"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#delete_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = get_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    def get_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.get_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.get_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#get_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_accounting_codes(opts = {})
      data, _status_code, _headers = get_all_accounting_codes_with_http_info(opts)
      return data
    end
    ...
    def get_all_accounting_codes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.get_all_accounting_codes ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AccountingCodesApi.get_all_accounting_codes, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#get_all_accounting_codes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_accounting_code(request, opts = {})
      data, _status_code, _headers = post_accounting_code_with_http_info(request, opts)
      return data
    end
    ...
    def post_accounting_code_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.post_accounting_code ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingCodesApi.post_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#post_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_accounting_code(ac_id, request, opts = {})
      data, _status_code, _headers = put_accounting_code_with_http_info(ac_id, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_accounting_code_with_http_info(ac_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.put_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.put_accounting_code"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingCodesApi.put_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#put_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_activate_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = put_activate_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_activate_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.put_activate_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.put_activate_accounting_code"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#put_activate_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_deactivate_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = put_deactivate_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_deactivate_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.put_deactivate_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.put_deactivate_accounting_code"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#put_deactivate_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
