...
module Zuora
  class TaxationItemsApi
    ...
    def delete_taxation_item(id, opts = {})
      data, _status_code, _headers = delete_taxation_item_with_http_info(id, opts)
      return data
    end
    ...
    def delete_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TaxationItemsApi.delete_taxation_item ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.delete_taxation_item"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#delete_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_taxation_item(id, opts = {})
      data, _status_code, _headers = get_taxation_item_with_http_info(id, opts)
      return data
    end
    ...
    def get_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TaxationItemsApi.get_taxation_item ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.get_taxation_item"
      end
      # resource path
      local_var_path = "/v1/taxationitems/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#get_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETTaxationItemType]
    def put_taxation_item(body, id, opts = {})
      data, _status_code, _headers = put_taxation_item_with_http_info(body, id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETTaxationItemType, Fixnum, Hash)>] GETTaxationItemType data, response status code and response headers
    def put_taxation_item_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TaxationItemsApi.put_taxation_item ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TaxationItemsApi.put_taxation_item"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.put_taxation_item"
      end
      # resource path
      local_var_path = "/v1/taxationitems/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETTaxationItemType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#put_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
