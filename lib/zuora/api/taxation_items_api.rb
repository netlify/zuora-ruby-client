...
module Zuora
  class TaxationItemsApi
    ...
    def d_elete_taxation_item(id, opts = {})
      data, _status_code, _headers = d_elete_taxation_item_with_http_info(id, opts)
      data
    end
    ...
    def d_elete_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.d_elete_taxation_item ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.d_elete_taxation_item"
      end
      # resource path
      local_var_path = '/v1/taxationitems/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#d_elete_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_taxation_item(id, opts = {})
      data, _status_code, _headers = g_et_taxation_item_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETTaxationItemType, Fixnum, Hash)>] GETTaxationItemType data, response status code and response headers
    def g_et_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.g_et_taxation_item ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.g_et_taxation_item"
      end
      # resource path
      local_var_path = '/v1/taxationitems/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETTaxationItemType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#g_et_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_delete_taxation_item(id, opts = {})
      data, _status_code, _headers = object_delete_taxation_item_with_http_info(id, opts)
      data
    end
    ...
    def object_delete_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.object_delete_taxation_item ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.object_delete_taxation_item"
      end
      # resource path
      local_var_path = '/v1/object/taxation-item/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#object_delete_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_get_taxation_item(id, opts = {})
      data, _status_code, _headers = object_get_taxation_item_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetTaxationItem, Fixnum, Hash)>] ProxyGetTaxationItem data, response status code and response headers
    def object_get_taxation_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.object_get_taxation_item ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.object_get_taxation_item"
      end
      # resource path
      local_var_path = '/v1/object/taxation-item/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetTaxationItem')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#object_get_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_taxation_item(create_request, opts = {})
      data, _status_code, _headers = object_post_taxation_item_with_http_info(create_request, opts)
      data
    end
    ...
    def object_post_taxation_item_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.object_post_taxation_item ...'
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling TaxationItemsApi.object_post_taxation_item"
      end
      # resource path
      local_var_path = '/v1/object/taxation-item'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#object_post_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [ProxyCreateOrModifyResponse]
    def object_put_taxation_item(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_taxation_item_with_http_info(id, modify_request, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_taxation_item_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.object_put_taxation_item ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.object_put_taxation_item"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling TaxationItemsApi.object_put_taxation_item"
      end
      # resource path
      local_var_path = '/v1/object/taxation-item/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#object_put_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETTaxationItemType]
    def p_ut_taxation_item(body, id, opts = {})
      data, _status_code, _headers = p_ut_taxation_item_with_http_info(body, id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETTaxationItemType, Fixnum, Hash)>] GETTaxationItemType data, response status code and response headers
    def p_ut_taxation_item_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxationItemsApi.p_ut_taxation_item ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TaxationItemsApi.p_ut_taxation_item"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TaxationItemsApi.p_ut_taxation_item"
      end
      # resource path
      local_var_path = '/v1/taxationitems/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETTaxationItemType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxationItemsApi#p_ut_taxation_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
