...
module Zuora
  class OrdersApi
    ...
    def delete_order(order_number, opts = {})
      data, _status_code, _headers = delete_order_with_http_info(order_number, opts)
      return data
    end
    ...
    def delete_order_with_http_info(order_number, opts = {})
      ...
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.delete_order"
      end
      # resource path
    ...
    def get_all_orders(opts = {})
      data, _status_code, _headers = get_all_orders_with_http_info(opts)
      return data
    end
    ...
    def get_all_orders_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_all_orders ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OrdersApi.get_all_orders, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_all_orders\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_order_with_http_info(order_number, opts = {})
      ...
      # verify the required parameter 'order_number' is set
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.get_order"
      end
      # resource path
      local_var_path = "/v1/orders/{orderNumber}".sub('{' + 'orderNumber' + '}', order_number.to_s)
    ...
    def get_order_billing_info(order_number, opts = {})
      data, _status_code, _headers = get_order_billing_info_with_http_info(order_number, opts)
      return data
    end
    ...
    def get_order_billing_info_with_http_info(order_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_order_billing_info ..."
      end
      # verify the required parameter 'order_number' is set
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.get_order_billing_info"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_order_billing_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GetOrderResponse]
    def get_order_metricsfor_evergreen_subscription(order_number, subscription_number, start_date, end_date, opts = {})
      data, _status_code, _headers = get_order_metricsfor_evergreen_subscription_with_http_info(order_number, subscription_number, start_date, end_date, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GetOrderResponse, Fixnum, Hash)>] GetOrderResponse data, response status code and response headers
    def get_order_metricsfor_evergreen_subscription_with_http_info(order_number, subscription_number, start_date, end_date, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_order_metricsfor_evergreen_subscription ..."
      end
      # verify the required parameter 'order_number' is set
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.get_order_metricsfor_evergreen_subscription"
      end
      ...
      if @api_client.config.client_side_validation && subscription_number.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_number' when calling OrdersApi.get_order_metricsfor_evergreen_subscription"
      end
      # verify the required parameter 'start_date' is set
      if @api_client.config.client_side_validation && start_date.nil?
        fail ArgumentError, "Missing the required parameter 'start_date' when calling OrdersApi.get_order_metricsfor_evergreen_subscription"
      end
      # verify the required parameter 'end_date' is set
      if @api_client.config.client_side_validation && end_date.nil?
        fail ArgumentError, "Missing the required parameter 'end_date' when calling OrdersApi.get_order_metricsfor_evergreen_subscription"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetOrderResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_order_metricsfor_evergreen_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_order_rated_result(order_number, opts = {})
      data, _status_code, _headers = get_order_rated_result_with_http_info(order_number, opts)
      return data
    end
    ...
    def get_order_rated_result_with_http_info(order_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_order_rated_result ..."
      end
      # verify the required parameter 'order_number' is set
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.get_order_rated_result"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_order_rated_result\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_orders_by_invoice_owner(account_number, opts = {})
      data, _status_code, _headers = get_orders_by_invoice_owner_with_http_info(account_number, opts)
      return data
    end
    ...
    def get_orders_by_invoice_owner_with_http_info(account_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_orders_by_invoice_owner ..."
      end
      # verify the required parameter 'account_number' is set
      if @api_client.config.client_side_validation && account_number.nil?
        fail ArgumentError, "Missing the required parameter 'account_number' when calling OrdersApi.get_orders_by_invoice_owner"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OrdersApi.get_orders_by_invoice_owner, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_orders_by_invoice_owner\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Date] :end_date The result will only contain the orders with the date of &#39;dateFilterOption&#39; earlier than or equal to this date. 
    # @return [GetOrdersResponse]
    def get_orders_by_subscription_number(subscription_number, opts = {})
      data, _status_code, _headers = get_orders_by_subscription_number_with_http_info(subscription_number, opts)
      return data
    end
    ...
    # @option opts [Date] :end_date The result will only contain the orders with the date of &#39;dateFilterOption&#39; earlier than or equal to this date. 
    # @return [Array<(GetOrdersResponse, Fixnum, Hash)>] GetOrdersResponse data, response status code and response headers
    def get_orders_by_subscription_number_with_http_info(subscription_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_orders_by_subscription_number ..."
      end
      # verify the required parameter 'subscription_number' is set
      if @api_client.config.client_side_validation && subscription_number.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_number' when calling OrdersApi.get_orders_by_subscription_number"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OrdersApi.get_orders_by_subscription_number, must be smaller than or equal to 40.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetOrdersResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_orders_by_subscription_number\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Date] :end_date The result will only contain the orders with the date of &#39;dateFilterOption&#39; earlier than or equal to this date. 
    # @return [GetOrdersResponse]
    def get_orders_by_subscription_owner(account_number, opts = {})
      data, _status_code, _headers = get_orders_by_subscription_owner_with_http_info(account_number, opts)
      return data
    end
    ...
    # @option opts [Date] :end_date The result will only contain the orders with the date of &#39;dateFilterOption&#39; earlier than or equal to this date. 
    # @return [Array<(GetOrdersResponse, Fixnum, Hash)>] GetOrdersResponse data, response status code and response headers
    def get_orders_by_subscription_owner_with_http_info(account_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.get_orders_by_subscription_owner ..."
      end
      # verify the required parameter 'account_number' is set
      if @api_client.config.client_side_validation && account_number.nil?
        fail ArgumentError, "Missing the required parameter 'account_number' when calling OrdersApi.get_orders_by_subscription_owner"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OrdersApi.get_orders_by_subscription_owner, must be smaller than or equal to 40.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetOrdersResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#get_orders_by_subscription_owner\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_order(body, opts = {})
      data, _status_code, _headers = post_order_with_http_info(body, opts)
      return data
    end
    ...
    def post_order_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.post_order ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling OrdersApi.post_order"
      end
      # resource path
      local_var_path = "/v1/orders"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#post_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_preview_order(body, opts = {})
      data, _status_code, _headers = post_preview_order_with_http_info(body, opts)
      return data
    end
    ...
    def post_preview_order_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.post_preview_order ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling OrdersApi.post_preview_order"
      end
      # resource path
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponse]
    def put_update_order_custom_fields(order_number, body, opts = {})
      data, _status_code, _headers = put_update_order_custom_fields_with_http_info(order_number, body, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponse, Fixnum, Hash)>] CommonResponse data, response status code and response headers
    def put_update_order_custom_fields_with_http_info(order_number, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrdersApi.put_update_order_custom_fields ..."
      end
      # verify the required parameter 'order_number' is set
      if @api_client.config.client_side_validation && order_number.nil?
        fail ArgumentError, "Missing the required parameter 'order_number' when calling OrdersApi.put_update_order_custom_fields"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling OrdersApi.put_update_order_custom_fields"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#put_update_order_custom_fields\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
