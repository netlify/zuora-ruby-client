...
module Zuora
  class OrdersApi
    ...
    def g_et_breakdown_invoice_by_order_with_http_info(invoice_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.g_et_breakdown_invoice_by_order ...'
      end
      # verify the required parameter 'invoice_number' is set
      if @api_client.config.client_side_validation && invoice_number.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_number' when calling OrdersApi.g_et_breakdown_invoice_by_order"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#g_et_breakdown_invoice_by_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get an order
    ...
    # @param subscription_number The number of the subscription to retrieve terms for. For example, A-S00000001. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [Integer] :version The version of the subscription to retrieve terms for. If you do not specify this parameter, Zuora returns the terms for the latest version of the subscription. 
    # @option opts [Integer] :page The page number of the terms retrieved.  (default to 1)
    # @option opts [Integer] :page_size Number of rows returned per page.  (default to 20)
    # @return [GetSubscriptionTermInfoResponseType]
    def g_et_subscription_term_info(subscription_number, opts = {})
      data, _status_code, _headers = g_et_subscription_term_info_with_http_info(subscription_number, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [Integer] :version The version of the subscription to retrieve terms for. If you do not specify this parameter, Zuora returns the terms for the latest version of the subscription. 
    # @option opts [Integer] :page The page number of the terms retrieved. 
    # @option opts [Integer] :page_size Number of rows returned per page. 
    # @return [Array<(GetSubscriptionTermInfoResponseType, Fixnum, Hash)>] GetSubscriptionTermInfoResponseType data, response status code and response headers
    def g_et_subscription_term_info_with_http_info(subscription_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.g_et_subscription_term_info ...'
      end
      # verify the required parameter 'subscription_number' is set
      if @api_client.config.client_side_validation && subscription_number.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_number' when calling OrdersApi.g_et_subscription_term_info"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OrdersApi.g_et_subscription_term_info, must be smaller than or equal to 40.'
      end

      # resource path
      local_var_path = '/v1/orders/term/{subscriptionNumber}'.sub('{' + 'subscriptionNumber' + '}', subscription_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetSubscriptionTermInfoResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#g_et_subscription_term_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_update_subscription_custom_fields_with_http_info(subscription_number, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.p_ut_update_subscription_custom_fields ...'
      end
      # verify the required parameter 'subscription_number' is set
      if @api_client.config.client_side_validation && subscription_number.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_number' when calling OrdersApi.p_ut_update_subscription_custom_fields"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling OrdersApi.p_ut_update_subscription_custom_fields"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#p_ut_update_subscription_custom_fields\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
