...
module Zuora
  class ProductRatePlansApi
    ...
    def object_delete_product_rate_plan(id, opts = {})
      data, _status_code, _headers = object_delete_product_rate_plan_with_http_info(id, opts)
      data
    end
    ...
    def object_delete_product_rate_plan_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductRatePlansApi.object_delete_product_rate_plan ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductRatePlansApi.object_delete_product_rate_plan"
      end
      # resource path
      local_var_path = '/v1/object/product-rate-plan/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlansApi#object_delete_product_rate_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def object_get_product_rate_plan(id, opts = {})
      data, _status_code, _headers = object_get_product_rate_plan_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetProductRatePlan, Fixnum, Hash)>] ProxyGetProductRatePlan data, response status code and response headers
    def object_get_product_rate_plan_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductRatePlansApi.object_get_product_rate_plan ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductRatePlansApi.object_get_product_rate_plan"
      end
      # resource path
      local_var_path = '/v1/object/product-rate-plan/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetProductRatePlan')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlansApi#object_get_product_rate_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_product_rate_plan(create_request, opts = {})
      data, _status_code, _headers = object_post_product_rate_plan_with_http_info(create_request, opts)
      data
    end
    ...
    def object_post_product_rate_plan_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductRatePlansApi.object_post_product_rate_plan ...'
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling ProductRatePlansApi.object_post_product_rate_plan"
      end
      # resource path
      local_var_path = '/v1/object/product-rate-plan'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlansApi#object_post_product_rate_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [ProxyCreateOrModifyResponse]
    def object_put_product_rate_plan(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_product_rate_plan_with_http_info(id, modify_request, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_product_rate_plan_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductRatePlansApi.object_put_product_rate_plan ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductRatePlansApi.object_put_product_rate_plan"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling ProductRatePlansApi.object_put_product_rate_plan"
      end
      # resource path
      local_var_path = '/v1/object/product-rate-plan/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlansApi#object_put_product_rate_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
