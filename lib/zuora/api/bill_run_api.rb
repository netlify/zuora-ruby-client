...
module Zuora
  class BillRunApi
    ...
    def post_email_billing_documentsfrom_bill_run(bill_run_id, request, opts = {})
      data, _status_code, _headers = post_email_billing_documentsfrom_bill_run_with_http_info(bill_run_id, request, opts)
      return data
    end
    ...
    def post_email_billing_documentsfrom_bill_run_with_http_info(bill_run_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BillRunApi.post_email_billing_documentsfrom_bill_run ..."
      end
      # verify the required parameter 'bill_run_id' is set
      if @api_client.config.client_side_validation && bill_run_id.nil?
        fail ArgumentError, "Missing the required parameter 'bill_run_id' when calling BillRunApi.post_email_billing_documentsfrom_bill_run"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling BillRunApi.post_email_billing_documentsfrom_bill_run"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BillRunApi#post_email_billing_documentsfrom_bill_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
