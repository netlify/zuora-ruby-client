...
module Zuora
  class SummaryJournalEntriesApi
    ...
    def delete_summary_journal_entry(je_number, opts = {})
      data, _status_code, _headers = delete_summary_journal_entry_with_http_info(je_number, opts)
      return data
    end
    ...
    def delete_summary_journal_entry_with_http_info(je_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.delete_summary_journal_entry ..."
      end
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.delete_summary_journal_entry"
      end
      # resource path
      local_var_path = "/v1/journal-entries/{je-number}".sub('{' + 'je-number' + '}', je_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#delete_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_all_summary_journal_entries(jr_number, opts = {})
      data, _status_code, _headers = get_all_summary_journal_entries_with_http_info(jr_number, opts)
      return data
    end
    ...
    def get_all_summary_journal_entries_with_http_info(jr_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.get_all_summary_journal_entries ..."
      end
      # verify the required parameter 'jr_number' is set
      if @api_client.config.client_side_validation && jr_number.nil?
        fail ArgumentError, "Missing the required parameter 'jr_number' when calling SummaryJournalEntriesApi.get_all_summary_journal_entries"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SummaryJournalEntriesApi.get_all_summary_journal_entries, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = "/v1/journal-entries/journal-runs/{jr-number}".sub('{' + 'jr-number' + '}', jr_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#get_all_summary_journal_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_summary_journal_entry(je_number, opts = {})
      data, _status_code, _headers = get_summary_journal_entry_with_http_info(je_number, opts)
      return data
    end
    ...
    def get_summary_journal_entry_with_http_info(je_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.get_summary_journal_entry ..."
      end
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.get_summary_journal_entry"
      end
      # resource path
      local_var_path = "/v1/journal-entries/{je-number}".sub('{' + 'je-number' + '}', je_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#get_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_summary_journal_entry(request, opts = {})
      data, _status_code, _headers = post_summary_journal_entry_with_http_info(request, opts)
      return data
    end
    ...
    def post_summary_journal_entry_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.post_summary_journal_entry ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SummaryJournalEntriesApi.post_summary_journal_entry"
      end
      # resource path
      local_var_path = "/v1/journal-entries"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#post_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_basic_summary_journal_entry(je_number, request, opts = {})
      data, _status_code, _headers = put_basic_summary_journal_entry_with_http_info(je_number, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_basic_summary_journal_entry_with_http_info(je_number, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.put_basic_summary_journal_entry ..."
      end
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.put_basic_summary_journal_entry"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SummaryJournalEntriesApi.put_basic_summary_journal_entry"
      end
      # resource path
      local_var_path = "/v1/journal-entries/{je-number}/basic-information".sub('{' + 'je-number' + '}', je_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#put_basic_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def put_summary_journal_entry(je_number, opts = {})
      data, _status_code, _headers = put_summary_journal_entry_with_http_info(je_number, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_summary_journal_entry_with_http_info(je_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SummaryJournalEntriesApi.put_summary_journal_entry ..."
      end
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.put_summary_journal_entry"
      end
      # resource path
      local_var_path = "/v1/journal-entries/{je-number}/cancel".sub('{' + 'je-number' + '}', je_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#put_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
