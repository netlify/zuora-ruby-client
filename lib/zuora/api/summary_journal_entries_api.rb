  ...
  class SummaryJournalEntriesApi
    ...
    def d_elete_summary_journal_entry_with_http_info(je_number, opts = {})
      ...
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.d_elete_summary_journal_entry"
      end
      # resource path
    ...
    def g_et_all_summary_journal_entries(jr_number, opts = {})
      data, _status_code, _headers = g_et_all_summary_journal_entries_with_http_info(jr_number, opts)
      data
    end
    ...
    def g_et_all_summary_journal_entries_with_http_info(jr_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SummaryJournalEntriesApi.g_et_all_summary_journal_entries ...'
      end
      # verify the required parameter 'jr_number' is set
      if @api_client.config.client_side_validation && jr_number.nil?
        fail ArgumentError, "Missing the required parameter 'jr_number' when calling SummaryJournalEntriesApi.g_et_all_summary_journal_entries"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SummaryJournalEntriesApi.g_et_all_summary_journal_entries, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#g_et_all_summary_journal_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_summary_journal_entry(je_number, opts = {})
      data, _status_code, _headers = g_et_summary_journal_entry_with_http_info(je_number, opts)
      data
    end
    ...
    def g_et_summary_journal_entry_with_http_info(je_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SummaryJournalEntriesApi.g_et_summary_journal_entry ...'
      end
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.g_et_summary_journal_entry"
      end
      # resource path
      local_var_path = '/v1/journal-entries/{je-number}'.sub('{' + 'je-number' + '}', je_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#g_et_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_summary_journal_entry(request, opts = {})
      data, _status_code, _headers = p_ost_summary_journal_entry_with_http_info(request, opts)
      data
    end
    ...
    def p_ost_summary_journal_entry_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SummaryJournalEntriesApi.p_ost_summary_journal_entry ...'
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SummaryJournalEntriesApi.p_ost_summary_journal_entry"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SummaryJournalEntriesApi#p_ost_summary_journal_entry\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_basic_summary_journal_entry_with_http_info(je_number, request, opts = {})
      ...
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.p_ut_basic_summary_journal_entry"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SummaryJournalEntriesApi.p_ut_basic_summary_journal_entry"
      end
      # resource path
    ...
    def p_ut_summary_journal_entry_with_http_info(je_number, opts = {})
      ...
      # verify the required parameter 'je_number' is set
      if @api_client.config.client_side_validation && je_number.nil?
        fail ArgumentError, "Missing the required parameter 'je_number' when calling SummaryJournalEntriesApi.p_ut_summary_journal_entry"
      end
      # resource path
