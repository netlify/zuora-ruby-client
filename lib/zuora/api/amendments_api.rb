...
module Zuora
  class AmendmentsApi
    ...
    def get_amendments_by_key(amendment_key, opts = {})
      data, _status_code, _headers = get_amendments_by_key_with_http_info(amendment_key, opts)
      return data
    end
    ...
    def get_amendments_by_key_with_http_info(amendment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.get_amendments_by_key ..."
      end
      # verify the required parameter 'amendment_key' is set
      if @api_client.config.client_side_validation && amendment_key.nil?
        fail ArgumentError, "Missing the required parameter 'amendment_key' when calling AmendmentsApi.get_amendments_by_key"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#get_amendments_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETAmendmentType]
    def get_amendments_by_subscription_id(subscription_id, opts = {})
      data, _status_code, _headers = get_amendments_by_subscription_id_with_http_info(subscription_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAmendmentType, Fixnum, Hash)>] GETAmendmentType data, response status code and response headers
    def get_amendments_by_subscription_id_with_http_info(subscription_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.get_amendments_by_subscription_id ..."
      end
      # verify the required parameter 'subscription_id' is set
      if @api_client.config.client_side_validation && subscription_id.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_id' when calling AmendmentsApi.get_amendments_by_subscription_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETAmendmentType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#get_amendments_by_subscription_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
