...
module Zuora
  class RefundsApi
    ...
    def d_elete_refund(refund_id, opts = {})
      data, _status_code, _headers = d_elete_refund_with_http_info(refund_id, opts)
      data
    end
    ...
    def d_elete_refund_with_http_info(refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.d_elete_refund ...'
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.d_elete_refund"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#d_elete_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_refund(refund_id, opts = {})
      data, _status_code, _headers = g_et_refund_with_http_info(refund_id, opts)
      data
    end
    ...
    def g_et_refund_with_http_info(refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refund ...'
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.g_et_refund"
      end
      # resource path
      local_var_path = '/v1/refunds/{refundId}'.sub('{' + 'refundId' + '}', refund_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_refund_item_part(itempartid, refundpartid, refund_id, opts = {})
      data, _status_code, _headers = g_et_refund_item_part_with_http_info(itempartid, refundpartid, refund_id, opts)
      data
    end
    ...
    def g_et_refund_item_part_with_http_info(itempartid, refundpartid, refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refund_item_part ...'
      end
      # verify the required parameter 'itempartid' is set
      if @api_client.config.client_side_validation && itempartid.nil?
        fail ArgumentError, "Missing the required parameter 'itempartid' when calling RefundsApi.g_et_refund_item_part"
      end
      # verify the required parameter 'refundpartid' is set
      if @api_client.config.client_side_validation && refundpartid.nil?
        fail ArgumentError, "Missing the required parameter 'refundpartid' when calling RefundsApi.g_et_refund_item_part"
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.g_et_refund_item_part"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refund_item_part\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_refund_item_parts(refundpartid, refund_id, opts = {})
      data, _status_code, _headers = g_et_refund_item_parts_with_http_info(refundpartid, refund_id, opts)
      data
    end
    ...
    def g_et_refund_item_parts_with_http_info(refundpartid, refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refund_item_parts ...'
      end
      # verify the required parameter 'refundpartid' is set
      if @api_client.config.client_side_validation && refundpartid.nil?
        fail ArgumentError, "Missing the required parameter 'refundpartid' when calling RefundsApi.g_et_refund_item_parts"
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.g_et_refund_item_parts"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RefundsApi.g_et_refund_item_parts, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refund_item_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get refund part
    ...
    def g_et_refund_part(refundpartid, refund_id, opts = {})
      data, _status_code, _headers = g_et_refund_part_with_http_info(refundpartid, refund_id, opts)
      data
    end
    ...
    def g_et_refund_part_with_http_info(refundpartid, refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refund_part ...'
      end
      # verify the required parameter 'refundpartid' is set
      if @api_client.config.client_side_validation && refundpartid.nil?
        fail ArgumentError, "Missing the required parameter 'refundpartid' when calling RefundsApi.g_et_refund_part"
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.g_et_refund_part"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refund_part\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get refund parts
    ...
    def g_et_refund_parts(refund_id, opts = {})
      data, _status_code, _headers = g_et_refund_parts_with_http_info(refund_id, opts)
      data
    end
    ...
    def g_et_refund_parts_with_http_info(refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refund_parts ...'
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.g_et_refund_parts"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refund_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get all refunds
    ...
    def g_et_refunds(opts = {})
      data, _status_code, _headers = g_et_refunds_with_http_info(opts)
      data
    end
    ...
    def g_et_refunds_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.g_et_refunds ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RefundsApi.g_et_refunds, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#g_et_refunds\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # CRUD: Delete refund
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETRefundType]
    def p_ut_cancel_refund(refund_id, opts = {})
      data, _status_code, _headers = p_ut_cancel_refund_with_http_info(refund_id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETRefundType, Fixnum, Hash)>] GETRefundType data, response status code and response headers
    def p_ut_cancel_refund_with_http_info(refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.p_ut_cancel_refund ...'
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.p_ut_cancel_refund"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETRefundType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#p_ut_cancel_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update refund
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETRefundType]
    def p_ut_update_refund(body, refund_id, opts = {})
      data, _status_code, _headers = p_ut_update_refund_with_http_info(body, refund_id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETRefundType, Fixnum, Hash)>] GETRefundType data, response status code and response headers
    def p_ut_update_refund_with_http_info(body, refund_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RefundsApi.p_ut_update_refund ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RefundsApi.p_ut_update_refund"
      end
      # verify the required parameter 'refund_id' is set
      if @api_client.config.client_side_validation && refund_id.nil?
        fail ArgumentError, "Missing the required parameter 'refund_id' when calling RefundsApi.p_ut_update_refund"
      end
      # resource path
      local_var_path = '/v1/refunds/{refundId}'.sub('{' + 'refundId' + '}', refund_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETRefundType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#p_ut_update_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
