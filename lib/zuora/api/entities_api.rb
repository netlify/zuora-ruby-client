...
module Zuora
  class EntitiesApi
    ...
    def delete_entities(id, opts = {})
      data, _status_code, _headers = delete_entities_with_http_info(id, opts)
      return data
    end
    ...
    def delete_entities_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntitiesApi.delete_entities ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.delete_entities"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#delete_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def post_entities(request, opts = {})
      data, _status_code, _headers = post_entities_with_http_info(request, opts)
      return data
    end
    ...
    def post_entities_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntitiesApi.post_entities ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling EntitiesApi.post_entities"
      end
      # resource path
      local_var_path = "/v1/entities"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#post_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_entities(id, request, opts = {})
      data, _status_code, _headers = put_entities_with_http_info(id, request, opts)
      return data
    end
    ...
    def put_entities_with_http_info(id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntitiesApi.put_entities ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.put_entities"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling EntitiesApi.put_entities"
      end
      # resource path
      local_var_path = "/v1/entities/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#put_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_provision_entity(id, opts = {})
      data, _status_code, _headers = put_provision_entity_with_http_info(id, opts)
      return data
    end
    ...
    def put_provision_entity_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntitiesApi.put_provision_entity ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.put_provision_entity"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#put_provision_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
