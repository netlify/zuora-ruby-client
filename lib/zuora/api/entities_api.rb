...
module Zuora
  class EntitiesApi
    ...
    def d_elete_entities(id, opts = {})
      data, _status_code, _headers = d_elete_entities_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(DELETEntityResponseType, Fixnum, Hash)>] DELETEntityResponseType data, response status code and response headers
    def d_elete_entities_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.d_elete_entities ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.d_elete_entities"
      end
      # resource path
      local_var_path = '/v1/entities/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'DELETEntityResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#d_elete_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [String] :provisioned Specify whether to retrieve provisioned or unprovisioned entities:  - &#x60;true&#x60;: Provisioned entities  - &#x60;false&#x60;: Unprovisioned entities   If you do not specify this field in the request, both the provisioned and unprovisioned entities are returned. 
    # @return [GETEntitiesResponseType]
    def g_et_entities(opts = {})
      data, _status_code, _headers = g_et_entities_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [String] :provisioned Specify whether to retrieve provisioned or unprovisioned entities:  - &#x60;true&#x60;: Provisioned entities  - &#x60;false&#x60;: Unprovisioned entities   If you do not specify this field in the request, both the provisioned and unprovisioned entities are returned. 
    # @return [Array<(GETEntitiesResponseType, Fixnum, Hash)>] GETEntitiesResponseType data, response status code and response headers
    def g_et_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.g_et_entities ...'
      end
      # resource path
      ...
      # query parameters
      query_params = {}
      query_params[:'provisioned'] = opts[:'provisioned'] if !opts[:'provisioned'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETEntitiesResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#g_et_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_entity_by_id(id, opts = {})
      data, _status_code, _headers = g_et_entity_by_id_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETEntitiesResponseTypeWithId, Fixnum, Hash)>] GETEntitiesResponseTypeWithId data, response status code and response headers
    def g_et_entity_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.g_et_entity_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.g_et_entity_by_id"
      end
      # resource path
      local_var_path = '/v1/entities/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETEntitiesResponseTypeWithId')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#g_et_entity_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_entities(request, opts = {})
      data, _status_code, _headers = p_ost_entities_with_http_info(request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(CreateEntityResponseType, Fixnum, Hash)>] CreateEntityResponseType data, response status code and response headers
    def p_ost_entities_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.p_ost_entities ...'
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling EntitiesApi.p_ost_entities"
      end
      # resource path
      local_var_path = '/v1/entities'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateEntityResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#p_ost_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_entities(id, request, opts = {})
      data, _status_code, _headers = p_ut_entities_with_http_info(id, request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(UpdateEntityResponseType, Fixnum, Hash)>] UpdateEntityResponseType data, response status code and response headers
    def p_ut_entities_with_http_info(id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.p_ut_entities ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.p_ut_entities"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling EntitiesApi.p_ut_entities"
      end
      # resource path
      local_var_path = '/v1/entities/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'UpdateEntityResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#p_ut_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_provision_entity(id, opts = {})
      data, _status_code, _headers = p_ut_provision_entity_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(ProvisionEntityResponseType, Fixnum, Hash)>] ProvisionEntityResponseType data, response status code and response headers
    def p_ut_provision_entity_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EntitiesApi.p_ut_provision_entity ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EntitiesApi.p_ut_provision_entity"
      end
      # resource path
      local_var_path = '/v1/entities/{id}/provision'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProvisionEntityResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntitiesApi#p_ut_provision_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
