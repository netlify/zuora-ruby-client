...
module Zuora
  class InvoicesApi
    ...
    # @param invoice_id The unique ID of an invoice. For example, 2c92c8955bd63cc1015bd7c151af02ab. 
    ...
    def g_et_invoice_application_parts(invoice_id, opts = {})
      data, _status_code, _headers = g_et_invoice_application_parts_with_http_info(invoice_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GetInvoiceApplicationPartCollectionType, Fixnum, Hash)>] GetInvoiceApplicationPartCollectionType data, response status code and response headers
    def g_et_invoice_application_parts_with_http_info(invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.g_et_invoice_application_parts ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.g_et_invoice_application_parts"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}/application-parts'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetInvoiceApplicationPartCollectionType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#g_et_invoice_application_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def object_delete_invoice(id, opts = {})
      data, _status_code, _headers = object_delete_invoice_with_http_info(id, opts)
      data
    end
    ...
    def object_delete_invoice_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.object_delete_invoice ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.object_delete_invoice"
      end
      # resource path
      local_var_path = '/v1/object/invoice/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#object_delete_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_get_invoice(id, opts = {})
      data, _status_code, _headers = object_get_invoice_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetInvoice, Fixnum, Hash)>] ProxyGetInvoice data, response status code and response headers
    def object_get_invoice_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.object_get_invoice ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.object_get_invoice"
      end
      # resource path
      local_var_path = '/v1/object/invoice/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetInvoice')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#object_get_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # CRUD: Update Invoice
    ...
    def object_put_invoice(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_invoice_with_http_info(id, modify_request, opts)
      data
    end
    ...
    def object_put_invoice_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.object_put_invoice ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.object_put_invoice"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling InvoicesApi.object_put_invoice"
      end
      # resource path
      local_var_path = '/v1/object/invoice/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#object_put_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param body 
    # @param invoice_id The ID of an invoice that you want to create a credit memo from. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETCreditMemoType]
    def p_ost_credit_memo_from_invoice(body, invoice_id, opts = {})
      data, _status_code, _headers = p_ost_credit_memo_from_invoice_with_http_info(body, invoice_id, opts)
      data
    end
    ...
    def p_ost_credit_memo_from_invoice_with_http_info(body, invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ost_credit_memo_from_invoice ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling InvoicesApi.p_ost_credit_memo_from_invoice"
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.p_ost_credit_memo_from_invoice"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}/creditmemos'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ost_credit_memo_from_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param invoice_id The ID of an invoice that you want to create a debit memo from. 
    # @param body 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETDebitMemoType]
    def p_ost_debit_memo_from_invoice(invoice_id, body, opts = {})
      data, _status_code, _headers = p_ost_debit_memo_from_invoice_with_http_info(invoice_id, body, opts)
      data
    end
    ...
    def p_ost_debit_memo_from_invoice_with_http_info(invoice_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ost_debit_memo_from_invoice ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.p_ost_debit_memo_from_invoice"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling InvoicesApi.p_ost_debit_memo_from_invoice"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}/debitmemos'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ost_debit_memo_from_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Email invoice
    ...
    # @param request 
    # @param invoice_id The ID of the invoice. For example, 2c92c8955bd63cc1015bd7c151af02ab. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [CommonResponseType]
    def p_ost_email_invoice(request, invoice_id, opts = {})
      data, _status_code, _headers = p_ost_email_invoice_with_http_info(request, invoice_id, opts)
      data
    end
    ...
    def p_ost_email_invoice_with_http_info(request, invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ost_email_invoice ...'
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.p_ost_email_invoice"
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.p_ost_email_invoice"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}/emails'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ost_email_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update invoices
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [CommonResponseType]
    def p_ut_batch_update_invoices(request, opts = {})
      data, _status_code, _headers = p_ut_batch_update_invoices_with_http_info(request, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_batch_update_invoices_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ut_batch_update_invoices ...'
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.p_ut_batch_update_invoices"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ut_batch_update_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Reverse invoice
    ...
    def p_ut_reverse_invoice(invoice_id, request, opts = {})
      data, _status_code, _headers = p_ut_reverse_invoice_with_http_info(invoice_id, request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(PutReverseInvoiceResponseType, Fixnum, Hash)>] PutReverseInvoiceResponseType data, response status code and response headers
    def p_ut_reverse_invoice_with_http_info(invoice_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ut_reverse_invoice ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.p_ut_reverse_invoice"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.p_ut_reverse_invoice"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}/reverse'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PutReverseInvoiceResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ut_reverse_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update invoice
    ...
    def p_ut_update_invoice(invoice_id, request, opts = {})
      data, _status_code, _headers = p_ut_update_invoice_with_http_info(invoice_id, request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(PutInvoiceResponseType, Fixnum, Hash)>] PutInvoiceResponseType data, response status code and response headers
    def p_ut_update_invoice_with_http_info(invoice_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.p_ut_update_invoice ...'
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.p_ut_update_invoice"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.p_ut_update_invoice"
      end
      # resource path
      local_var_path = '/v1/invoices/{invoiceId}'.sub('{' + 'invoiceId' + '}', invoice_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PutInvoiceResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#p_ut_update_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
