...
module Zuora
  class InvoicesApi
    ...
    def get_breakdown_invoice_by_order(invoice_number, opts = {})
      data, _status_code, _headers = get_breakdown_invoice_by_order_with_http_info(invoice_number, opts)
      return data
    end
    ...
    def get_breakdown_invoice_by_order_with_http_info(invoice_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.get_breakdown_invoice_by_order ..."
      end
      # verify the required parameter 'invoice_number' is set
      if @api_client.config.client_side_validation && invoice_number.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_number' when calling InvoicesApi.get_breakdown_invoice_by_order"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#get_breakdown_invoice_by_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def post_credit_memo_from_invoice(body, invoice_id, opts = {})
      data, _status_code, _headers = post_credit_memo_from_invoice_with_http_info(body, invoice_id, opts)
      return data
    end
    ...
    def post_credit_memo_from_invoice_with_http_info(body, invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.post_credit_memo_from_invoice ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling InvoicesApi.post_credit_memo_from_invoice"
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.post_credit_memo_from_invoice"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#post_credit_memo_from_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_debit_memo_from_invoice(invoice_id, body, opts = {})
      data, _status_code, _headers = post_debit_memo_from_invoice_with_http_info(invoice_id, body, opts)
      return data
    end
    ...
    def post_debit_memo_from_invoice_with_http_info(invoice_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.post_debit_memo_from_invoice ..."
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.post_debit_memo_from_invoice"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling InvoicesApi.post_debit_memo_from_invoice"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#post_debit_memo_from_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_email_invoice(request, invoice_id, opts = {})
      data, _status_code, _headers = post_email_invoice_with_http_info(request, invoice_id, opts)
      return data
    end
    ...
    def post_email_invoice_with_http_info(request, invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.post_email_invoice ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.post_email_invoice"
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.post_email_invoice"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#post_email_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_reverse_invoice(invoice_id, request, opts = {})
      data, _status_code, _headers = put_reverse_invoice_with_http_info(invoice_id, request, opts)
      return data
    end
    ...
    def put_reverse_invoice_with_http_info(invoice_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.put_reverse_invoice ..."
      end
      # verify the required parameter 'invoice_id' is set
      if @api_client.config.client_side_validation && invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_id' when calling InvoicesApi.put_reverse_invoice"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling InvoicesApi.put_reverse_invoice"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#put_reverse_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
