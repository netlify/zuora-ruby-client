...
module Zuora
  class AttachmentsApi
    ...
    def delete_attachments(attachment_id, opts = {})
      data, _status_code, _headers = delete_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    def delete_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.delete_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.delete_attachments"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#delete_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_attachments(attachment_id, opts = {})
      data, _status_code, _headers = get_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    def get_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.get_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.get_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments/{attachment-id}".sub('{' + 'attachment-id' + '}', attachment_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#get_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_attachments_list(object_type, object_key, opts = {})
      data, _status_code, _headers = get_attachments_list_with_http_info(object_type, object_key, opts)
      return data
    end
    ...
    def get_attachments_list_with_http_info(object_type, object_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.get_attachments_list ..."
      end
      # verify the required parameter 'object_type' is set
      if @api_client.config.client_side_validation && object_type.nil?
        fail ArgumentError, "Missing the required parameter 'object_type' when calling AttachmentsApi.get_attachments_list"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && object_key.nil?
        fail ArgumentError, "Missing the required parameter 'object_key' when calling AttachmentsApi.get_attachments_list"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AttachmentsApi.get_attachments_list, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#get_attachments_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_attachments(associated_object_type, associated_object_key, request, opts = {})
      data, _status_code, _headers = post_attachments_with_http_info(associated_object_type, associated_object_key, request, opts)
      return data
    end
    ...
    def post_attachments_with_http_info(associated_object_type, associated_object_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.post_attachments ..."
      end
      ...
      if @api_client.config.client_side_validation && associated_object_type.nil?
        fail ArgumentError, "Missing the required parameter 'associated_object_type' when calling AttachmentsApi.post_attachments"
      end
      ...
      if @api_client.config.client_side_validation && associated_object_key.nil?
        fail ArgumentError, "Missing the required parameter 'associated_object_key' when calling AttachmentsApi.post_attachments"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AttachmentsApi.post_attachments"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#post_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [CommonResponseType]
    def put_attachments(attachment_id, opts = {})
      data, _status_code, _headers = put_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    # @option opts [PUTAttachmentType] :request 
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def put_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.put_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.put_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments/{attachment-id}".sub('{' + 'attachment-id' + '}', attachment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#put_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
