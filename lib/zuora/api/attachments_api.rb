...
module Zuora
  class AttachmentsApi
    ...
    def p_ost_attachments(associated_object_type, associated_object_key, file, opts = {})
      data, _status_code, _headers = p_ost_attachments_with_http_info(associated_object_type, associated_object_key, file, opts)
      data
    end
    ...
    def p_ost_attachments_with_http_info(associated_object_type, associated_object_key, file, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && file.nil?
        fail ArgumentError, "Missing the required parameter 'file' when calling AttachmentsApi.p_ost_attachments"
      end
      # resource path
