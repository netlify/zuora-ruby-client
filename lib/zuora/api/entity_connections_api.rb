...
module Zuora
  class EntityConnectionsApi
    ...
    def get_entity_connections(opts = {})
      data, _status_code, _headers = get_entity_connections_with_http_info(opts)
      return data
    end
    ...
    def get_entity_connections_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.get_entity_connections ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EntityConnectionsApi.get_entity_connections, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#get_entity_connections\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def post_entity_connections(opts = {})
      data, _status_code, _headers = post_entity_connections_with_http_info(opts)
      return data
    end
    ...
    def post_entity_connections_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.post_entity_connections ..."
      end
      # resource path
      local_var_path = "/v1/entity-connections"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#post_entity_connections\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_entity_connections_accept(connection_id, opts = {})
      data, _status_code, _headers = put_entity_connections_accept_with_http_info(connection_id, opts)
      return data
    end
    ...
    def put_entity_connections_accept_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.put_entity_connections_accept ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.put_entity_connections_accept"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#put_entity_connections_accept\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_entity_connections_deny(connection_id, opts = {})
      data, _status_code, _headers = put_entity_connections_deny_with_http_info(connection_id, opts)
      return data
    end
    ...
    def put_entity_connections_deny_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.put_entity_connections_deny ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.put_entity_connections_deny"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#put_entity_connections_deny\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_entity_connections_disconnect(connection_id, opts = {})
      data, _status_code, _headers = put_entity_connections_disconnect_with_http_info(connection_id, opts)
      return data
    end
    ...
    def put_entity_connections_disconnect_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.put_entity_connections_disconnect ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.put_entity_connections_disconnect"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#put_entity_connections_disconnect\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
