...
module Zuora
  class AccountsApi
    ...
    def get_account(account_key, opts = {})
      data, _status_code, _headers = get_account_with_http_info(account_key, opts)
      return data
    end
    ...
    def get_account_with_http_info(account_key, opts = {})
      ...
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.get_account"
      end
      # resource path
      local_var_path = "/v1/accounts/{account-key}".sub('{' + 'account-key' + '}', account_key.to_s)
    ...
    def get_account_summary(account_key, opts = {})
      data, _status_code, _headers = get_account_summary_with_http_info(account_key, opts)
      return data
    end
    ...
    def get_account_summary_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.get_account_summary ..."
      end
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.get_account_summary"
      end
      # resource path
      local_var_path = "/v1/accounts/{account-key}/summary".sub('{' + 'account-key' + '}', account_key.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#get_account_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_delete_account(id, opts = {})
      data, _status_code, _headers = object_delete_account_with_http_info(id, opts)
      return data
    end
    ...
    def object_delete_account_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.object_delete_account ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountsApi.object_delete_account"
      end
      # resource path
      local_var_path = "/v1/object/account/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#object_delete_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_get_account(id, opts = {})
      data, _status_code, _headers = object_get_account_with_http_info(id, opts)
      return data
    end
    ...
    def object_get_account_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.object_get_account ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountsApi.object_get_account"
      end
      # resource path
      local_var_path = "/v1/object/account/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#object_get_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_account(create_request, opts = {})
      data, _status_code, _headers = object_post_account_with_http_info(create_request, opts)
      return data
    end
    ...
    def object_post_account_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.object_post_account ..."
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling AccountsApi.object_post_account"
      end
      # resource path
      local_var_path = "/v1/object/account"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#object_post_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [ProxyCreateOrModifyResponse]
    def object_put_account(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_account_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_account_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.object_put_account ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountsApi.object_put_account"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling AccountsApi.object_put_account"
      end
      # resource path
      local_var_path = "/v1/object/account/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#object_put_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_account(request, opts = {})
      data, _status_code, _headers = post_account_with_http_info(request, opts)
      return data
    end
    ...
    def post_account_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.post_account ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountsApi.post_account"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#post_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_generate_billing_documents(body, id, opts = {})
      data, _status_code, _headers = post_generate_billing_documents_with_http_info(body, id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GenerateBillingDocumentResponseType, Fixnum, Hash)>] GenerateBillingDocumentResponseType data, response status code and response headers
    def post_generate_billing_documents_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.post_generate_billing_documents ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AccountsApi.post_generate_billing_documents"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountsApi.post_generate_billing_documents"
      end
      # resource path
      local_var_path = "/v1/accounts/{id}/billing-documents/generate".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GenerateBillingDocumentResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#post_generate_billing_documents\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_account(account_key, request, opts = {})
      data, _status_code, _headers = put_account_with_http_info(account_key, request, opts)
      return data
    end
    ...
    def put_account_with_http_info(account_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.put_account ..."
      end
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.put_account"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountsApi.put_account"
      end
      # resource path
      local_var_path = "/v1/accounts/{account-key}".sub('{' + 'account-key' + '}', account_key.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#put_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
