...
module Zuora
  class RevenueItemsApi
    ...
    # @param event_number The number associated with the revenue event.
    ...
    def g_et_revenue_items_by_charge_revenue_event_number(event_number, opts = {})
      data, _status_code, _headers = g_et_revenue_items_by_charge_revenue_event_number_with_http_info(event_number, opts)
      data
    end
    ...
    # @return [Array<(GETRevenueItemsType, Fixnum, Hash)>] GETRevenueItemsType data, response status code and response headers
    def g_et_revenue_items_by_charge_revenue_event_number_with_http_info(event_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RevenueItemsApi.g_et_revenue_items_by_charge_revenue_event_number ...'
      end
      # verify the required parameter 'event_number' is set
      if @api_client.config.client_side_validation && event_number.nil?
        fail ArgumentError, "Missing the required parameter 'event_number' when calling RevenueItemsApi.g_et_revenue_items_by_charge_revenue_event_number"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RevenueItemsApi.g_et_revenue_items_by_charge_revenue_event_number, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = '/v1/revenue-items/revenue-events/{event-number}'.sub('{' + 'event-number' + '}', event_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRevenueItemsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueItemsApi#g_et_revenue_items_by_charge_revenue_event_number\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param crs_number The charge revenue summary number.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [Integer] :page_size Number of rows returned per page.  (default to 300)
    # @return [GETRevenueItemsType]
    def g_et_revenue_items_by_charge_revenue_summary_number(crs_number, opts = {})
      data, _status_code, _headers = g_et_revenue_items_by_charge_revenue_summary_number_with_http_info(crs_number, opts)
      data
    end
    ...
    # @option opts [Integer] :page_size Number of rows returned per page. 
    # @return [Array<(GETRevenueItemsType, Fixnum, Hash)>] GETRevenueItemsType data, response status code and response headers
    def g_et_revenue_items_by_charge_revenue_summary_number_with_http_info(crs_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RevenueItemsApi.g_et_revenue_items_by_charge_revenue_summary_number ...'
      end
      # verify the required parameter 'crs_number' is set
      if @api_client.config.client_side_validation && crs_number.nil?
        fail ArgumentError, "Missing the required parameter 'crs_number' when calling RevenueItemsApi.g_et_revenue_items_by_charge_revenue_summary_number"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RevenueItemsApi.g_et_revenue_items_by_charge_revenue_summary_number, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = '/v1/revenue-items/charge-revenue-summaries/{crs-number}'.sub('{' + 'crs-number' + '}', crs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRevenueItemsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueItemsApi#g_et_revenue_items_by_charge_revenue_summary_number\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_revenue_items_by_revenue_schedule(rs_number, opts = {})
      data, _status_code, _headers = g_et_revenue_items_by_revenue_schedule_with_http_info(rs_number, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @option opts [Integer] :page_size Number of rows returned per page. 
    # @return [Array<(GETRsRevenueItemsType, Fixnum, Hash)>] GETRsRevenueItemsType data, response status code and response headers
    def g_et_revenue_items_by_revenue_schedule_with_http_info(rs_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RevenueItemsApi.g_et_revenue_items_by_revenue_schedule ...'
      end
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueItemsApi.g_et_revenue_items_by_revenue_schedule"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RevenueItemsApi.g_et_revenue_items_by_revenue_schedule, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = '/v1/revenue-items/revenue-schedules/{rs-number}'.sub('{' + 'rs-number' + '}', rs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETRsRevenueItemsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueItemsApi#g_et_revenue_items_by_revenue_schedule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_event(event_number, request, opts = {})
      data, _status_code, _headers = p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(event_number, request, opts)
      data
    end
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(event_number, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_event ...'
      end
      # verify the required parameter 'event_number' is set
      if @api_client.config.client_side_validation && event_number.nil?
        fail ArgumentError, "Missing the required parameter 'event_number' when calling RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_event"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_event"
      end
      # resource path
      local_var_path = '/v1/revenue-items/revenue-events/{event-number}'.sub('{' + 'event-number' + '}', event_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueItemsApi#p_ut_custom_fieldson_revenue_items_by_revenue_event\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [CommonResponseType]
    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule(rs_number, request, opts = {})
      data, _status_code, _headers = p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(rs_number, request, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(rs_number, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_schedule ...'
      end
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_schedule"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueItemsApi.p_ut_custom_fieldson_revenue_items_by_revenue_schedule"
      end
      # resource path
      local_var_path = '/v1/revenue-items/revenue-schedules/{rs-number}'.sub('{' + 'rs-number' + '}', rs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueItemsApi#p_ut_custom_fieldson_revenue_items_by_revenue_schedule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
