...
module Zuora
  class PaymentMethodsApi
    ...
    def delete_payment_methods(payment_method_id, opts = {})
      data, _status_code, _headers = delete_payment_methods_with_http_info(payment_method_id, opts)
      return data
    end
    ...
    def delete_payment_methods_with_http_info(payment_method_id, opts = {})
      ...
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.delete_payment_methods"
      end
      # resource path
    ...
    def get_payment_methods(account_key, opts = {})
      data, _status_code, _headers = get_payment_methods_with_http_info(account_key, opts)
      return data
    end
    ...
    def get_payment_methods_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling PaymentMethodsApi.get_payment_methods"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling PaymentMethodsApi.get_payment_methods, must be smaller than or equal to 40.'
      end
    ...
    def post_payment_methods(request, opts = {})
      data, _status_code, _headers = post_payment_methods_with_http_info(request, opts)
      return data
    end
    ...
    def post_payment_methods_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.post_payment_methods ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.post_payment_methods"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#post_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_payment_methods_decryption(request, opts = {})
      data, _status_code, _headers = post_payment_methods_decryption_with_http_info(request, opts)
      return data
    end
    ...
    def post_payment_methods_decryption_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.post_payment_methods_decryption ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.post_payment_methods_decryption"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#post_payment_methods_decryption\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_payment_methods(payment_method_id, request, opts = {})
      data, _status_code, _headers = put_payment_methods_with_http_info(payment_method_id, request, opts)
      return data
    end
    ...
    def put_payment_methods_with_http_info(payment_method_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.put_payment_methods ..."
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.put_payment_methods"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.put_payment_methods"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#put_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_verify_payment_methods(payment_method_id, body, opts = {})
      data, _status_code, _headers = put_verify_payment_methods_with_http_info(payment_method_id, body, opts)
      return data
    end
    ...
    def put_verify_payment_methods_with_http_info(payment_method_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.put_verify_payment_methods ..."
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.put_verify_payment_methods"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentMethodsApi.put_verify_payment_methods"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#put_verify_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
