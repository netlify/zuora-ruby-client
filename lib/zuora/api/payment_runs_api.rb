...
module Zuora
  class PaymentRunsApi
    ...
    # @param payment_run_id The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
    # @param [Hash] opts the optional parameters
    # @return [CommonResponseType]
    def d_elete_payment_run(payment_run_id, opts = {})
      data, _status_code, _headers = d_elete_payment_run_with_http_info(payment_run_id, opts)
      data
    end
    ...
    def d_elete_payment_run_with_http_info(payment_run_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.d_elete_payment_run ...'
      end
      # verify the required parameter 'payment_run_id' is set
      if @api_client.config.client_side_validation && payment_run_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_run_id' when calling PaymentRunsApi.d_elete_payment_run"
      end
      # resource path
      local_var_path = '/v1/payment-runs/{paymentRunId}'.sub('{' + 'paymentRunId' + '}', payment_run_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#d_elete_payment_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_payment_run(payment_run_id, opts = {})
      data, _status_code, _headers = g_et_payment_run_with_http_info(payment_run_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETPaymentRunType, Fixnum, Hash)>] GETPaymentRunType data, response status code and response headers
    def g_et_payment_run_with_http_info(payment_run_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.g_et_payment_run ...'
      end
      # verify the required parameter 'payment_run_id' is set
      if @api_client.config.client_side_validation && payment_run_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_run_id' when calling PaymentRunsApi.g_et_payment_run"
      end
      # resource path
      local_var_path = '/v1/payment-runs/{paymentRunId}'.sub('{' + 'paymentRunId' + '}', payment_run_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETPaymentRunType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#g_et_payment_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_payment_run_summary(payment_run_id, opts = {})
      data, _status_code, _headers = g_et_payment_run_summary_with_http_info(payment_run_id, opts)
      data
    end
    ...
    # @param payment_run_id The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETPaymentRunSummaryResponse, Fixnum, Hash)>] GETPaymentRunSummaryResponse data, response status code and response headers
    def g_et_payment_run_summary_with_http_info(payment_run_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.g_et_payment_run_summary ...'
      end
      # verify the required parameter 'payment_run_id' is set
      if @api_client.config.client_side_validation && payment_run_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_run_id' when calling PaymentRunsApi.g_et_payment_run_summary"
      end
      # resource path
      local_var_path = '/v1/payment-runs/{paymentRunId}/summary'.sub('{' + 'paymentRunId' + '}', payment_run_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETPaymentRunSummaryResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#g_et_payment_run_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get payment runs
    ...
    def g_et_payment_runs(opts = {})
      data, _status_code, _headers = g_et_payment_runs_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :fields_filterable This parameter restricts the data returned in the response. You can use this parameter to supply a dimension you want to filter on.  A single filter uses the following form:   *fieldsFilterable* &#x60;&#x3D;&#x60; *field_value*              Filters can be combined by using &#x60;&amp;&#x60;. For example: *fieldsFilterable* &#x60;&#x3D;&#x60; *field_value* &#x60;&amp;&#x60; *fieldsFilterable* &#x60;&#x3D;&#x60; *field_value*  *fieldsFilterable* indicates the name of a supported field that you can use to filter the response data. The supported filterable fields of this operation are as below:    - targetDate   - status   - createdDate   - createdById   - updatedDate   - updatedById   *field_value* indicates a valid value of the filterable field. If the type of the field value is string, you can set the field to &#x60;null&#x60; value for filtering. Then, you can get the response data with this field value being &#x60;null&#x60;. For more information about these fields, see the field descriptions in the **Responses** section.     Examples:  - /payment-runs?status&#x3D;Processed  - /payment-runs?targetDate&#x3D;2017-10-10&amp;status&#x3D;Pending  - /payment-runs?status&#x3D;Completed&amp;sort&#x3D;+updatedDate 
    # @option opts [String] :sort This parameter restricts the order of the data returned in the response. You can use this parameter to supply a dimension you want to sort on.  A sortable field uses the following form:   *operator* *field_name*  You can use at most two sortable fields in one URL path. Use a comma to separate sortable fields. For example:  *operator* *field_name*, *operator* *field_name*    *operator* is used to mark the order of sequencing. The operator is optional. If you only specify the sortable field without any operator, the response data is sorted in descending order by this field.    - The &#x60;-&#x60; operator indicates an ascending order.   - The &#x60;+&#x60; operator indicates a descending order.  By default, the response data is displayed in descending order by payment run number.  *field_name* indicates the name of a sortable field. The supported sortable fields of this operation are as below:    - targetDate   - status   - createdDate   - createdById   - updatedDate   - updatedById  Examples:  - /payment-runs?sort&#x3D;+createdDate  - /payment-runs?status&#x3D;Processing&amp;sort&#x3D;-createdById,+targetDate 
    # @return [Array<(GETPaymentRunCollectionType, Fixnum, Hash)>] GETPaymentRunCollectionType data, response status code and response headers
    def g_et_payment_runs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.g_et_payment_runs ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling PaymentRunsApi.g_et_payment_runs, must be smaller than or equal to 40.'
      end

      # resource path
      local_var_path = '/v1/payment-runs'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETPaymentRunCollectionType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#g_et_payment_runs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create payment run
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETPaymentRunType]
    def p_ost_payment_run(body, opts = {})
      data, _status_code, _headers = p_ost_payment_run_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETPaymentRunType, Fixnum, Hash)>] GETPaymentRunType data, response status code and response headers
    def p_ost_payment_run_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.p_ost_payment_run ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentRunsApi.p_ost_payment_run"
      end
      # resource path
      local_var_path = '/v1/payment-runs'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'GETPaymentRunType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#p_ost_payment_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update payment run
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [GETPaymentRunType]
    def p_ut_payment_run(payment_run_id, body, opts = {})
      data, _status_code, _headers = p_ut_payment_run_with_http_info(payment_run_id, body, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GETPaymentRunType, Fixnum, Hash)>] GETPaymentRunType data, response status code and response headers
    def p_ut_payment_run_with_http_info(payment_run_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentRunsApi.p_ut_payment_run ...'
      end
      # verify the required parameter 'payment_run_id' is set
      if @api_client.config.client_side_validation && payment_run_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_run_id' when calling PaymentRunsApi.p_ut_payment_run"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentRunsApi.p_ut_payment_run"
      end
      # resource path
      local_var_path = '/v1/payment-runs/{paymentRunId}'.sub('{' + 'paymentRunId' + '}', payment_run_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETPaymentRunType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentRunsApi#p_ut_payment_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
