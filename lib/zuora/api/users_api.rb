...
module Zuora
  class UsersApi
    ...
    def get_entities_user_accessible(username, opts = {})
      data, _status_code, _headers = get_entities_user_accessible_with_http_info(username, opts)
      return data
    end
    ...
    def get_entities_user_accessible_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.get_entities_user_accessible ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.get_entities_user_accessible"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#get_entities_user_accessible\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def put_accept_user_access(username, opts = {})
      data, _status_code, _headers = put_accept_user_access_with_http_info(username, opts)
      return data
    end
    ...
    def put_accept_user_access_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.put_accept_user_access ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.put_accept_user_access"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#put_accept_user_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_deny_user_access(username, opts = {})
      data, _status_code, _headers = put_deny_user_access_with_http_info(username, opts)
      return data
    end
    ...
    def put_deny_user_access_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.put_deny_user_access ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.put_deny_user_access"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#put_deny_user_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def put_send_user_access_requests(username, request, opts = {})
      data, _status_code, _headers = put_send_user_access_requests_with_http_info(username, request, opts)
      return data
    end
    ...
    def put_send_user_access_requests_with_http_info(username, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.put_send_user_access_requests ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.put_send_user_access_requests"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling UsersApi.put_send_user_access_requests"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#put_send_user_access_requests\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
