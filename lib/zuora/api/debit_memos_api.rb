...
module Zuora
  class DebitMemosApi
    ...
    def g_et_debit_memo_application_parts(debit_memo_id, opts = {})
      data, _status_code, _headers = g_et_debit_memo_application_parts_with_http_info(debit_memo_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(GetDebitMemoApplicationPartCollectionType, Fixnum, Hash)>] GetDebitMemoApplicationPartCollectionType data, response status code and response headers
    def g_et_debit_memo_application_parts_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DebitMemosApi.g_et_debit_memo_application_parts ...'
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.g_et_debit_memo_application_parts"
      end
      # resource path
      local_var_path = '/v1/debitmemos/{debitMemoId}/application-parts'.sub('{' + 'debitMemoId' + '}', debit_memo_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetDebitMemoApplicationPartCollectionType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#g_et_debit_memo_application_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get debit memo item
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [CommonResponseType]
    def p_ut_batch_update_debit_memos(body, opts = {})
      data, _status_code, _headers = p_ut_batch_update_debit_memos_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :zuora_entity_ids An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_batch_update_debit_memos_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DebitMemosApi.p_ut_batch_update_debit_memos ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DebitMemosApi.p_ut_batch_update_debit_memos"
      end
      # resource path
      local_var_path = '/v1/debitmemos'
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#p_ut_batch_update_debit_memos\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Cancel debit memo
