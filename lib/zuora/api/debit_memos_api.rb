...
module Zuora
  class DebitMemosApi
    ...
    def delete_debit_memo(debit_memo_id, opts = {})
      data, _status_code, _headers = delete_debit_memo_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    def delete_debit_memo_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.delete_debit_memo ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.delete_debit_memo"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#delete_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_debit_memo(debit_memo_id, opts = {})
      data, _status_code, _headers = get_debit_memo_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    def get_debit_memo_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.get_debit_memo ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.get_debit_memo"
      end
      # resource path
      local_var_path = "/v1/debitmemos/{debitMemoId}".sub('{' + 'debitMemoId' + '}', debit_memo_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#get_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_debit_memo_item(dmitemid, debit_memo_id, opts = {})
      data, _status_code, _headers = get_debit_memo_item_with_http_info(dmitemid, debit_memo_id, opts)
      return data
    end
    ...
    def get_debit_memo_item_with_http_info(dmitemid, debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.get_debit_memo_item ..."
      end
      # verify the required parameter 'dmitemid' is set
      if @api_client.config.client_side_validation && dmitemid.nil?
        fail ArgumentError, "Missing the required parameter 'dmitemid' when calling DebitMemosApi.get_debit_memo_item"
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.get_debit_memo_item"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#get_debit_memo_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_debit_memo_items(debit_memo_id, opts = {})
      data, _status_code, _headers = get_debit_memo_items_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    def get_debit_memo_items_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.get_debit_memo_items ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.get_debit_memo_items"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling DebitMemosApi.get_debit_memo_items, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#get_debit_memo_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_debit_memos(opts = {})
      data, _status_code, _headers = get_debit_memos_with_http_info(opts)
      return data
    end
    ...
    def get_debit_memos_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.get_debit_memos ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling DebitMemosApi.get_debit_memos, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#get_debit_memos\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETDebitMemoType]
    def post_debit_memo_from_prpc(body, opts = {})
      data, _status_code, _headers = post_debit_memo_from_prpc_with_http_info(body, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETDebitMemoType, Fixnum, Hash)>] GETDebitMemoType data, response status code and response headers
    def post_debit_memo_from_prpc_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.post_debit_memo_from_prpc ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DebitMemosApi.post_debit_memo_from_prpc"
      end
      # resource path
      local_var_path = "/v1/debitmemos"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'GETDebitMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#post_debit_memo_from_prpc\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_debit_memo_pdf(debit_memo_id, opts = {})
      data, _status_code, _headers = post_debit_memo_pdf_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    def post_debit_memo_pdf_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.post_debit_memo_pdf ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.post_debit_memo_pdf"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#post_debit_memo_pdf\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def post_email_debit_memo(request, debit_memo_id, opts = {})
      data, _status_code, _headers = post_email_debit_memo_with_http_info(request, debit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def post_email_debit_memo_with_http_info(request, debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.post_email_debit_memo ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling DebitMemosApi.post_email_debit_memo"
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.post_email_debit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#post_email_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_dm_taxation_items(debit_memo_id, body, opts = {})
      data, _status_code, _headers = post_dm_taxation_items_with_http_info(debit_memo_id, body, opts)
      return data
    end
    ...
    def post_dm_taxation_items_with_http_info(debit_memo_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.post_dm_taxation_items ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.post_dm_taxation_items"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DebitMemosApi.post_dm_taxation_items"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#post_dm_taxation_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETDebitMemoType]
    def put_cancel_debit_memo(debit_memo_id, opts = {})
      data, _status_code, _headers = put_cancel_debit_memo_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETDebitMemoType, Fixnum, Hash)>] GETDebitMemoType data, response status code and response headers
    def put_cancel_debit_memo_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.put_cancel_debit_memo ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.put_cancel_debit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETDebitMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#put_cancel_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETDebitMemoType]
    def put_debit_memo(body, debit_memo_id, opts = {})
      data, _status_code, _headers = put_debit_memo_with_http_info(body, debit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETDebitMemoType, Fixnum, Hash)>] GETDebitMemoType data, response status code and response headers
    def put_debit_memo_with_http_info(body, debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.put_debit_memo ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DebitMemosApi.put_debit_memo"
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.put_debit_memo"
      end
      # resource path
      local_var_path = "/v1/debitmemos/{debitMemoId}".sub('{' + 'debitMemoId' + '}', debit_memo_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETDebitMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#put_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETDebitMemoType]
    def put_post_debit_memo(debit_memo_id, opts = {})
      data, _status_code, _headers = put_post_debit_memo_with_http_info(debit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETDebitMemoType, Fixnum, Hash)>] GETDebitMemoType data, response status code and response headers
    def put_post_debit_memo_with_http_info(debit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DebitMemosApi.put_post_debit_memo ..."
      end
      # verify the required parameter 'debit_memo_id' is set
      if @api_client.config.client_side_validation && debit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'debit_memo_id' when calling DebitMemosApi.put_post_debit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETDebitMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DebitMemosApi#put_post_debit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
