...
module Zuora
  class UsageApi
    ...
    def get_usage(account_key, opts = {})
      data, _status_code, _headers = get_usage_with_http_info(account_key, opts)
      return data
    end
    ...
    def get_usage_with_http_info(account_key, opts = {})
      ...
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling UsageApi.get_usage"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling UsageApi.get_usage, must be smaller than or equal to 40.'
      end
    ...
    def post_usage(content_type, opts = {})
      data, _status_code, _headers = post_usage_with_http_info(content_type, opts)
      return data
    end
    ...
    def post_usage_with_http_info(content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsageApi.post_usage ..."
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling UsageApi.post_usage"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsageApi#post_usage\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
