...
module SwaggerClient
  class EntityConnectionsApi
    ...
    # @option opts [Integer] :page_size Number of rows returned per page.  (default to 30)
    # @option opts [String] :type Specifies whether to retrieve inbound or outbound connections for an entity.  Possible values:  - &#x60;inbound&#x60;: All the incoming connections to the entity.  - &#x60;outbound&#x60;: All the outgoing connections from the entity.  If you do not specify this field in the request, both the inbound and outbound connections are returned. 
    # @return [GETEntityConnectionsResponseType]
    def g_et_entity_connections(opts = {})
      data, _status_code, _headers = g_et_entity_connections_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :type Specifies whether to retrieve inbound or outbound connections for an entity.  Possible values:  - &#x60;inbound&#x60;: All the incoming connections to the entity.  - &#x60;outbound&#x60;: All the outgoing connections from the entity.  If you do not specify this field in the request, both the inbound and outbound connections are returned. 
    # @return [Array<(GETEntityConnectionsResponseType, Fixnum, Hash)>] GETEntityConnectionsResponseType data, response status code and response headers
    def g_et_entity_connections_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.g_et_entity_connections ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EntityConnectionsApi.g_et_entity_connections, must be smaller than or equal to 300.'
      end

      if @api_client.config.client_side_validation && opts[:'type'] && !['inbound', 'outbound'].include?(opts[:'type'])
        fail ArgumentError, 'invalid value for "type", must be one of inbound, outbound'
      end
      # resource path
      local_var_path = "/v1/entity-connections"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETEntityConnectionsResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#g_et_entity_connections\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [POSTEntityConnectionsType] :request 
    # @return [POSTEntityConnectionsResponseType]
    def p_ost_entity_connections(opts = {})
      data, _status_code, _headers = p_ost_entity_connections_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [POSTEntityConnectionsType] :request 
    # @return [Array<(POSTEntityConnectionsResponseType, Fixnum, Hash)>] POSTEntityConnectionsResponseType data, response status code and response headers
    def p_ost_entity_connections_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.p_ost_entity_connections ..."
      end
      # resource path
      local_var_path = "/v1/entity-connections"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTEntityConnectionsResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#p_ost_entity_connections\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param connection_id The ID of the connection that you want to accept. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [PUTEntityConnectionsAcceptResponseType]
    def p_ut_entity_connections_accept(connection_id, opts = {})
      data, _status_code, _headers = p_ut_entity_connections_accept_with_http_info(connection_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTEntityConnectionsAcceptResponseType, Fixnum, Hash)>] PUTEntityConnectionsAcceptResponseType data, response status code and response headers
    def p_ut_entity_connections_accept_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.p_ut_entity_connections_accept ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.p_ut_entity_connections_accept"
      end
      # resource path
      local_var_path = "/v1/entity-connections/{connection-id}/accept".sub('{' + 'connection-id' + '}', connection_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTEntityConnectionsAcceptResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#p_ut_entity_connections_accept\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param connection_id The ID of the connection that you want to deny. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [PUTEntityConnectionsDenyResponseType]
    def p_ut_entity_connections_deny(connection_id, opts = {})
      data, _status_code, _headers = p_ut_entity_connections_deny_with_http_info(connection_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTEntityConnectionsDenyResponseType, Fixnum, Hash)>] PUTEntityConnectionsDenyResponseType data, response status code and response headers
    def p_ut_entity_connections_deny_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.p_ut_entity_connections_deny ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.p_ut_entity_connections_deny"
      end
      # resource path
      local_var_path = "/v1/entity-connections/{connection-id}/deny".sub('{' + 'connection-id' + '}', connection_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTEntityConnectionsDenyResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#p_ut_entity_connections_deny\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param connection_id The ID of the connection that you want to disconnect. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [PUTEntityConnectionsDisconnectResponseType]
    def p_ut_entity_connections_disconnect(connection_id, opts = {})
      data, _status_code, _headers = p_ut_entity_connections_disconnect_with_http_info(connection_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTEntityConnectionsDisconnectResponseType, Fixnum, Hash)>] PUTEntityConnectionsDisconnectResponseType data, response status code and response headers
    def p_ut_entity_connections_disconnect_with_http_info(connection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EntityConnectionsApi.p_ut_entity_connections_disconnect ..."
      end
      # verify the required parameter 'connection_id' is set
      if @api_client.config.client_side_validation && connection_id.nil?
        fail ArgumentError, "Missing the required parameter 'connection_id' when calling EntityConnectionsApi.p_ut_entity_connections_disconnect"
      end
      # resource path
      local_var_path = "/v1/entity-connections/{connection-id}/disconnect".sub('{' + 'connection-id' + '}', connection_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTEntityConnectionsDisconnectResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EntityConnectionsApi#p_ut_entity_connections_disconnect\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
