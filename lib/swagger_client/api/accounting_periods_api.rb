...
module SwaggerClient
  class AccountingPeriodsApi
    ...
    # @param ap_id ID of the accounting period you want to delete.
    ...
    def d_elete_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = d_elete_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    def d_elete_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.d_elete_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.d_elete_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#d_elete_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param ap_id ID of the accounting period you want to get.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETAccountingPeriodType]
    def g_et_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = g_et_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAccountingPeriodType, Fixnum, Hash)>] GETAccountingPeriodType data, response status code and response headers
    def g_et_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.g_et_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.g_et_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAccountingPeriodType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#g_et_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [Integer] :page_size Number of rows returned per page.  (default to 300)
    # @return [GETAccountingPeriodsType]
    def g_et_all_accounting_periods(opts = {})
      data, _status_code, _headers = g_et_all_accounting_periods_with_http_info(opts)
      return data
    end
    ...
    # @return [Array<(GETAccountingPeriodsType, Fixnum, Hash)>] GETAccountingPeriodsType data, response status code and response headers
    def g_et_all_accounting_periods_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.g_et_all_accounting_periods ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AccountingPeriodsApi.g_et_all_accounting_periods, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = "/v1/accounting-periods"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAccountingPeriodsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#g_et_all_accounting_periods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_accounting_period(request, opts = {})
      data, _status_code, _headers = p_ost_accounting_period_with_http_info(request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(POSTAccountingPeriodResponseType, Fixnum, Hash)>] POSTAccountingPeriodResponseType data, response status code and response headers
    def p_ost_accounting_period_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ost_accounting_period ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingPeriodsApi.p_ost_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTAccountingPeriodResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ost_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ap_id ID of the accounting period you want to close.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_close_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = p_ut_close_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_close_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ut_close_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.p_ut_close_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}/close".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ut_close_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ap_id ID of the accounting period you want to set to pending close.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_pending_close_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = p_ut_pending_close_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_pending_close_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ut_pending_close_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.p_ut_pending_close_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}/pending-close".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ut_pending_close_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ap_id ID of the accounting period that you want to re-open.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_reopen_accounting_period(ap_id, opts = {})
      data, _status_code, _headers = p_ut_reopen_accounting_period_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_reopen_accounting_period_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ut_reopen_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.p_ut_reopen_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}/reopen".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ut_reopen_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ap_id ID of the accounting period for which you want to run a trial balance.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_run_trial_balance(ap_id, opts = {})
      data, _status_code, _headers = p_ut_run_trial_balance_with_http_info(ap_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_run_trial_balance_with_http_info(ap_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ut_run_trial_balance ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.p_ut_run_trial_balance"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}/run-trial-balance".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ut_run_trial_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ap_id ID of the accounting period you want to update.
    # @param request 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_update_accounting_period(ap_id, request, opts = {})
      data, _status_code, _headers = p_ut_update_accounting_period_with_http_info(ap_id, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_update_accounting_period_with_http_info(ap_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingPeriodsApi.p_ut_update_accounting_period ..."
      end
      # verify the required parameter 'ap_id' is set
      if @api_client.config.client_side_validation && ap_id.nil?
        fail ArgumentError, "Missing the required parameter 'ap_id' when calling AccountingPeriodsApi.p_ut_update_accounting_period"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingPeriodsApi.p_ut_update_accounting_period"
      end
      # resource path
      local_var_path = "/v1/accounting-periods/{ap-id}".sub('{' + 'ap-id' + '}', ap_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingPeriodsApi#p_ut_update_accounting_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
