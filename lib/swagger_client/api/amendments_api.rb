...
module SwaggerClient
  class AmendmentsApi
    ...
    # @param amendment_key Can be the amendment ID or the amendment code.
    ...
    def g_et_amendments_by_key(amendment_key, opts = {})
      data, _status_code, _headers = g_et_amendments_by_key_with_http_info(amendment_key, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAmendmentType, Fixnum, Hash)>] GETAmendmentType data, response status code and response headers
    def g_et_amendments_by_key_with_http_info(amendment_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.g_et_amendments_by_key ..."
      end
      # verify the required parameter 'amendment_key' is set
      if @api_client.config.client_side_validation && amendment_key.nil?
        fail ArgumentError, "Missing the required parameter 'amendment_key' when calling AmendmentsApi.g_et_amendments_by_key"
      end
      # resource path
      local_var_path = "/v1/amendments/{amendment-key}".sub('{' + 'amendment-key' + '}', amendment_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETAmendmentType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#g_et_amendments_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param subscription_id The ID of the subscription whose amendment changes you want to retrieve.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETAmendmentType]
    def g_et_amendments_by_subscription_id(subscription_id, opts = {})
      data, _status_code, _headers = g_et_amendments_by_subscription_id_with_http_info(subscription_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAmendmentType, Fixnum, Hash)>] GETAmendmentType data, response status code and response headers
    def g_et_amendments_by_subscription_id_with_http_info(subscription_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.g_et_amendments_by_subscription_id ..."
      end
      # verify the required parameter 'subscription_id' is set
      if @api_client.config.client_side_validation && subscription_id.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_id' when calling AmendmentsApi.g_et_amendments_by_subscription_id"
      end
      # resource path
      local_var_path = "/v1/amendments/subscriptions/{subscription-id}".sub('{' + 'subscription-id' + '}', subscription_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETAmendmentType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#g_et_amendments_by_subscription_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_delete_amendment(id, opts = {})
      data, _status_code, _headers = object_delete_amendment_with_http_info(id, opts)
      return data
    end
    ...
    def object_delete_amendment_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.object_delete_amendment ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AmendmentsApi.object_delete_amendment"
      end
      # resource path
      local_var_path = "/v1/object/amendment/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#object_delete_amendment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_get_amendment(id, opts = {})
      data, _status_code, _headers = object_get_amendment_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetAmendment, Fixnum, Hash)>] ProxyGetAmendment data, response status code and response headers
    def object_get_amendment_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.object_get_amendment ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AmendmentsApi.object_get_amendment"
      end
      # resource path
      local_var_path = "/v1/object/amendment/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetAmendment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#object_get_amendment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_amendment(create_request, opts = {})
      data, _status_code, _headers = object_post_amendment_with_http_info(create_request, opts)
      return data
    end
    ...
    def object_post_amendment_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.object_post_amendment ..."
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling AmendmentsApi.object_post_amendment"
      end
      # resource path
      local_var_path = "/v1/object/amendment"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#object_post_amendment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [ProxyCreateOrModifyResponse]
    def object_put_amendment(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_amendment_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_amendment_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AmendmentsApi.object_put_amendment ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AmendmentsApi.object_put_amendment"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling AmendmentsApi.object_put_amendment"
      end
      # resource path
      local_var_path = "/v1/object/amendment/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AmendmentsApi#object_put_amendment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
