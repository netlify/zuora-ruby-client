...
module SwaggerClient
  class UnitOfMeasureApi
    ...
    def object_delete_unit_of_measure(id, opts = {})
      data, _status_code, _headers = object_delete_unit_of_measure_with_http_info(id, opts)
      return data
    end
    ...
    def object_delete_unit_of_measure_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UnitOfMeasureApi.object_delete_unit_of_measure ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasureApi.object_delete_unit_of_measure"
      end
      # resource path
      local_var_path = "/v1/object/unit-of-measure/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UnitOfMeasureApi#object_delete_unit_of_measure\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def object_get_unit_of_measure(id, opts = {})
      data, _status_code, _headers = object_get_unit_of_measure_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetUnitOfMeasure, Fixnum, Hash)>] ProxyGetUnitOfMeasure data, response status code and response headers
    def object_get_unit_of_measure_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UnitOfMeasureApi.object_get_unit_of_measure ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasureApi.object_get_unit_of_measure"
      end
      # resource path
      local_var_path = "/v1/object/unit-of-measure/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetUnitOfMeasure')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UnitOfMeasureApi#object_get_unit_of_measure\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_unit_of_measure(create_request, opts = {})
      data, _status_code, _headers = object_post_unit_of_measure_with_http_info(create_request, opts)
      return data
    end
    ...
    def object_post_unit_of_measure_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UnitOfMeasureApi.object_post_unit_of_measure ..."
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling UnitOfMeasureApi.object_post_unit_of_measure"
      end
      # resource path
      local_var_path = "/v1/object/unit-of-measure"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UnitOfMeasureApi#object_post_unit_of_measure\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [ProxyCreateOrModifyResponse]
    def object_put_unit_of_measure(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_unit_of_measure_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_unit_of_measure_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UnitOfMeasureApi.object_put_unit_of_measure ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasureApi.object_put_unit_of_measure"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling UnitOfMeasureApi.object_put_unit_of_measure"
      end
      # resource path
      local_var_path = "/v1/object/unit-of-measure/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UnitOfMeasureApi#object_put_unit_of_measure\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
