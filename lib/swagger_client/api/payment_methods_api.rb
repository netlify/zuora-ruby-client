...
module SwaggerClient
  class PaymentMethodsApi
    ...
    # @param payment_method_id Unique identifier of a payment method. (Since this ID is unique, and linked to a customer account in the system, no customer identifier is needed.)
    ...
    def d_elete_payment_methods(payment_method_id, opts = {})
      data, _status_code, _headers = d_elete_payment_methods_with_http_info(payment_method_id, opts)
      return data
    end
    ...
    def d_elete_payment_methods_with_http_info(payment_method_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.d_elete_payment_methods ..."
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.d_elete_payment_methods"
      end
      # resource path
      local_var_path = "/v1/payment-methods/{payment-method-id}".sub('{' + 'payment-method-id' + '}', payment_method_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#d_elete_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_payment_methods(account_key, opts = {})
      data, _status_code, _headers = g_et_payment_methods_with_http_info(account_key, opts)
      return data
    end
    ...
    # @return [Array<(GETPaymentMethodsType, Fixnum, Hash)>] GETPaymentMethodsType data, response status code and response headers
    def g_et_payment_methods_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.g_et_payment_methods ..."
      end
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling PaymentMethodsApi.g_et_payment_methods"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling PaymentMethodsApi.g_et_payment_methods, must be smaller than or equal to 40.'
      end

      # resource path
      local_var_path = "/v1/payment-methods/credit-cards/accounts/{account-key}".sub('{' + 'account-key' + '}', account_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETPaymentMethodsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#g_et_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_delete_payment_method(id, opts = {})
      data, _status_code, _headers = object_delete_payment_method_with_http_info(id, opts)
      return data
    end
    ...
    def object_delete_payment_method_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.object_delete_payment_method ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentMethodsApi.object_delete_payment_method"
      end
      # resource path
      local_var_path = "/v1/object/payment-method/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#object_delete_payment_method\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_get_payment_method(id, opts = {})
      data, _status_code, _headers = object_get_payment_method_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetPaymentMethod, Fixnum, Hash)>] ProxyGetPaymentMethod data, response status code and response headers
    def object_get_payment_method_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.object_get_payment_method ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentMethodsApi.object_get_payment_method"
      end
      # resource path
      local_var_path = "/v1/object/payment-method/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetPaymentMethod')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#object_get_payment_method\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def object_post_payment_method(create_request, opts = {})
      data, _status_code, _headers = object_post_payment_method_with_http_info(create_request, opts)
      return data
    end
    ...
    def object_post_payment_method_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.object_post_payment_method ..."
      end
      # verify the required parameter 'create_request' is set
      if @api_client.config.client_side_validation && create_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_request' when calling PaymentMethodsApi.object_post_payment_method"
      end
      # resource path
      local_var_path = "/v1/object/payment-method"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#object_post_payment_method\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [ProxyCreateOrModifyResponse]
    def object_put_payment_method(id, modify_request, opts = {})
      data, _status_code, _headers = object_put_payment_method_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def object_put_payment_method_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.object_put_payment_method ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentMethodsApi.object_put_payment_method"
      end
      # verify the required parameter 'modify_request' is set
      if @api_client.config.client_side_validation && modify_request.nil?
        fail ArgumentError, "Missing the required parameter 'modify_request' when calling PaymentMethodsApi.object_put_payment_method"
      end
      # resource path
      local_var_path = "/v1/object/payment-method/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#object_put_payment_method\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_payment_methods(request, opts = {})
      data, _status_code, _headers = p_ost_payment_methods_with_http_info(request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(POSTPaymentMethodResponseType, Fixnum, Hash)>] POSTPaymentMethodResponseType data, response status code and response headers
    def p_ost_payment_methods_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.p_ost_payment_methods ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.p_ost_payment_methods"
      end
      # resource path
      local_var_path = "/v1/payment-methods/credit-cards"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTPaymentMethodResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#p_ost_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_payment_methods_decryption(request, opts = {})
      data, _status_code, _headers = p_ost_payment_methods_decryption_with_http_info(request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(POSTPaymentMethodResponseDecryption, Fixnum, Hash)>] POSTPaymentMethodResponseDecryption data, response status code and response headers
    def p_ost_payment_methods_decryption_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.p_ost_payment_methods_decryption ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.p_ost_payment_methods_decryption"
      end
      # resource path
      local_var_path = "/v1/payment-methods/decryption"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTPaymentMethodResponseDecryption')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#p_ost_payment_methods_decryption\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param payment_method_id Unique ID of the payment method to update.
    # @param request 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [PUTPaymentMethodResponseType]
    def p_ut_payment_methods(payment_method_id, request, opts = {})
      data, _status_code, _headers = p_ut_payment_methods_with_http_info(payment_method_id, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTPaymentMethodResponseType, Fixnum, Hash)>] PUTPaymentMethodResponseType data, response status code and response headers
    def p_ut_payment_methods_with_http_info(payment_method_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.p_ut_payment_methods ..."
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.p_ut_payment_methods"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling PaymentMethodsApi.p_ut_payment_methods"
      end
      # resource path
      local_var_path = "/v1/payment-methods/credit-cards/{payment-method-id}".sub('{' + 'payment-method-id' + '}', payment_method_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTPaymentMethodResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#p_ut_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param payment_method_id The ID of the payment method to be verified. 
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [PUTVerifyPaymentMethodResponseType]
    def p_ut_verify_payment_methods(payment_method_id, body, opts = {})
      data, _status_code, _headers = p_ut_verify_payment_methods_with_http_info(payment_method_id, body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PUTVerifyPaymentMethodResponseType, Fixnum, Hash)>] PUTVerifyPaymentMethodResponseType data, response status code and response headers
    def p_ut_verify_payment_methods_with_http_info(payment_method_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentMethodsApi.p_ut_verify_payment_methods ..."
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.p_ut_verify_payment_methods"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentMethodsApi.p_ut_verify_payment_methods"
      end
      # resource path
      local_var_path = "/v1/payment-methods/{payment-method-id}/verify".sub('{' + 'payment-method-id' + '}', payment_method_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTVerifyPaymentMethodResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentMethodsApi#p_ut_verify_payment_methods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
