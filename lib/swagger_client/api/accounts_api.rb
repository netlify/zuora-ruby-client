  ...
  class AccountsApi
    ...
    def g_et_account_with_http_info(account_key, opts = {})
      ...
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.g_et_account"
      end
      # resource path
    ...
    def g_et_account_summary_with_http_info(account_key, opts = {})
      ...
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.g_et_account_summary"
      end
      # resource path
    ...
    def p_ost_account_with_http_info(request, opts = {})
      ...
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountsApi.p_ost_account"
      end
      # resource path
    ...
    def p_ost_generate_billing_documents(body, id, opts = {})
      data, _status_code, _headers = p_ost_generate_billing_documents_with_http_info(body, id, opts)
      return data
    end
    ...
    def p_ost_generate_billing_documents_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.p_ost_generate_billing_documents ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AccountsApi.p_ost_generate_billing_documents"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountsApi.p_ost_generate_billing_documents"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#p_ost_generate_billing_documents\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_account_with_http_info(account_key, request, opts = {})
      ...
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling AccountsApi.p_ut_account"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountsApi.p_ut_account"
      end
      # resource path
      local_var_path = "/v1/accounts/{account-key}".sub('{' + 'account-key' + '}', account_key.to_s)
