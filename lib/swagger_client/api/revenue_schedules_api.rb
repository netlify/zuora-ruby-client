  ...
  class RevenueSchedulesApi
    ...
    def d_eleters_with_http_info(rs_number, opts = {})
      ...
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.d_eleters"
      end
      # resource path
    ...
    def g_etr_sby_credit_memo_item(cmi_id, opts = {})
      data, _status_code, _headers = g_etr_sby_credit_memo_item_with_http_info(cmi_id, opts)
      return data
    end
    ...
    def g_etr_sby_credit_memo_item_with_http_info(cmi_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.g_etr_sby_credit_memo_item ..."
      end
      # verify the required parameter 'cmi_id' is set
      if @api_client.config.client_side_validation && cmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'cmi_id' when calling RevenueSchedulesApi.g_etr_sby_credit_memo_item"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#g_etr_sby_credit_memo_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GETRSDetailType]
    def g_etr_sby_debit_memo_item(dmi_id, opts = {})
      data, _status_code, _headers = g_etr_sby_debit_memo_item_with_http_info(dmi_id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETRSDetailType, Fixnum, Hash)>] GETRSDetailType data, response status code and response headers
    def g_etr_sby_debit_memo_item_with_http_info(dmi_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.g_etr_sby_debit_memo_item ..."
      end
      # verify the required parameter 'dmi_id' is set
      if @api_client.config.client_side_validation && dmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'dmi_id' when calling RevenueSchedulesApi.g_etr_sby_debit_memo_item"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRSDetailType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#g_etr_sby_debit_memo_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_etr_sby_invoice_item_with_http_info(invoice_item_id, opts = {})
      ...
      if @api_client.config.client_side_validation && invoice_item_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_id' when calling RevenueSchedulesApi.g_etr_sby_invoice_item"
      end
      # resource path
    ...
    def g_etr_sby_invoice_item_adjustment_with_http_info(invoice_item_adj_id, opts = {})
      ...
      if @api_client.config.client_side_validation && invoice_item_adj_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_adj_id' when calling RevenueSchedulesApi.g_etr_sby_invoice_item_adjustment"
      end
      # resource path
    ...
    def g_etr_sby_product_charge_and_billing_account(account_key, charge_key, opts = {})
      data, _status_code, _headers = g_etr_sby_product_charge_and_billing_account_with_http_info(account_key, charge_key, opts)
      return data
    end
    ...
    def g_etr_sby_product_charge_and_billing_account_with_http_info(account_key, charge_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.g_etr_sby_product_charge_and_billing_account ..."
      end
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling RevenueSchedulesApi.g_etr_sby_product_charge_and_billing_account"
      end
      # verify the required parameter 'charge_key' is set
      if @api_client.config.client_side_validation && charge_key.nil?
        fail ArgumentError, "Missing the required parameter 'charge_key' when calling RevenueSchedulesApi.g_etr_sby_product_charge_and_billing_account"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RevenueSchedulesApi.g_etr_sby_product_charge_and_billing_account, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#g_etr_sby_product_charge_and_billing_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_etr_sfor_subsc_charge(charge_key, opts = {})
      data, _status_code, _headers = g_etr_sfor_subsc_charge_with_http_info(charge_key, opts)
      return data
    end
    ...
    def g_etr_sfor_subsc_charge_with_http_info(charge_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.g_etr_sfor_subsc_charge ..."
      end
      # verify the required parameter 'charge_key' is set
      if @api_client.config.client_side_validation && charge_key.nil?
        fail ArgumentError, "Missing the required parameter 'charge_key' when calling RevenueSchedulesApi.g_etr_sfor_subsc_charge"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling RevenueSchedulesApi.g_etr_sfor_subsc_charge, must be smaller than or equal to 300.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#g_etr_sfor_subsc_charge\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETRSDetailType]
    def g_etrs(rs_number, opts = {})
      data, _status_code, _headers = g_etrs_with_http_info(rs_number, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETRSDetailType, Fixnum, Hash)>] GETRSDetailType data, response status code and response headers
    def g_etrs_with_http_info(rs_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.g_etrs ..."
      end
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.g_etrs"
      end
      # resource path
      local_var_path = "/v1/revenue-schedules/{rs-number}".sub('{' + 'rs-number' + '}', rs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRSDetailType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#g_etrs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ostr_sfor_credit_memo_item_distribute_by_date_range(cmi_id, body, opts = {})
      data, _status_code, _headers = p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(cmi_id, body, opts)
      return data
    end
    ...
    def p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(cmi_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_distribute_by_date_range ..."
      end
      # verify the required parameter 'cmi_id' is set
      if @api_client.config.client_side_validation && cmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'cmi_id' when calling RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_distribute_by_date_range"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_distribute_by_date_range"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#p_ostr_sfor_credit_memo_item_distribute_by_date_range\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [POSTRevenueScheduleByTransactionResponseType]
    def p_ostr_sfor_credit_memo_item_manual_distribution(cmi_id, body, opts = {})
      data, _status_code, _headers = p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(cmi_id, body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTRevenueScheduleByTransactionResponseType, Fixnum, Hash)>] POSTRevenueScheduleByTransactionResponseType data, response status code and response headers
    def p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(cmi_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_manual_distribution ..."
      end
      # verify the required parameter 'cmi_id' is set
      if @api_client.config.client_side_validation && cmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'cmi_id' when calling RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_manual_distribution"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RevenueSchedulesApi.p_ostr_sfor_credit_memo_item_manual_distribution"
      end
      # resource path
      local_var_path = "/v1/revenue-schedules/credit-memo-items/{cmi-id}".sub('{' + 'cmi-id' + '}', cmi_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTRevenueScheduleByTransactionResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#p_ostr_sfor_credit_memo_item_manual_distribution\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [POSTRevenueScheduleByTransactionResponseType]
    def p_ostr_sfor_debit_memo_item_distribute_by_date_range(dmi_id, body, opts = {})
      data, _status_code, _headers = p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(dmi_id, body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTRevenueScheduleByTransactionResponseType, Fixnum, Hash)>] POSTRevenueScheduleByTransactionResponseType data, response status code and response headers
    def p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(dmi_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_distribute_by_date_range ..."
      end
      # verify the required parameter 'dmi_id' is set
      if @api_client.config.client_side_validation && dmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'dmi_id' when calling RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_distribute_by_date_range"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_distribute_by_date_range"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTRevenueScheduleByTransactionResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#p_ostr_sfor_debit_memo_item_distribute_by_date_range\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [POSTRevenueScheduleByTransactionResponseType]
    def p_ostr_sfor_debit_memo_item_manual_distribution(dmi_id, body, opts = {})
      data, _status_code, _headers = p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(dmi_id, body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTRevenueScheduleByTransactionResponseType, Fixnum, Hash)>] POSTRevenueScheduleByTransactionResponseType data, response status code and response headers
    def p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(dmi_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_manual_distribution ..."
      end
      # verify the required parameter 'dmi_id' is set
      if @api_client.config.client_side_validation && dmi_id.nil?
        fail ArgumentError, "Missing the required parameter 'dmi_id' when calling RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_manual_distribution"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RevenueSchedulesApi.p_ostr_sfor_debit_memo_item_manual_distribution"
      end
      # resource path
      local_var_path = "/v1/revenue-schedules/debit-memo-items/{dmi-id}".sub('{' + 'dmi-id' + '}', dmi_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTRevenueScheduleByTransactionResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#p_ostr_sfor_debit_memo_item_manual_distribution\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(invoice_item_adj_key, request, opts = {})
      ...
      if @api_client.config.client_side_validation && invoice_item_adj_key.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_adj_key' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range"
      end
      # resource path
    ...
    def p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(invoice_item_adj_key, request, opts = {})
      ...
      # verify the required parameter 'invoice_item_adj_key' is set
      if @api_client.config.client_side_validation && invoice_item_adj_key.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_adj_key' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_adjustment_manual_distribution"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_adjustment_manual_distribution"
      end
      # resource path
    ...
    def p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(invoice_item_id, request, opts = {})
      ...
      # verify the required parameter 'invoice_item_id' is set
      if @api_client.config.client_side_validation && invoice_item_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_id' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_distribute_by_date_range"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_distribute_by_date_range"
      end
      # resource path
    ...
    def p_ostr_sfor_invoice_item_manual_distribution_with_http_info(invoice_item_id, request, opts = {})
      ...
      # verify the required parameter 'invoice_item_id' is set
      if @api_client.config.client_side_validation && invoice_item_id.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_item_id' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_manual_distribution"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ostr_sfor_invoice_item_manual_distribution"
      end
      # resource path
      local_var_path = "/v1/revenue-schedules/invoice-items/{invoice-item-id}".sub('{' + 'invoice-item-id' + '}', invoice_item_id.to_s)
    ...
    def p_ostr_sfor_subsc_charge(charge_key, request, opts = {})
      data, _status_code, _headers = p_ostr_sfor_subsc_charge_with_http_info(charge_key, request, opts)
      return data
    end
    ...
    def p_ostr_sfor_subsc_charge_with_http_info(charge_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueSchedulesApi.p_ostr_sfor_subsc_charge ..."
      end
      # verify the required parameter 'charge_key' is set
      if @api_client.config.client_side_validation && charge_key.nil?
        fail ArgumentError, "Missing the required parameter 'charge_key' when calling RevenueSchedulesApi.p_ostr_sfor_subsc_charge"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ostr_sfor_subsc_charge"
      end
      # resource path
      local_var_path = "/v1/revenue-schedules/subscription-charges/{charge-key}".sub('{' + 'charge-key' + '}', charge_key.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueSchedulesApi#p_ostr_sfor_subsc_charge\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_revenue_across_ap_with_http_info(rs_number, request, opts = {})
      ...
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.p_ut_revenue_across_ap"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ut_revenue_across_ap"
      end
      # resource path
    ...
    def p_ut_revenue_by_recognition_startand_end_dates_with_http_info(rs_number, request, opts = {})
      ...
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.p_ut_revenue_by_recognition_startand_end_dates"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ut_revenue_by_recognition_startand_end_dates"
      end
      # resource path
    ...
    def p_ut_revenue_specific_date_with_http_info(rs_number, request, opts = {})
      ...
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.p_ut_revenue_specific_date"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_ut_revenue_specific_date"
      end
      # resource path
    ...
    def p_utrs_basic_info_with_http_info(rs_number, request, opts = {})
      ...
      # verify the required parameter 'rs_number' is set
      if @api_client.config.client_side_validation && rs_number.nil?
        fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueSchedulesApi.p_utrs_basic_info"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling RevenueSchedulesApi.p_utrs_basic_info"
      end
      # resource path
