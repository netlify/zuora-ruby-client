...
module SwaggerClient
  class UsersApi
    ...
    def g_et_entities_user_accessible(username, opts = {})
      data, _status_code, _headers = g_et_entities_user_accessible_with_http_info(username, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETEntitiesUserAccessibleResponseType, Fixnum, Hash)>] GETEntitiesUserAccessibleResponseType data, response status code and response headers
    def g_et_entities_user_accessible_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.g_et_entities_user_accessible ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.g_et_entities_user_accessible"
      end
      # resource path
      local_var_path = "/v1/users/{username}/accessible-entities".sub('{' + 'username' + '}', username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETEntitiesUserAccessibleResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#g_et_entities_user_accessible\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def p_ut_accept_user_access(username, opts = {})
      data, _status_code, _headers = p_ut_accept_user_access_with_http_info(username, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTAcceptUserAccessResponseType, Fixnum, Hash)>] PUTAcceptUserAccessResponseType data, response status code and response headers
    def p_ut_accept_user_access_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.p_ut_accept_user_access ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.p_ut_accept_user_access"
      end
      # resource path
      local_var_path = "/v1/users/{username}/accept-access".sub('{' + 'username' + '}', username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTAcceptUserAccessResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#p_ut_accept_user_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_deny_user_access(username, opts = {})
      data, _status_code, _headers = p_ut_deny_user_access_with_http_info(username, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTDenyUserAccessResponseType, Fixnum, Hash)>] PUTDenyUserAccessResponseType data, response status code and response headers
    def p_ut_deny_user_access_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.p_ut_deny_user_access ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.p_ut_deny_user_access"
      end
      # resource path
      local_var_path = "/v1/users/{username}/deny-access".sub('{' + 'username' + '}', username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTDenyUserAccessResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#p_ut_deny_user_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_send_user_access_requests(username, request, opts = {})
      data, _status_code, _headers = p_ut_send_user_access_requests_with_http_info(username, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(PUTSendUserAccessRequestResponseType, Fixnum, Hash)>] PUTSendUserAccessRequestResponseType data, response status code and response headers
    def p_ut_send_user_access_requests_with_http_info(username, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsersApi.p_ut_send_user_access_requests ..."
      end
      # verify the required parameter 'username' is set
      if @api_client.config.client_side_validation && username.nil?
        fail ArgumentError, "Missing the required parameter 'username' when calling UsersApi.p_ut_send_user_access_requests"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling UsersApi.p_ut_send_user_access_requests"
      end
      # resource path
      local_var_path = "/v1/users/{username}/request-access".sub('{' + 'username' + '}', username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PUTSendUserAccessRequestResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#p_ut_send_user_access_requests\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
