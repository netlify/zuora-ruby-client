...
module SwaggerClient
  class SubscriptionsApi
    ...
    def g_et_subscriptions_by_account(account_key, opts = {})
      data, _status_code, _headers = g_et_subscriptions_by_account_with_http_info(account_key, opts)
      return data
    end
    ...
    def g_et_subscriptions_by_account_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.g_et_subscriptions_by_account ..."
      end
      # verify the required parameter 'account_key' is set
      if @api_client.config.client_side_validation && account_key.nil?
        fail ArgumentError, "Missing the required parameter 'account_key' when calling SubscriptionsApi.g_et_subscriptions_by_account"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SubscriptionsApi.g_et_subscriptions_by_account, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#g_et_subscriptions_by_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_subscriptions_by_key(subscription_key, opts = {})
      data, _status_code, _headers = g_et_subscriptions_by_key_with_http_info(subscription_key, opts)
      return data
    end
    ...
    def g_et_subscriptions_by_key_with_http_info(subscription_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.g_et_subscriptions_by_key ..."
      end
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.g_et_subscriptions_by_key"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#g_et_subscriptions_by_key\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :charge_detail  The segmented rate plan charges. When an amendment results in a change to a charge, Zuora creates a segmented rate plan charge. Use this field to track segment charges.  Possible values are:   * __last-segment__: (Default) The last rate plan charge on the subscription. The last rate plan charge is the last one in the order of time on the subscription rather than the most recent changed charge on the subscription.  * __current-segment__: The segmented charge that is active on today’s date (effectiveStartDate &lt;&#x3D; today’s date &lt; effectiveEndDate).    * __all-segments__: All the segmented charges. The &#x60;chargeSegments&#x60; field is returned in the response. The &#x60;chargeSegments&#x60; field contains an array of the charge information for all the charge segments.   * __specific-segment&amp;as-of-date&#x3D;date__: The segmented charge that is active on a date you specified (effectiveStartDate &lt;&#x3D; specific date &lt; effectiveEndDate). The format of the date is yyyy-mm-dd. 
    # @return [GETSubscriptionTypeWithSuccess]
    def g_et_subscriptions_by_key_and_version(subscription_key, version, opts = {})
      data, _status_code, _headers = g_et_subscriptions_by_key_and_version_with_http_info(subscription_key, version, opts)
      return data
    end
    ...
    # @option opts [String] :charge_detail  The segmented rate plan charges. When an amendment results in a change to a charge, Zuora creates a segmented rate plan charge. Use this field to track segment charges.  Possible values are:   * __last-segment__: (Default) The last rate plan charge on the subscription. The last rate plan charge is the last one in the order of time on the subscription rather than the most recent changed charge on the subscription.  * __current-segment__: The segmented charge that is active on today’s date (effectiveStartDate &lt;&#x3D; today’s date &lt; effectiveEndDate).    * __all-segments__: All the segmented charges. The &#x60;chargeSegments&#x60; field is returned in the response. The &#x60;chargeSegments&#x60; field contains an array of the charge information for all the charge segments.   * __specific-segment&amp;as-of-date&#x3D;date__: The segmented charge that is active on a date you specified (effectiveStartDate &lt;&#x3D; specific date &lt; effectiveEndDate). The format of the date is yyyy-mm-dd. 
    # @return [Array<(GETSubscriptionTypeWithSuccess, Fixnum, Hash)>] GETSubscriptionTypeWithSuccess data, response status code and response headers
    def g_et_subscriptions_by_key_and_version_with_http_info(subscription_key, version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.g_et_subscriptions_by_key_and_version ..."
      end
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.g_et_subscriptions_by_key_and_version"
      end
      # verify the required parameter 'version' is set
      if @api_client.config.client_side_validation && version.nil?
        fail ArgumentError, "Missing the required parameter 'version' when calling SubscriptionsApi.g_et_subscriptions_by_key_and_version"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETSubscriptionTypeWithSuccess')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#g_et_subscriptions_by_key_and_version\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_preview_subscription(request, opts = {})
      data, _status_code, _headers = p_ost_preview_subscription_with_http_info(request, opts)
      return data
    end
    ...
    def p_ost_preview_subscription_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.p_ost_preview_subscription ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ost_preview_subscription"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#p_ost_preview_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_subscription_with_http_info(request, opts = {})
      ...
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ost_subscription"
      end
      # resource path
    ...
    def p_ut_cancel_subscription(subscription_key, request, opts = {})
      data, _status_code, _headers = p_ut_cancel_subscription_with_http_info(subscription_key, request, opts)
      return data
    end
    ...
    def p_ut_cancel_subscription_with_http_info(subscription_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.p_ut_cancel_subscription ..."
      end
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.p_ut_cancel_subscription"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ut_cancel_subscription"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#p_ut_cancel_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_renew_subscription_with_http_info(subscription_key, request, opts = {})
      ...
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.p_ut_renew_subscription"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ut_renew_subscription"
      end
      # resource path
    ...
    def p_ut_resume_subscription(subscription_key, request, opts = {})
      data, _status_code, _headers = p_ut_resume_subscription_with_http_info(subscription_key, request, opts)
      return data
    end
    ...
    def p_ut_resume_subscription_with_http_info(subscription_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.p_ut_resume_subscription ..."
      end
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.p_ut_resume_subscription"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ut_resume_subscription"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#p_ut_resume_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_subscription_with_http_info(subscription_key, request, opts = {})
      ...
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.p_ut_subscription"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ut_subscription"
      end
      # resource path
      local_var_path = "/v1/subscriptions/{subscription-key}".sub('{' + 'subscription-key' + '}', subscription_key.to_s)
    ...
    def p_ut_suspend_subscription(subscription_key, request, opts = {})
      data, _status_code, _headers = p_ut_suspend_subscription_with_http_info(subscription_key, request, opts)
      return data
    end
    ...
    def p_ut_suspend_subscription_with_http_info(subscription_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.p_ut_suspend_subscription ..."
      end
      # verify the required parameter 'subscription_key' is set
      if @api_client.config.client_side_validation && subscription_key.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_key' when calling SubscriptionsApi.p_ut_suspend_subscription"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling SubscriptionsApi.p_ut_suspend_subscription"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#p_ut_suspend_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ut_update_subscription_custom_fields(subscription_number, body, opts = {})
      data, _status_code, _headers = p_ut_update_subscription_custom_fields_with_http_info(subscription_number, body, opts)
      return data
    end
    ...
    def p_ut_update_subscription_custom_fields_with_http_info(subscription_number, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionsApi.p_ut_update_subscription_custom_fields ..."
      end
      ...
      if @api_client.config.client_side_validation && subscription_number.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_number' when calling SubscriptionsApi.p_ut_update_subscription_custom_fields"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SubscriptionsApi.p_ut_update_subscription_custom_fields"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionsApi#p_ut_update_subscription_custom_fields\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
