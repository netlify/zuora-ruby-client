...
module SwaggerClient
  class AttachmentsApi
    ...
    def d_elete_attachments(attachment_id, opts = {})
      data, _status_code, _headers = d_elete_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    def d_elete_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.d_elete_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.d_elete_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments/{attachment-id}".sub('{' + 'attachment-id' + '}', attachment_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#d_elete_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param attachment_id Id of the attachment you want to view.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETAttachmentResponseType]
    def g_et_attachments(attachment_id, opts = {})
      data, _status_code, _headers = g_et_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAttachmentResponseType, Fixnum, Hash)>] GETAttachmentResponseType data, response status code and response headers
    def g_et_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.g_et_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.g_et_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments/{attachment-id}".sub('{' + 'attachment-id' + '}', attachment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAttachmentResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#g_et_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param object_type The type of object to list attachements for. 
    # @param object_key ID of the object to list attachements for.  - If &#x60;object-type&#x60; is &#x60;account&#x60;, specify an account ID.  - If &#x60;object-type&#x60; is &#x60;invoice&#x60;, specify an invoice ID.  - If &#x60;object-type&#x60; is &#x60;subscription&#x60;, specify a subscription number. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [Integer] :page_size Number of rows returned per page.  (default to 20)
    # @return [GETAttachmentsResponseType]
    def g_et_attachments_list(object_type, object_key, opts = {})
      data, _status_code, _headers = g_et_attachments_list_with_http_info(object_type, object_key, opts)
      return data
    end
    ...
    # @return [Array<(GETAttachmentsResponseType, Fixnum, Hash)>] GETAttachmentsResponseType data, response status code and response headers
    def g_et_attachments_list_with_http_info(object_type, object_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.g_et_attachments_list ..."
      end
      # verify the required parameter 'object_type' is set
      if @api_client.config.client_side_validation && object_type.nil?
        fail ArgumentError, "Missing the required parameter 'object_type' when calling AttachmentsApi.g_et_attachments_list"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['account', 'invoice', 'subscription'].include?(object_type)
        fail ArgumentError, "invalid value for 'object_type', must be one of account, invoice, subscription"
      end
      # verify the required parameter 'object_key' is set
      if @api_client.config.client_side_validation && object_key.nil?
        fail ArgumentError, "Missing the required parameter 'object_key' when calling AttachmentsApi.g_et_attachments_list"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AttachmentsApi.g_et_attachments_list, must be smaller than or equal to 40.'
      end

      # resource path
      local_var_path = "/v1/attachments/{object-type}/{object-key}".sub('{' + 'object-type' + '}', object_type.to_s).sub('{' + 'object-key' + '}', object_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAttachmentsResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#g_et_attachments_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param associated_object_type Specify one of the following values: Account, Subscription, or Invoice. 
    # @param associated_object_key For the Subscription type, specify the Subscription Number. An attachment is tied to the Subscription Number and thus viewable with every subscription version.  For Account and Invoice, specify the id. 
    # @param request 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :description Description of the attachment document. 
    # @return [POSTAttachmentResponseType]
    def p_ost_attachments(associated_object_type, associated_object_key, request, opts = {})
      data, _status_code, _headers = p_ost_attachments_with_http_info(associated_object_type, associated_object_key, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :description Description of the attachment document. 
    # @return [Array<(POSTAttachmentResponseType, Fixnum, Hash)>] POSTAttachmentResponseType data, response status code and response headers
    def p_ost_attachments_with_http_info(associated_object_type, associated_object_key, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.p_ost_attachments ..."
      end
      ...
      if @api_client.config.client_side_validation && associated_object_type.nil?
        fail ArgumentError, "Missing the required parameter 'associated_object_type' when calling AttachmentsApi.p_ost_attachments"
      end
      # verify the required parameter 'associated_object_key' is set
      if @api_client.config.client_side_validation && associated_object_key.nil?
        fail ArgumentError, "Missing the required parameter 'associated_object_key' when calling AttachmentsApi.p_ost_attachments"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AttachmentsApi.p_ost_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments"

      # query parameters
      query_params = {}
      query_params[:'associatedObjectType'] = associated_object_type
      query_params[:'associatedObjectKey'] = associated_object_key
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTAttachmentResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#p_ost_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [PUTAttachmentType] :request 
    # @return [CommonResponseType]
    def p_ut_attachments(attachment_id, opts = {})
      data, _status_code, _headers = p_ut_attachments_with_http_info(attachment_id, opts)
      return data
    end
    ...
    # @option opts [PUTAttachmentType] :request 
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_attachments_with_http_info(attachment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AttachmentsApi.p_ut_attachments ..."
      end
      # verify the required parameter 'attachment_id' is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        fail ArgumentError, "Missing the required parameter 'attachment_id' when calling AttachmentsApi.p_ut_attachments"
      end
      # resource path
      local_var_path = "/v1/attachments/{attachment-id}".sub('{' + 'attachment-id' + '}', attachment_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AttachmentsApi#p_ut_attachments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
