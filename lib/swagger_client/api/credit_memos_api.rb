...
module SwaggerClient
  class CreditMemosApi
    ...
    def d_elete_credit_memo(credit_memo_id, opts = {})
      data, _status_code, _headers = d_elete_credit_memo_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    def d_elete_credit_memo_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.d_elete_credit_memo ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.d_elete_credit_memo"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#d_elete_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_breakdown_credit_memo_by_order(credit_memo_number, opts = {})
      data, _status_code, _headers = g_et_breakdown_credit_memo_by_order_with_http_info(credit_memo_number, opts)
      return data
    end
    ...
    def g_et_breakdown_credit_memo_by_order_with_http_info(credit_memo_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_breakdown_credit_memo_by_order ..."
      end
      ...
      if @api_client.config.client_side_validation && credit_memo_number.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_number' when calling CreditMemosApi.g_et_breakdown_credit_memo_by_order"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_breakdown_credit_memo_by_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo(credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo"
      end
      # resource path
      local_var_path = "/v1/creditmemos/{creditMemoId}".sub('{' + 'creditMemoId' + '}', credit_memo_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_item(cmitemid, credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_item_with_http_info(cmitemid, credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_item_with_http_info(cmitemid, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_item ..."
      end
      # verify the required parameter 'cmitemid' is set
      if @api_client.config.client_side_validation && cmitemid.nil?
        fail ArgumentError, "Missing the required parameter 'cmitemid' when calling CreditMemosApi.g_et_credit_memo_item"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_item"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_item_part(partid, itempartid, credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_item_part_with_http_info(partid, itempartid, credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_item_part_with_http_info(partid, itempartid, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_item_part ..."
      end
      # verify the required parameter 'partid' is set
      if @api_client.config.client_side_validation && partid.nil?
        fail ArgumentError, "Missing the required parameter 'partid' when calling CreditMemosApi.g_et_credit_memo_item_part"
      end
      # verify the required parameter 'itempartid' is set
      if @api_client.config.client_side_validation && itempartid.nil?
        fail ArgumentError, "Missing the required parameter 'itempartid' when calling CreditMemosApi.g_et_credit_memo_item_part"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_item_part"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_item_part\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_item_parts(partid, credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_item_parts_with_http_info(partid, credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_item_parts_with_http_info(partid, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_item_parts ..."
      end
      # verify the required parameter 'partid' is set
      if @api_client.config.client_side_validation && partid.nil?
        fail ArgumentError, "Missing the required parameter 'partid' when calling CreditMemosApi.g_et_credit_memo_item_parts"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_item_parts"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CreditMemosApi.g_et_credit_memo_item_parts, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_item_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_items(credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_items_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_items_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_items ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_items"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CreditMemosApi.g_et_credit_memo_items, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_part(partid, credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_part_with_http_info(partid, credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_part_with_http_info(partid, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_part ..."
      end
      # verify the required parameter 'partid' is set
      if @api_client.config.client_side_validation && partid.nil?
        fail ArgumentError, "Missing the required parameter 'partid' when calling CreditMemosApi.g_et_credit_memo_part"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_part"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_part\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memo_parts(credit_memo_id, opts = {})
      data, _status_code, _headers = g_et_credit_memo_parts_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    def g_et_credit_memo_parts_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memo_parts ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.g_et_credit_memo_parts"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CreditMemosApi.g_et_credit_memo_parts, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memo_parts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_credit_memos(opts = {})
      data, _status_code, _headers = g_et_credit_memos_with_http_info(opts)
      return data
    end
    ...
    def g_et_credit_memos_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.g_et_credit_memos ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 40
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CreditMemosApi.g_et_credit_memos, must be smaller than or equal to 40.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#g_et_credit_memos\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ost_credit_memo_from_prpc(body, opts = {})
      data, _status_code, _headers = p_ost_credit_memo_from_prpc_with_http_info(body, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ost_credit_memo_from_prpc_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ost_credit_memo_from_prpc ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ost_credit_memo_from_prpc"
      end
      # resource path
      local_var_path = "/v1/creditmemos"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ost_credit_memo_from_prpc\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_credit_memo_pdf(credit_memo_id, opts = {})
      data, _status_code, _headers = p_ost_credit_memo_pdf_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    def p_ost_credit_memo_pdf_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ost_credit_memo_pdf ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ost_credit_memo_pdf"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ost_credit_memo_pdf\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ost_email_credit_memo(request, credit_memo_id, opts = {})
      data, _status_code, _headers = p_ost_email_credit_memo_with_http_info(request, credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ost_email_credit_memo_with_http_info(request, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ost_email_credit_memo ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling CreditMemosApi.p_ost_email_credit_memo"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ost_email_credit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ost_email_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_refund_credit_memo(body, creditmemo_id, opts = {})
      data, _status_code, _headers = p_ost_refund_credit_memo_with_http_info(body, creditmemo_id, opts)
      return data
    end
    ...
    def p_ost_refund_credit_memo_with_http_info(body, creditmemo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ost_refund_credit_memo ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ost_refund_credit_memo"
      end
      # verify the required parameter 'creditmemo_id' is set
      if @api_client.config.client_side_validation && creditmemo_id.nil?
        fail ArgumentError, "Missing the required parameter 'creditmemo_id' when calling CreditMemosApi.p_ost_refund_credit_memo"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ost_refund_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ostcm_taxation_items(credit_memo_id, body, opts = {})
      data, _status_code, _headers = p_ostcm_taxation_items_with_http_info(credit_memo_id, body, opts)
      return data
    end
    ...
    def p_ostcm_taxation_items_with_http_info(credit_memo_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ostcm_taxation_items ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ostcm_taxation_items"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ostcm_taxation_items"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ostcm_taxation_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ut_apply_credit_memo(body, credit_memo_id, opts = {})
      data, _status_code, _headers = p_ut_apply_credit_memo_with_http_info(body, credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ut_apply_credit_memo_with_http_info(body, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ut_apply_credit_memo ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ut_apply_credit_memo"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ut_apply_credit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ut_apply_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ut_cancel_credit_memo(credit_memo_id, opts = {})
      data, _status_code, _headers = p_ut_cancel_credit_memo_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ut_cancel_credit_memo_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ut_cancel_credit_memo ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ut_cancel_credit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ut_cancel_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ut_post_credit_memo(credit_memo_id, opts = {})
      data, _status_code, _headers = p_ut_post_credit_memo_with_http_info(credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ut_post_credit_memo_with_http_info(credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ut_post_credit_memo ..."
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ut_post_credit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ut_post_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ut_unapply_credit_memo(body, credit_memo_id, opts = {})
      data, _status_code, _headers = p_ut_unapply_credit_memo_with_http_info(body, credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ut_unapply_credit_memo_with_http_info(body, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ut_unapply_credit_memo ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ut_unapply_credit_memo"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ut_unapply_credit_memo"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ut_unapply_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETCreditMemoType]
    def p_ut_update_credit_memo(body, credit_memo_id, opts = {})
      data, _status_code, _headers = p_ut_update_credit_memo_with_http_info(body, credit_memo_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETCreditMemoType, Fixnum, Hash)>] GETCreditMemoType data, response status code and response headers
    def p_ut_update_credit_memo_with_http_info(body, credit_memo_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreditMemosApi.p_ut_update_credit_memo ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CreditMemosApi.p_ut_update_credit_memo"
      end
      # verify the required parameter 'credit_memo_id' is set
      if @api_client.config.client_side_validation && credit_memo_id.nil?
        fail ArgumentError, "Missing the required parameter 'credit_memo_id' when calling CreditMemosApi.p_ut_update_credit_memo"
      end
      # resource path
      local_var_path = "/v1/creditmemos/{creditMemoId}".sub('{' + 'creditMemoId' + '}', credit_memo_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GETCreditMemoType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreditMemosApi#p_ut_update_credit_memo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
