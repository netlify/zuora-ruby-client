...
module SwaggerClient
  class InvoicesApi
    ...
    # @param invoice_number Number of invoice to be broken down.
    ...
    def g_et_breakdown_invoice_by_order(invoice_number, opts = {})
      data, _status_code, _headers = g_et_breakdown_invoice_by_order_with_http_info(invoice_number, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GetInvoiceAmountBreakdownByOrderResponse, Fixnum, Hash)>] GetInvoiceAmountBreakdownByOrderResponse data, response status code and response headers
    def g_et_breakdown_invoice_by_order_with_http_info(invoice_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.g_et_breakdown_invoice_by_order ..."
      end
      # verify the required parameter 'invoice_number' is set
      if @api_client.config.client_side_validation && invoice_number.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_number' when calling InvoicesApi.g_et_breakdown_invoice_by_order"
      end
      # resource path
      local_var_path = "/v1/invoices/{invoiceNumber}/amountBreakdownByOrder".sub('{' + 'invoiceNumber' + '}', invoice_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GetInvoiceAmountBreakdownByOrderResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#g_et_breakdown_invoice_by_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
