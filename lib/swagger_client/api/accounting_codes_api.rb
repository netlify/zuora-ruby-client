...
module SwaggerClient
  class AccountingCodesApi
    ...
    # @param ac_id ID of the accounting code you want to delete.
    ...
    def d_elete_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = d_elete_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    def d_elete_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.d_elete_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.d_elete_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#d_elete_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param ac_id ID of the accounting code you want to query.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [GETAccountingCodeItemType]
    def g_et_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = g_et_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(GETAccountingCodeItemType, Fixnum, Hash)>] GETAccountingCodeItemType data, response status code and response headers
    def g_et_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.g_et_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.g_et_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAccountingCodeItemType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#g_et_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def g_et_all_accounting_codes(opts = {})
      data, _status_code, _headers = g_et_all_accounting_codes_with_http_info(opts)
      return data
    end
    ...
    # @return [Array<(GETAccountingCodesType, Fixnum, Hash)>] GETAccountingCodesType data, response status code and response headers
    def g_et_all_accounting_codes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.g_et_all_accounting_codes ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 300
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling AccountingCodesApi.g_et_all_accounting_codes, must be smaller than or equal to 300.'
      end

      # resource path
      local_var_path = "/v1/accounting-codes"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETAccountingCodesType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#g_et_all_accounting_codes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_accounting_code(request, opts = {})
      data, _status_code, _headers = p_ost_accounting_code_with_http_info(request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(POSTAccountingCodeResponseType, Fixnum, Hash)>] POSTAccountingCodeResponseType data, response status code and response headers
    def p_ost_accounting_code_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.p_ost_accounting_code ..."
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingCodesApi.p_ost_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTAccountingCodeResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#p_ost_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ac_id ID of the accounting code you want to update.
    # @param request 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_accounting_code(ac_id, request, opts = {})
      data, _status_code, _headers = p_ut_accounting_code_with_http_info(ac_id, request, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_accounting_code_with_http_info(ac_id, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.p_ut_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.p_ut_accounting_code"
      end
      # verify the required parameter 'request' is set
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling AccountingCodesApi.p_ut_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#p_ut_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ac_id ID of the accounting code you want to activate.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_activate_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = p_ut_activate_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_activate_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.p_ut_activate_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.p_ut_activate_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}/activate".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#p_ut_activate_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ac_id ID of the accounting code you want to deactivate.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :entity_id The Id of the entity that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [CommonResponseType]
    def p_ut_deactivate_accounting_code(ac_id, opts = {})
      data, _status_code, _headers = p_ut_deactivate_accounting_code_with_http_info(ac_id, opts)
      return data
    end
    ...
    # @option opts [String] :entity_name The [name of the entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity/B_Introduction_to_Entity_and_Entity_Hierarchy#Name_and_Display_Name) that you want to access. Note that you must have permission to access the entity. For more information, see [REST Authentication](https://www.zuora.com/developer/api-reference/#section/Authentication/Entity-Id-and-Entity-Name).
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_deactivate_accounting_code_with_http_info(ac_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountingCodesApi.p_ut_deactivate_accounting_code ..."
      end
      # verify the required parameter 'ac_id' is set
      if @api_client.config.client_side_validation && ac_id.nil?
        fail ArgumentError, "Missing the required parameter 'ac_id' when calling AccountingCodesApi.p_ut_deactivate_accounting_code"
      end
      # resource path
      local_var_path = "/v1/accounting-codes/{ac-id}/deactivate".sub('{' + 'ac-id' + '}', ac_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingCodesApi#p_ut_deactivate_accounting_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
