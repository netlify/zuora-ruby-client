...
module SwaggerClient
  ...
  class AmendmentRatePlanChargeData
    attr_accessor :rate_plan_charge

    # 
    attr_accessor :rate_plan_charge_tier
    ...
    def self.swagger_types
      {
        ...
        :'rate_plan_charge_tier' => :'Array<AmendmentRatePlanChargeTier>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RatePlanCharge')
        self.rate_plan_charge = attributes[:'RatePlanCharge']
      end

      if attributes.has_key?(:'RatePlanChargeTier')
        if (value = attributes[:'RatePlanChargeTier']).is_a?(Array)
          self.rate_plan_charge_tier = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @rate_plan_charge.nil?
        invalid_properties.push("invalid value for 'rate_plan_charge', rate_plan_charge cannot be nil.")
      end
    ...
    def valid?
      return false if @rate_plan_charge.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rate_plan_charge == o.rate_plan_charge &&
          rate_plan_charge_tier == o.rate_plan_charge_tier
    end
    ...
    def hash
      [rate_plan_charge, rate_plan_charge_tier].hash
    end
