...
module SwaggerClient
  ...
  class UnapplyPaymentType
    ...
    def self.swagger_types
      {
        :'debit_memos' => :'Array<PaymentDebitMemoApplicationUnapplyRequestType>',
        :'effective_date' => :'Date',
        :'invoices' => :'Array<PaymentInvoiceApplicationUnapplyRequestType>'
      }
    end
    ...
    def hash
      [debit_memos, effective_date, invoices].hash
    end
