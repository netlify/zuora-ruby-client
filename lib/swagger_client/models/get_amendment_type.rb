...
module SwaggerClient
  ...
  class GETAmendmentType
    ...
    attr_accessor :new_rate_plan_id

    # The ID of the subscription that the amendment changes. 
    attr_accessor :new_subscription_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'baseRatePlanId')
        self.base_rate_plan_id = attributes[:'baseRatePlanId']
      end

      if attributes.has_key?(:'baseSubscriptionId')
        self.base_subscription_id = attributes[:'baseSubscriptionId']
      end
      ...
      if attributes.has_key?(:'newRatePlanId')
        self.new_rate_plan_id = attributes[:'newRatePlanId']
      end

      if attributes.has_key?(:'newSubscriptionId')
        self.new_subscription_id = attributes[:'newSubscriptionId']
      end
      ...
      if attributes.has_key?(:'suspendDate')
        self.suspend_date = attributes[:'suspendDate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          base_rate_plan_id == o.base_rate_plan_id &&
          base_subscription_id == o.base_subscription_id &&
          code == o.code &&
          ...
          id == o.id &&
          name == o.name &&
          new_rate_plan_id == o.new_rate_plan_id &&
          new_subscription_id == o.new_subscription_id &&
    ...
    def hash
      [auto_renew, base_rate_plan_id, base_subscription_id, code, contract_effective_date, current_term, current_term_period_type, customer_acceptance_date, description, destination_account_id, destination_invoice_owner_id, effective_date, id, name, new_rate_plan_id, new_subscription_id, renewal_setting, renewal_term, renewal_term_period_type, resume_date, service_activation_date, specific_update_date, status, success, suspend_date, term_start_date, term_type, type].hash
    end
