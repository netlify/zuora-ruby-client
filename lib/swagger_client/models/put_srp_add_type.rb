...
module SwaggerClient
  ...
  class PUTSrpAddType
    ...
    def self.swagger_types
      {
        :'charge_overrides' => :'Array<PUTScAddType>',
    ...
    def hash
      [charge_overrides, contract_effective_date, custom_field__c, customer_acceptance_date, product_rate_plan_id, service_activation_date].hash
    end
