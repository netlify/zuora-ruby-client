...
module SwaggerClient
  ...
  class POSTPaymentMethodType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cardHolderInfo')
        self.card_holder_info = attributes[:'cardHolderInfo']
      end
    ...
    def list_invalid_properties
      ...
      if @credit_card_number.nil?
        invalid_properties.push("invalid value for 'credit_card_number', credit_card_number cannot be nil.")
      end

      if @credit_card_type.nil?
        invalid_properties.push("invalid value for 'credit_card_type', credit_card_type cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @credit_card_number.nil?
      return false if @credit_card_type.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          card_holder_info == o.card_holder_info &&
    ...
    def hash
      [account_key, card_holder_info, credit_card_number, credit_card_type, default_payment_method, expiration_month, expiration_year, num_consecutive_failures, security_code].hash
    end
