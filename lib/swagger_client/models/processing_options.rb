...
module SwaggerClient
  ...
  class ProcessingOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'collectPayment')
        self.collect_payment = attributes[:'collectPayment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          collect_payment == o.collect_payment &&
    ...
    def hash
      [billing_options, collect_payment, run_billing].hash
    end
