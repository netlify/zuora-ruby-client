...
module SwaggerClient
  ...
  class GETRSDetailsByProductChargeType
    ...
    attr_accessor :revenue_schedules
    ...
    def self.swagger_types
      {
        :'next_page' => :'String',
        :'revenue_schedules' => :'Array<GETRSDetailForProductChargeType>',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'revenueSchedules')
        if (value = attributes[:'revenueSchedules']).is_a?(Array)
          self.revenue_schedules = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          revenue_schedules == o.revenue_schedules &&
          success == o.success
    end
    ...
    def hash
      [next_page, revenue_schedules, success].hash
    end
