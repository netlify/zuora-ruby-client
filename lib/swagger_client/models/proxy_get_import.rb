...
module SwaggerClient
  ...
  class ProxyGetImport
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ImportType')
        self.import_type = attributes[:'ImportType']
      end
      ...
      if attributes.has_key?(:'OriginalResourceUrl')
        self.original_resource_url = attributes[:'OriginalResourceUrl']
      end

      if attributes.has_key?(:'ResultResourceUrl')
        self.result_resource_url = attributes[:'ResultResourceUrl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          md5 == o.md5 &&
          name == o.name &&
          original_resource_url == o.original_resource_url &&
          result_resource_url == o.result_resource_url &&
          status == o.status &&
    ...
    def hash
      [created_by_id, created_date, id, import_type, imported_count, md5, name, original_resource_url, result_resource_url, status, status_reason, total_count, updated_by_id, updated_date].hash
    end
