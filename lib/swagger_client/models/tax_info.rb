...
module SwaggerClient
  # The taxation permission is required to specify tax info.
  class TaxInfo
    attr_accessor :vat_id

    attr_accessor :company_code

    attr_accessor :exempt_certificate_id

    attr_accessor :exempt_certificate_type

    attr_accessor :exempt_description

    attr_accessor :exempt_effective_date

    attr_accessor :exempt_expiration_date

    attr_accessor :exempt_issuing_jurisdiction

    # Possible values are 'No', 'Yes', or 'PendingVerification'. 
    attr_accessor :exempt_status
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'exemptCertificateId')
        self.exempt_certificate_id = attributes[:'exemptCertificateId']
      end

      if attributes.has_key?(:'exemptCertificateType')
        self.exempt_certificate_type = attributes[:'exemptCertificateType']
      end

      if attributes.has_key?(:'exemptDescription')
        self.exempt_description = attributes[:'exemptDescription']
      end

      if attributes.has_key?(:'exemptEffectiveDate')
        self.exempt_effective_date = attributes[:'exemptEffectiveDate']
      end

      if attributes.has_key?(:'exemptExpirationDate')
        self.exempt_expiration_date = attributes[:'exemptExpirationDate']
      end

      if attributes.has_key?(:'exemptIssuingJurisdiction')
        self.exempt_issuing_jurisdiction = attributes[:'exemptIssuingJurisdiction']
      end

      if attributes.has_key?(:'exemptStatus')
        self.exempt_status = attributes[:'exemptStatus']
      else
        self.exempt_status = "No"
      end
    ...
    def list_invalid_properties
      ...
      if !@vat_id.nil? && @vat_id.to_s.length > 25
        invalid_properties.push("invalid value for 'vat_id', the character length must be smaller than or equal to 25.")
      end
      ...
      if !@exempt_certificate_id.nil? && @exempt_certificate_id.to_s.length > 32
        invalid_properties.push("invalid value for 'exempt_certificate_id', the character length must be smaller than or equal to 32.")
      end

      if !@exempt_certificate_type.nil? && @exempt_certificate_type.to_s.length > 32
        invalid_properties.push("invalid value for 'exempt_certificate_type', the character length must be smaller than or equal to 32.")
      end

      if !@exempt_description.nil? && @exempt_description.to_s.length > 500
        invalid_properties.push("invalid value for 'exempt_description', the character length must be smaller than or equal to 500.")
      end

      if !@exempt_issuing_jurisdiction.nil? && @exempt_issuing_jurisdiction.to_s.length > 32
        invalid_properties.push("invalid value for 'exempt_issuing_jurisdiction', the character length must be smaller than or equal to 32.")
      end
    ...
    def valid?
      return false if !@vat_id.nil? && @vat_id.to_s.length > 25
      return false if !@company_code.nil? && @company_code.to_s.length > 50
      return false if !@exempt_certificate_id.nil? && @exempt_certificate_id.to_s.length > 32
      return false if !@exempt_certificate_type.nil? && @exempt_certificate_type.to_s.length > 32
      return false if !@exempt_description.nil? && @exempt_description.to_s.length > 500
      return false if !@exempt_issuing_jurisdiction.nil? && @exempt_issuing_jurisdiction.to_s.length > 32
      exempt_status_validator = EnumAttributeValidator.new('String', ["No", "Yes", "PendingVerification"])
      return false unless exempt_status_validator.valid?(@exempt_status)
      return true
    end
    ...
    def vat_id=(vat_id)
      ...
      if !vat_id.nil? && vat_id.to_s.length > 25
        fail ArgumentError, "invalid value for 'vat_id', the character length must be smaller than or equal to 25."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] exempt_certificate_id Value to be assigned
    def exempt_certificate_id=(exempt_certificate_id)

      if !exempt_certificate_id.nil? && exempt_certificate_id.to_s.length > 32
        fail ArgumentError, "invalid value for 'exempt_certificate_id', the character length must be smaller than or equal to 32."
      end

      @exempt_certificate_id = exempt_certificate_id
    end

    # Custom attribute writer method with validation
    # @param [Object] exempt_certificate_type Value to be assigned
    def exempt_certificate_type=(exempt_certificate_type)

      if !exempt_certificate_type.nil? && exempt_certificate_type.to_s.length > 32
        fail ArgumentError, "invalid value for 'exempt_certificate_type', the character length must be smaller than or equal to 32."
      end

      @exempt_certificate_type = exempt_certificate_type
    end

    # Custom attribute writer method with validation
    # @param [Object] exempt_description Value to be assigned
    def exempt_description=(exempt_description)

      if !exempt_description.nil? && exempt_description.to_s.length > 500
        fail ArgumentError, "invalid value for 'exempt_description', the character length must be smaller than or equal to 500."
      end

      @exempt_description = exempt_description
    end

    # Custom attribute writer method with validation
    # @param [Object] exempt_issuing_jurisdiction Value to be assigned
    def exempt_issuing_jurisdiction=(exempt_issuing_jurisdiction)

      if !exempt_issuing_jurisdiction.nil? && exempt_issuing_jurisdiction.to_s.length > 32
        fail ArgumentError, "invalid value for 'exempt_issuing_jurisdiction', the character length must be smaller than or equal to 32."
      end

      @exempt_issuing_jurisdiction = exempt_issuing_jurisdiction
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] exempt_status Object to be assigned
    def exempt_status=(exempt_status)
      validator = EnumAttributeValidator.new('String', ["No", "Yes", "PendingVerification"])
      unless validator.valid?(exempt_status)
        fail ArgumentError, "invalid value for 'exempt_status', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exempt_certificate_id == o.exempt_certificate_id &&
          exempt_certificate_type == o.exempt_certificate_type &&
          exempt_description == o.exempt_description &&
          exempt_effective_date == o.exempt_effective_date &&
          exempt_expiration_date == o.exempt_expiration_date &&
          exempt_issuing_jurisdiction == o.exempt_issuing_jurisdiction &&
          exempt_status == o.exempt_status
    end
    ...
    def hash
      [vat_id, company_code, exempt_certificate_id, exempt_certificate_type, exempt_description, exempt_effective_date, exempt_expiration_date, exempt_issuing_jurisdiction, exempt_status].hash
    end
