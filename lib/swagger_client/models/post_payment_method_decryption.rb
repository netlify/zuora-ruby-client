...
module SwaggerClient
  ...
  class POSTPaymentMethodDecryption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentToken')
        self.payment_token = attributes[:'paymentToken']
      end
    ...
    def hash
      [account_id, card_holder_info, integration_type, invoice_id, merchant_id, payment_gateway, payment_token, process_payment].hash
    end
