...
module SwaggerClient
  ...
  class CreditMemoItemBreakdown
    attr_accessor :amount

    # Available only when the credit memo item represents a discount invoice item.
    attr_accessor :apply_to_charge_number

    attr_accessor :breakdown_details

    attr_accessor :charge_number

    attr_accessor :credit_memo_item_id
    ...
    def self.swagger_types
      {
        :'amount' => :'Float',
        :'apply_to_charge_number' => :'String',
        :'breakdown_details' => :'Array<BreakdownDetail>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'applyToChargeNumber')
        self.apply_to_charge_number = attributes[:'applyToChargeNumber']
      end

      if attributes.has_key?(:'breakdownDetails')
        if (value = attributes[:'breakdownDetails']).is_a?(Array)
          self.breakdown_details = value
        end
      end
      ...
      if attributes.has_key?(:'creditMemoItemId')
        self.credit_memo_item_id = attributes[:'creditMemoItemId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount == o.amount &&
          apply_to_charge_number == o.apply_to_charge_number &&
          breakdown_details == o.breakdown_details &&
          charge_number == o.charge_number &&
          credit_memo_item_id == o.credit_memo_item_id &&
          end_date == o.end_date &&
    ...
    def hash
      [amount, apply_to_charge_number, breakdown_details, charge_number, credit_memo_item_id, end_date, start_date, subscription_number].hash
    end
