...
module SwaggerClient
  ...
  class GETAccountSummaryPaymentInvoiceType
    ...
    attr_accessor :applied_payment_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appliedPaymentAmount')
        self.applied_payment_amount = attributes[:'appliedPaymentAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          applied_payment_amount == o.applied_payment_amount &&
    ...
    def hash
      [applied_payment_amount, invoice_id, invoice_number].hash
    end
