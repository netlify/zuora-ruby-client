...
module SwaggerClient
  ...
  class GETCreditMemoItemPartsCollectionType
    ...
    def self.swagger_types
      {
        :'item_parts' => :'Array<GETCreditMemoItemPartTypewithSuccess>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'itemParts')
        if (value = attributes[:'itemParts']).is_a?(Array)
          self.item_parts = value
        end
      end
    ...
    def hash
      [item_parts, next_page, success].hash
    end
