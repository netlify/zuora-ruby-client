...
module SwaggerClient
  ...
  class SubscribeRequestSubscriptionData
    ...
    def list_invalid_properties
      ...
      if @rate_plan_data.nil?
        invalid_properties.push("invalid value for 'rate_plan_data', rate_plan_data cannot be nil.")
      end
    ...
    def valid?
      return false if @rate_plan_data.nil?
    ...
    def hash
      [rate_plan_data, subscription].hash
    end
