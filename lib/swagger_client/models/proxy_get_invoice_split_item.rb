...
module SwaggerClient
  ...
  class ProxyGetInvoiceSplitItem
    ...
    attr_accessor :invoice_split_id
    ...
    attr_accessor :split_percentage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InvoiceSplitId')
        self.invoice_split_id = attributes[:'InvoiceSplitId']
      end
      ...
      if attributes.has_key?(:'SplitPercentage')
        self.split_percentage = attributes[:'SplitPercentage']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invoice_split_id == o.invoice_split_id &&
          payment_term == o.payment_term &&
          split_percentage == o.split_percentage &&
    ...
    def hash
      [created_by_id, created_date, id, invoice_date, invoice_id, invoice_split_id, payment_term, split_percentage, updated_by_id, updated_date].hash
    end
