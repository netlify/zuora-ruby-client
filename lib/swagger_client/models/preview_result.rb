...
module SwaggerClient
  ...
  class PreviewResult
    ...
    def self.swagger_types
      {
        :'charge_metrics' => :'Array<PreviewResultChargeMetrics>',
        :'credit_memos' => :'Array<PreviewResultCreditMemos>',
        :'invoices' => :'Array<PreviewResultInvoices>',
        :'order_metrics' => :'Array<PreviewResultOrderMetrics>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeMetrics')
        if (value = attributes[:'chargeMetrics']).is_a?(Array)
          self.charge_metrics = value
        end
      end

      if attributes.has_key?(:'creditMemos')
        if (value = attributes[:'creditMemos']).is_a?(Array)
          self.credit_memos = value
        end
      end
      ...
      if attributes.has_key?(:'orderMetrics')
        if (value = attributes[:'orderMetrics']).is_a?(Array)
          self.order_metrics = value
        end
      end
    ...
    def hash
      [charge_metrics, credit_memos, invoices, order_metrics].hash
    end
