...
module SwaggerClient
  ...
  class CreditMemoFromChargeDetailType
    ...
    attr_accessor :memo_item_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memoItemAmount')
        self.memo_item_amount = attributes[:'memoItemAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          memo_item_amount == o.memo_item_amount &&
    ...
    def hash
      [charge_id, comment, finance_information, memo_item_amount, service_end_date, service_start_date].hash
    end
