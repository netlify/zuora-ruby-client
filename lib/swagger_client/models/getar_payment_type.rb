...
module SwaggerClient
  ...
  class GETARPaymentType
    ...
    attr_accessor :credit_balance_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditBalanceAmount')
        self.credit_balance_amount = attributes[:'creditBalanceAmount']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["Draft", "Processing", "Processed", "Error", "Canceled", "Posted"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Draft", "Processing", "Processed", "Error", "Canceled", "Posted"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_balance_amount == o.credit_balance_amount &&
          currency == o.currency &&
    ...
    def hash
      [account_id, amount, applied_amount, auth_transaction_id, bank_identification_number, cancelled_on, comment, created_by_id, created_date, credit_balance_amount, currency, custom_field__c, effective_date, finance_information, gateway_id, gateway_order_id, gateway_response, gateway_response_code, gateway_state, id, marked_for_submission_on, number, payment_method_id, payment_method_snapshot_id, reference_id, refund_amount, second_payment_reference_id, settled_on, soft_descriptor, soft_descriptor_phone, status, submitted_on, success, type, unapplied_amount, updated_by_id, updated_date].hash
    end
