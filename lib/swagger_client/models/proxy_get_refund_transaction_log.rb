...
module SwaggerClient
  ...
  class ProxyGetRefundTransactionLog
    ...
    def hash
      [batch_id, gateway, gateway_reason_code, gateway_reason_code_description, gateway_state, gateway_transaction_type, id, refund_id, request_string, response_string, transaction_date, transaction_id].hash
    end
