...
module SwaggerClient
  ...
  class GETDebitMemoItemTypeFinanceInformation
    ...
    def hash
      [deferred_revenue_accounting_code, deferred_revenue_accounting_code_type, recognized_revenue_accounting_code, recognized_revenue_accounting_code_type, revenue_recognition_rule_name, revenue_schedule_number].hash
    end
