...
module SwaggerClient
  ...
  class GETBillingDocumentsResponseType
    ...
    def valid?
      document_type_validator = EnumAttributeValidator.new('String', ["Invoice", "CreditMemo", "DebitMemo"])
    ...
    def document_type=(document_type)
      validator = EnumAttributeValidator.new('String', ["Invoice", "CreditMemo", "DebitMemo"])
    ...
    def hash
      [account_id, amount, balance, document_date, document_number, document_type, id, status].hash
    end
