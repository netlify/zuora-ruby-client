...
module SwaggerClient
  ...
  class RecurringPerUnitPricingOverride
    ...
    def valid?
      ...
      list_price_base_validator = EnumAttributeValidator.new('String', ["Per_Billing_Period", "Per_Month", "Per_Week"])
      return false unless list_price_base_validator.valid?(@list_price_base)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] list_price_base Object to be assigned
    def list_price_base=(list_price_base)
      validator = EnumAttributeValidator.new('String', ["Per_Billing_Period", "Per_Month", "Per_Week"])
      unless validator.valid?(list_price_base)
        fail ArgumentError, "invalid value for 'list_price_base', must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [price_change_option, price_increase_percentage, list_price, list_price_base, quantity].hash
    end
