...
module SwaggerClient
  ...
  class SubscriptionRatedResult
    # The amount changes per regular charge, or per regular charge and the discount charge if there is discount charge.
    attr_accessor :charge_rated_results
    ...
    def self.swagger_types
      {
        :'charge_rated_results' => :'Array<ChargeRatedResult>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeRatedResults')
        if (value = attributes[:'chargeRatedResults']).is_a?(Array)
          self.charge_rated_results = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          charge_rated_results == o.charge_rated_results &&
    ...
    def hash
      [charge_rated_results, subscription_number].hash
    end
