...
module SwaggerClient
  ...
  class PUTSrpUpdateType
    ...
    attr_accessor :charge_update_details
    ...
    def self.swagger_types
      {
        :'charge_update_details' => :'Array<PUTScUpdateType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeUpdateDetails')
        if (value = attributes[:'chargeUpdateDetails']).is_a?(Array)
          self.charge_update_details = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @rate_plan_id.nil?
        invalid_properties.push("invalid value for 'rate_plan_id', rate_plan_id cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @rate_plan_id.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          charge_update_details == o.charge_update_details &&
    ...
    def hash
      [charge_update_details, contract_effective_date, custom_field__c, customer_acceptance_date, rate_plan_id, service_activation_date, specific_update_date].hash
    end
