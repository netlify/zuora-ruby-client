...
module SwaggerClient
  ...
  class GETCalloutHistoryVOsType
    ...
    attr_accessor :callout_histories
    ...
    def self.swagger_types
      {
        :'callout_histories' => :'Array<GETCalloutHistoryVOType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'calloutHistories')
        if (value = attributes[:'calloutHistories']).is_a?(Array)
          self.callout_histories = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          callout_histories == o.callout_histories &&
    ...
    def hash
      [callout_histories, next_page, success].hash
    end
