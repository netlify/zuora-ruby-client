...
module SwaggerClient
  ...
  class POSTInvoiceCollectCreditMemosType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memoAmount')
        self.memo_amount = attributes[:'memoAmount']
      end

      if attributes.has_key?(:'memoNumber')
        self.memo_number = attributes[:'memoNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          memo_amount == o.memo_amount &&
          memo_number == o.memo_number
    end
    ...
    def hash
      [id, memo_amount, memo_number].hash
    end
