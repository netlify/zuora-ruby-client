...
module SwaggerClient
  ...
  class GETRSDetailForProductChargeType
    ...
    attr_accessor :linked_transaction_number
    ...
    attr_accessor :linked_transaction_type
    ...
    attr_accessor :product_charge_id

    # The name of the recognition rule. 
    attr_accessor :recognition_rule_name

    # The revenue that was distributed in a closed accounting period. 
    attr_accessor :recognized_revenue
    ...
    def self.swagger_types
      {
        ...
        :'reference_id' => :'String',
        :'revenue_items' => :'Array<GETRsRevenueItemType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customFieldsValues')
        self.custom_fields_values = attributes[:'customFieldsValues']
      end

      if attributes.has_key?(:'linkedTransactionId')
        self.linked_transaction_id = attributes[:'linkedTransactionId']
      end

      if attributes.has_key?(:'linkedTransactionNumber')
        self.linked_transaction_number = attributes[:'linkedTransactionNumber']
      end

      if attributes.has_key?(:'linkedTransactionType')
        self.linked_transaction_type = attributes[:'linkedTransactionType']
      end
      ...
      if attributes.has_key?(:'productChargeId')
        self.product_charge_id = attributes[:'productChargeId']
      end

      if attributes.has_key?(:'recognitionRuleName')
        self.recognition_rule_name = attributes[:'recognitionRuleName']
      end

      if attributes.has_key?(:'recognizedRevenue')
        self.recognized_revenue = attributes[:'recognizedRevenue']
      end
      ...
      if attributes.has_key?(:'revenueItems')
        if (value = attributes[:'revenueItems']).is_a?(Array)
      ...
      if attributes.has_key?(:'undistributedUnrecognizedRevenue')
        self.undistributed_unrecognized_revenue = attributes[:'undistributedUnrecognizedRevenue']
      end

      if attributes.has_key?(:'unrecognizedRevenue')
        self.unrecognized_revenue = attributes[:'unrecognizedRevenue']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          currency == o.currency &&
          custom_fields_values == o.custom_fields_values &&
          linked_transaction_id == o.linked_transaction_id &&
          linked_transaction_number == o.linked_transaction_number &&
          linked_transaction_type == o.linked_transaction_type &&
          notes == o.notes &&
          number == o.number &&
          product_charge_id == o.product_charge_id &&
          recognition_rule_name == o.recognition_rule_name &&
          recognized_revenue == o.recognized_revenue &&
          reference_id == o.reference_id &&
          revenue_items == o.revenue_items &&
          revenue_schedule_date == o.revenue_schedule_date &&
          undistributed_unrecognized_revenue == o.undistributed_unrecognized_revenue &&
          unrecognized_revenue == o.unrecognized_revenue &&
    ...
    def hash
      [account_id, amount, created_on, currency, custom_fields_values, linked_transaction_id, linked_transaction_number, linked_transaction_type, notes, number, product_charge_id, recognition_rule_name, recognized_revenue, reference_id, revenue_items, revenue_schedule_date, undistributed_unrecognized_revenue, unrecognized_revenue, updated_on].hash
    end
