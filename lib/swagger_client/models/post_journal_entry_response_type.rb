...
module SwaggerClient
  ...
  class POSTJournalEntryResponseType
    ...
    attr_accessor :journal_entry_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'journalEntryNumber')
        self.journal_entry_number = attributes[:'journalEntryNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          journal_entry_number == o.journal_entry_number &&
          success == o.success
    end
    ...
    def hash
      [journal_entry_number, success].hash
    end
