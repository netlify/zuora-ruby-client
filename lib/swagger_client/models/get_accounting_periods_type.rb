...
module SwaggerClient
  ...
  class GETAccountingPeriodsType
    ...
    attr_accessor :accounting_periods
    ...
    def self.swagger_types
      {
        :'accounting_periods' => :'Array<GETAccountingPeriodWithoutSuccessType>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingPeriods')
        if (value = attributes[:'accountingPeriods']).is_a?(Array)
          self.accounting_periods = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounting_periods == o.accounting_periods &&
    ...
    def hash
      [accounting_periods, next_page, success].hash
    end
