...
module SwaggerClient
  ...
  class GETInvoiceFileType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pdfFileUrl')
        self.pdf_file_url = attributes[:'pdfFileUrl']
      end
    ...
    def hash
      [id, pdf_file_url, version_number].hash
    end
