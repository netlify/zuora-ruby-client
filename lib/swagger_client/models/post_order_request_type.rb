...
module SwaggerClient
  ...
  class POSTOrderRequestType
    ...
    # The account number that this order will be created under. It can be either the accountNumber or the account info provided. It will return an error if both are specified. Note that the invoice owner account of the subscriptions included in this order should be the same with order's account. 
    attr_accessor :existing_account_number

    attr_accessor :new_account

    # The date when the order is signed. All the order actions under this order will use this order date as the contract effective date.
    ...
    def self.swagger_types
      {
        ...
        :'order_number' => :'String',
        :'processing_options' => :'ProcessingOptions',
        :'subscriptions' => :'Array<POSTOrderRequestTypeSubscriptions>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'existingAccountNumber')
        self.existing_account_number = attributes[:'existingAccountNumber']
      end

      if attributes.has_key?(:'newAccount')
        self.new_account = attributes[:'newAccount']
      end
    ...
    def list_invalid_properties
      ...
      if !@existing_account_number.nil? && @existing_account_number.to_s.length > 70
        invalid_properties.push("invalid value for 'existing_account_number', the character length must be smaller than or equal to 70.")
      end
    ...
    def valid?
      return false if !@existing_account_number.nil? && @existing_account_number.to_s.length > 70
    ...
    # @param [Object] existing_account_number Value to be assigned
    def existing_account_number=(existing_account_number)

      if !existing_account_number.nil? && existing_account_number.to_s.length > 70
        fail ArgumentError, "invalid value for 'existing_account_number', the character length must be smaller than or equal to 70."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          existing_account_number == o.existing_account_number &&
          new_account == o.new_account &&
    ...
    def hash
      [custom_fields, existing_account_number, new_account, order_date, order_number, processing_options, subscriptions].hash
    end
