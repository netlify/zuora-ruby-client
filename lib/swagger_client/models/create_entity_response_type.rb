...
module SwaggerClient
  ...
  class CreateEntityResponseType
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["Provisioned", "Unprovisioned"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Provisioned", "Unprovisioned"])
    ...
    def hash
      [display_name, id, locale, name, parent_id, status, success, tenant_id, timezone].hash
    end
