...
module SwaggerClient
  ...
  class POSTEntityConnectionsType
    ...
    attr_accessor :target_entity_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'targetEntityId')
        self.target_entity_id = attributes[:'targetEntityId']
      end
    ...
    def list_invalid_properties
      ...
      if @target_entity_id.nil?
        invalid_properties.push("invalid value for 'target_entity_id', target_entity_id cannot be nil.")
      end

      if @target_entity_id.to_s.length > 32
        invalid_properties.push("invalid value for 'target_entity_id', the character length must be smaller than or equal to 32.")
      end
    ...
    def valid?
      return false if @target_entity_id.nil?
      return false if @target_entity_id.to_s.length > 32
      return true
    end

    # Custom attribute writer method with validation
    # @param [Object] target_entity_id Value to be assigned
    def target_entity_id=(target_entity_id)
      if target_entity_id.nil?
        fail ArgumentError, "target_entity_id cannot be nil"
      end

      if target_entity_id.to_s.length > 32
        fail ArgumentError, "invalid value for 'target_entity_id', the character length must be smaller than or equal to 32."
      end
