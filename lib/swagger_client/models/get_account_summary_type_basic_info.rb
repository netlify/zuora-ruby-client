...
module SwaggerClient
  ...
  class GETAccountSummaryTypeBasicInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastPaymentAmount')
        self.last_payment_amount = attributes[:'lastPaymentAmount']
      end
    ...
    def hash
      [account_number, additional_email_addresses, balance, batch, bill_cycle_day, currency, custom_field__c, default_payment_method, id, invoice_delivery_prefs_email, invoice_delivery_prefs_print, last_invoice_date, last_payment_amount, last_payment_date, name, status, tags].hash
    end
