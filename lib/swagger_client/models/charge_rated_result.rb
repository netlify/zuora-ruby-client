...
module SwaggerClient
  ...
  class ChargeRatedResult
    # The regular charge number that this discount charge is applied to.
    attr_accessor :applied_to_charge_number

    attr_accessor :charge_number

    # The amount changes per date duration.
    attr_accessor :rated_items
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ratedItems')
        if (value = attributes[:'ratedItems']).is_a?(Array)
          self.rated_items = value
        end
      end
    ...
    def hash
      [applied_to_charge_number, charge_number, rated_items].hash
    end
