...
module SwaggerClient
  ...
  class PricingUpdate
    ...
    def hash
      [discount, recurring_flat_fee, recurring_per_unit, recurring_tiered, recurring_volume, usage_flat_fee, usage_overage, usage_per_unit, usage_tiered, usage_tiered_with_overage, usage_volume].hash
    end
