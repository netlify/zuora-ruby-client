...
module SwaggerClient
  ...
  class FinanceInformation
    ...
    def hash
      [custom_field__c, deferred_revenue_accounting_code, deferred_revenue_accounting_code_type, recognized_revenue_accounting_code, recognized_revenue_accounting_code_type].hash
    end
