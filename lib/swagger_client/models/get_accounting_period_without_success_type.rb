...
module SwaggerClient
  ...
  class GETAccountingPeriodWithoutSuccessType
    ...
    def hash
      [created_by, created_on, custom_field__c, end_date, file_ids, fiscal_year, fiscal_quarter, id, name, notes, run_trial_balance_end, run_trial_balance_error_message, run_trial_balance_start, run_trial_balance_status, start_date, status, updated_by, updated_on].hash
    end
