...
module SwaggerClient
  ...
  class AmendmentRatePlanData
    ...
    # 
    attr_accessor :rate_plan_charge_data

    attr_accessor :subscription_product_feature_list
    ...
    def self.swagger_types
      {
        :'rate_plan' => :'RatePlan',
        :'rate_plan_charge_data' => :'Array<RatePlanChargeDataInRatePlanData>',
        :'subscription_product_feature_list' => :'SubscriptionProductFeatureList'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RatePlan')
        self.rate_plan = attributes[:'RatePlan']
      end

      if attributes.has_key?(:'RatePlanChargeData')
        if (value = attributes[:'RatePlanChargeData']).is_a?(Array)
          self.rate_plan_charge_data = value
        end
      end

      if attributes.has_key?(:'SubscriptionProductFeatureList')
        self.subscription_product_feature_list = attributes[:'SubscriptionProductFeatureList']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rate_plan_charge_data == o.rate_plan_charge_data &&
          subscription_product_feature_list == o.subscription_product_feature_list
    end
    ...
    def hash
      [rate_plan, rate_plan_charge_data, subscription_product_feature_list].hash
    end
