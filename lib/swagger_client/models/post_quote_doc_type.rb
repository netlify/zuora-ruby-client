...
module SwaggerClient
  ...
  class POSTQuoteDocType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'apiuser')
        self.apiuser = attributes[:'apiuser']
      end
      ...
      if attributes.has_key?(:'useSFDCLocale')
        self.use_sfdc_locale = attributes[:'useSFDCLocale']
      end
      ...
      if attributes.has_key?(:'zquotesMajorVersion')
        self.zquotes_major_version = attributes[:'zquotesMajorVersion']
      end

      if attributes.has_key?(:'zquotesMinorVersion')
        self.zquotes_minor_version = attributes[:'zquotesMinorVersion']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          token == o.token &&
          use_sfdc_locale == o.use_sfdc_locale &&
          username == o.username &&
          zquotes_major_version == o.zquotes_major_version &&
          zquotes_minor_version == o.zquotes_minor_version
    end
    ...
    def hash
      [apiuser, document_type, locale, password, quote_id, sandbox, server_url, session_id, template_id, token, use_sfdc_locale, username, zquotes_major_version, zquotes_minor_version].hash
    end
