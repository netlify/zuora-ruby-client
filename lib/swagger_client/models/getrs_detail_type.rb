...
module SwaggerClient
  ...
  class GETRSDetailType
    ...
    def hash
      [account_id, amount, created_on, currency, custom_field__c, linked_transaction_id, linked_transaction_number, linked_transaction_type, notes, number, recognition_rule_name, recognized_revenue, reference_id, revenue_items, revenue_schedule_date, subscription_charge_id, subscription_id, success, undistributed_unrecognized_revenue, unrecognized_revenue, updated_on].hash
    end
