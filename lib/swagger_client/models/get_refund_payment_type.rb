...
module SwaggerClient
  ...
  class GETRefundPaymentType
    ...
    attr_accessor :marked_for_submission_on
    ...
    attr_accessor :payment_method_snapshot_id
    ...
    attr_accessor :refund_transaction_time
    ...
    attr_accessor :second_refund_reference_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditMemoId')
        self.credit_memo_id = attributes[:'creditMemoId']
      end
      ...
      if attributes.has_key?(:'gatewayId')
      ...
      if attributes.has_key?(:'markedForSubmissionOn')
        self.marked_for_submission_on = attributes[:'markedForSubmissionOn']
      end

      if attributes.has_key?(:'methodType')
      ...
      if attributes.has_key?(:'paymentMethodSnapshotId')
        self.payment_method_snapshot_id = attributes[:'paymentMethodSnapshotId']
      end
      ...
      if attributes.has_key?(:'refundTransactionTime')
        self.refund_transaction_time = attributes[:'refundTransactionTime']
      end

      if attributes.has_key?(:'secondRefundReferenceId')
        self.second_refund_reference_id = attributes[:'secondRefundReferenceId']
      end

      if attributes.has_key?(:'settledOn')
        self.settled_on = attributes[:'settledOn']
      end
      ...
      if attributes.has_key?(:'submittedOn')
        self.submitted_on = attributes[:'submittedOn']
      end
    ...
    def valid?
      ...
      method_type_validator = EnumAttributeValidator.new('String', ["ACH", "Cash", "Check", "CreditCard", "PayPal", "WireTransfer", "DebitCard", "CreditCardReferenceTransaction", "BankTransfer", "Other"])
      return false unless method_type_validator.valid?(@method_type)
      status_validator = EnumAttributeValidator.new('String', ["Processed", "Canceled", "Error", "Processing"])
    ...
    def method_type=(method_type)
      validator = EnumAttributeValidator.new('String', ["ACH", "Cash", "Check", "CreditCard", "PayPal", "WireTransfer", "DebitCard", "CreditCardReferenceTransaction", "BankTransfer", "Other"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Processed", "Canceled", "Error", "Processing"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_memo_id == o.credit_memo_id &&
          ...
          id == o.id &&
          marked_for_submission_on == o.marked_for_submission_on &&
          method_type == o.method_type &&
          number == o.number &&
          payment_id == o.payment_id &&
          payment_method_id == o.payment_method_id &&
          payment_method_snapshot_id == o.payment_method_snapshot_id &&
          reason_code == o.reason_code &&
          reference_id == o.reference_id &&
          refund_date == o.refund_date &&
          refund_transaction_time == o.refund_transaction_time &&
          second_refund_reference_id == o.second_refund_reference_id &&
    ...
    def hash
      [account_id, amount, cancelled_on, comment, created_by_id, created_date, credit_memo_id, custom_field__c, finance_information, gateway_id, gateway_response, gateway_response_code, gateway_state, id, marked_for_submission_on, method_type, number, payment_id, payment_method_id, payment_method_snapshot_id, reason_code, reference_id, refund_date, refund_transaction_time, second_refund_reference_id, settled_on, soft_descriptor, soft_descriptor_phone, status, submitted_on, success, type, updated_by_id, updated_date].hash
    end
