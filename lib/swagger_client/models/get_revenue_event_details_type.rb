...
module SwaggerClient
  ...
  class GETRevenueEventDetailsType
    ...
    attr_accessor :revenue_event_details
    ...
    def self.swagger_types
      {
        :'next_page' => :'String',
        :'revenue_event_details' => :'Array<GETRevenueEventDetailWithoutSuccessType>',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'revenueEventDetails')
        if (value = attributes[:'revenueEventDetails']).is_a?(Array)
          self.revenue_event_details = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          revenue_event_details == o.revenue_event_details &&
          success == o.success
    end
    ...
    def hash
      [next_page, revenue_event_details, success].hash
    end
