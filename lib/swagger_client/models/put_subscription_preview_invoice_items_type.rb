...
module SwaggerClient
  ...
  class PUTSubscriptionPreviewInvoiceItemsType
    ...
    def hash
      [charge_amount, charge_description, charge_name, product_name, product_rate_plan_charge_id, quantity, service_end_date, service_start_date, unit_of_measure].hash
    end
