...
module SwaggerClient
  ...
  class TriggerParams
    # The date when this price charge becomes active and billing starts. Required when the triggerEvent is 'SpecificDate'.
    attr_accessor :specific_trigger_date

    # The event that triggers the subscription.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'specificTriggerDate')
        self.specific_trigger_date = attributes[:'specificTriggerDate']
      end
    ...
    def valid?
      trigger_event_validator = EnumAttributeValidator.new('String', ["ContractEffective", "ServiceActivation", "CustomerAcceptance", "SpecificDate"])
    ...
    def trigger_event=(trigger_event)
      validator = EnumAttributeValidator.new('String', ["ContractEffective", "ServiceActivation", "CustomerAcceptance", "SpecificDate"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          specific_trigger_date == o.specific_trigger_date &&
    ...
    def hash
      [specific_trigger_date, trigger_event].hash
    end
