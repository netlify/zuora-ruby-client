  ...
  class GETAccountingPeriodType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fileIds')
        self.file_ids = attributes[:'fileIds']
      end

      if attributes.has_key?(:'fiscalYear')
        self.fiscal_year = attributes[:'fiscalYear']
      end
      ...
      if attributes.has_key?(:'runTrialBalanceEnd')
        self.run_trial_balance_end = attributes[:'runTrialBalanceEnd']
      end

      if attributes.has_key?(:'runTrialBalanceErrorMessage')
        self.run_trial_balance_error_message = attributes[:'runTrialBalanceErrorMessage']
      end

      if attributes.has_key?(:'runTrialBalanceStart')
        self.run_trial_balance_start = attributes[:'runTrialBalanceStart']
      end

      if attributes.has_key?(:'runTrialBalanceStatus')
        self.run_trial_balance_status = attributes[:'runTrialBalanceStatus']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          notes == o.notes &&
          run_trial_balance_end == o.run_trial_balance_end &&
          run_trial_balance_error_message == o.run_trial_balance_error_message &&
          run_trial_balance_start == o.run_trial_balance_start &&
          run_trial_balance_status == o.run_trial_balance_status &&
    ...
    def hash
      [created_by, created_on, custom_field__c, end_date, file_ids, fiscal_year, fiscal_quarter, id, name, notes, run_trial_balance_end, run_trial_balance_error_message, run_trial_balance_start, run_trial_balance_status, start_date, status, success, updated_by, updated_on].hash
    end
