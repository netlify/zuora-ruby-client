...
module SwaggerClient
  ...
  class ProxyGetCreditBalanceAdjustment
    ...
    # 
    attr_accessor :integration_id__ns

    # 
    attr_accessor :integration_status__ns
    ...
    attr_accessor :source_transaction_number
    ...
    attr_accessor :source_transaction_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdjustmentDate')
        self.adjustment_date = attributes[:'AdjustmentDate']
      end
      ...
      if attributes.has_key?(:'IntegrationId__NS')
        self.integration_id__ns = attributes[:'IntegrationId__NS']
      end

      if attributes.has_key?(:'IntegrationStatus__NS')
        self.integration_status__ns = attributes[:'IntegrationStatus__NS']
      end
      ...
      if attributes.has_key?(:'SourceTransactionId')
        self.source_transaction_id = attributes[:'SourceTransactionId']
      end

      if attributes.has_key?(:'SourceTransactionNumber')
        self.source_transaction_number = attributes[:'SourceTransactionNumber']
      end

      if attributes.has_key?(:'SourceTransactionType')
        self.source_transaction_type = attributes[:'SourceTransactionType']
      end
      ...
      if attributes.has_key?(:'SyncDate__NS')
        self.sync_date__ns = attributes[:'SyncDate__NS']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          integration_id__ns == o.integration_id__ns &&
          integration_status__ns == o.integration_status__ns &&
          number == o.number &&
          reason_code == o.reason_code &&
          reference_id == o.reference_id &&
          source_transaction_id == o.source_transaction_id &&
          source_transaction_number == o.source_transaction_number &&
          source_transaction_type == o.source_transaction_type &&
          status == o.status &&
          sync_date__ns == o.sync_date__ns &&
    ...
    def hash
      [account_id, accounting_code, adjustment_date, amount, cancelled_on, comment, created_by_id, created_date, id, integration_id__ns, integration_status__ns, number, reason_code, reference_id, source_transaction_id, source_transaction_number, source_transaction_type, status, sync_date__ns, transferred_to_accounting, type, updated_by_id, updated_date].hash
    end
