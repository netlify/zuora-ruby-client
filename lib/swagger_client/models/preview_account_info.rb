...
module SwaggerClient
  # The account info required for an order preview.
  class PreviewAccountInfo
    ...
    def list_invalid_properties
      ...
      if @sold_to_contact.nil?
        invalid_properties.push("invalid value for 'sold_to_contact', sold_to_contact cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @sold_to_contact.nil?
      return true
    end
    ...
    def hash
      [bill_cycle_day, currency, custom_fields, sold_to_contact].hash
    end
