...
module SwaggerClient
  ...
  class GETJournalEntriesInJournalRunType
    ...
    def self.swagger_types
      {
        :'journal_entries' => :'Array<GETJournalEntryDetailTypeWithoutSuccess>',
        :'next_page' => :'String',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'journalEntries')
        if (value = attributes[:'journalEntries']).is_a?(Array)
          self.journal_entries = value
        end
      end
    ...
    def hash
      [journal_entries, next_page, success].hash
    end
