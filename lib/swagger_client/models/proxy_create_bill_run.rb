...
module SwaggerClient
  ...
  class ProxyCreateBillRun
    # ID of the account used for single account bill run.  This field is only required if you create ad hoc bill run for a single customer account.  **Character limit:** 32 
    ...
    # Batch of accounts for this bill run.   When creating ad hoc bill run for multiple customer accounts, this field is only required if the `BillCycleDay`  field is not specified.  **Character limit:** 20  **Values:** AllBatches or Batchn where n is a number between 1 and 50. 
    attr_accessor :batch

    # The day of the bill cycle.  When creating ad hoc bill run for multiple customer accounts, this field is only required if the `Batch` field is not specified.  **Character limit:** 32  **Values:** `AllBillCycleDays` or 01 - 31. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ChargeTypeToExclude')
        self.charge_type_to_exclude = attributes[:'ChargeTypeToExclude']
      end
      ...
      if attributes.has_key?(:'NoEmailForZeroAmountInvoice')
        ...
        self.no_email_for_zero_amount_invoice = false
      end
    ...
    def list_invalid_properties
      ...
      if @target_date.nil?
        invalid_properties.push("invalid value for 'target_date', target_date cannot be nil.")
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          charge_type_to_exclude == o.charge_type_to_exclude &&
    ...
    def hash
      [account_id, auto_email, auto_post, auto_renewal, batch, bill_cycle_day, charge_type_to_exclude, invoice_date, no_email_for_zero_amount_invoice, target_date].hash
    end
