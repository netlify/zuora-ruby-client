...
module SwaggerClient
  ...
  class SubscribeRequestSubscribeOptionsSubscribeInvoiceProcessingOptions
    ...
    # 
    attr_accessor :invoice_processing_scope
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InvoiceProcessingScope')
        self.invoice_processing_scope = attributes[:'InvoiceProcessingScope']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invoice_processing_scope == o.invoice_processing_scope &&
    ...
    def hash
      [invoice_date, invoice_processing_scope, invoice_target_date].hash
    end
