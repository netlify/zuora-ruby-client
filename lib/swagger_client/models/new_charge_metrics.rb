...
module SwaggerClient
  ...
  class NewChargeMetrics
    ...
    # 
    attr_accessor :original_rate_plan_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DMRR')
        self.dmrr = attributes[:'DMRR']
      end
      ...
      if attributes.has_key?(:'OriginalRatePlanId')
        self.original_rate_plan_id = attributes[:'OriginalRatePlanId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          original_rate_plan_id == o.original_rate_plan_id &&
    ...
    def hash
      [charge_number, dmrr, dtcv, mrr, original_id, original_rate_plan_id, product_rate_plan_charge_id, product_rate_plan_id, tcv].hash
    end
