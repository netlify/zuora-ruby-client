...
module SwaggerClient
  ...
  class GETChargeRSDetailType
    ...
    def self.swagger_types
      {
        ...
        :'revenue_items' => :'Array<GETRevenueItemType>',
    ...
    def hash
      [account_id, amount, currency, notes, number, recognition_rule_name, recognized_revenue, revenue_items, subscription_charge_id, subscription_id, success, undistributed_unrecognized_revenue, unrecognized_revenue].hash
    end
