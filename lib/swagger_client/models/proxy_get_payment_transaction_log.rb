...
module SwaggerClient
  ...
  class ProxyGetPaymentTransactionLog
    ...
    attr_accessor :gateway_transaction_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AVSResponseCode')
        self.avs_response_code = attributes[:'AVSResponseCode']
      end
      ...
      if attributes.has_key?(:'CVVResponseCode')
        self.cvv_response_code = attributes[:'CVVResponseCode']
      end
      ...
      if attributes.has_key?(:'GatewayReasonCode')
        self.gateway_reason_code = attributes[:'GatewayReasonCode']
      end

      if attributes.has_key?(:'GatewayReasonCodeDescription')
        self.gateway_reason_code_description = attributes[:'GatewayReasonCodeDescription']
      end
      ...
      if attributes.has_key?(:'GatewayTransactionType')
        self.gateway_transaction_type = attributes[:'GatewayTransactionType']
      end
      ...
      if attributes.has_key?(:'RequestString')
        self.request_string = attributes[:'RequestString']
      end

      if attributes.has_key?(:'ResponseString')
        self.response_string = attributes[:'ResponseString']
      end
    ...
    def valid?
      ...
      gateway_transaction_type_validator = EnumAttributeValidator.new('String', ["Authorization", "Sale", "Void", "Inquiry", "VoidAuth"])
      return false unless gateway_transaction_type_validator.valid?(@gateway_transaction_type)
      return true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] gateway_transaction_type Object to be assigned
    def gateway_transaction_type=(gateway_transaction_type)
      validator = EnumAttributeValidator.new('String', ["Authorization", "Sale", "Void", "Inquiry", "VoidAuth"])
      unless validator.valid?(gateway_transaction_type)
        fail ArgumentError, "invalid value for 'gateway_transaction_type', must be one of #{validator.allowable_values}."
      end
      @gateway_transaction_type = gateway_transaction_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          avs_response_code == o.avs_response_code &&
          batch_id == o.batch_id &&
          cvv_response_code == o.cvv_response_code &&
          gateway == o.gateway &&
          gateway_reason_code == o.gateway_reason_code &&
          gateway_reason_code_description == o.gateway_reason_code_description &&
          gateway_state == o.gateway_state &&
          gateway_transaction_type == o.gateway_transaction_type &&
          id == o.id &&
          payment_id == o.payment_id &&
          request_string == o.request_string &&
          response_string == o.response_string &&
    ...
    def hash
      [avs_response_code, batch_id, cvv_response_code, gateway, gateway_reason_code, gateway_reason_code_description, gateway_state, gateway_transaction_type, id, payment_id, request_string, response_string, transaction_date, transaction_id].hash
    end
