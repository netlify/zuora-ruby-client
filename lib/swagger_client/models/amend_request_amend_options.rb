...
module SwaggerClient
  ...
  class AmendRequestAmendOptions
    ...
    attr_accessor :invoice_processing_options
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InvoiceProcessingOptions')
        self.invoice_processing_options = attributes[:'InvoiceProcessingOptions']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invoice_processing_options == o.invoice_processing_options &&
    ...
    def hash
      [apply_credit_balance, electronic_payment_options, external_payment_options, generate_invoice, invoice_processing_options, process_payments].hash
    end
