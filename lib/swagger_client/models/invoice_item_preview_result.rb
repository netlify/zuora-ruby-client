...
module SwaggerClient
  ...
  class InvoiceItemPreviewResult
    ...
    attr_accessor :applied_to_charge_number
    ...
    def self.swagger_types
      {
        ...
        :'applied_to_charge_number' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appliedToChargeNumber')
        self.applied_to_charge_number = attributes[:'appliedToChargeNumber']
      end
    ...
    def valid?
      processing_type_validator = EnumAttributeValidator.new('String', ["Charge", "Discount", "Tax"])
    ...
    def processing_type=(processing_type)
      validator = EnumAttributeValidator.new('String', ["Charge", "Discount", "Tax"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          applied_to_charge_number == o.applied_to_charge_number &&
    ...
    def hash
      [additional_info, amount_without_tax, applied_to_charge_number, charge_description, charge_name, charge_number, processing_type, product_name, product_rate_plan_charge_id, service_end_date, service_start_date, subscription_number, tax_amount].hash
    end
