...
module SwaggerClient
  ...
  class GetHostedPageType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pageVersion')
        self.page_version = attributes[:'pageVersion']
      end
    ...
    def hash
      [page_id, page_name, page_type, page_version].hash
    end
