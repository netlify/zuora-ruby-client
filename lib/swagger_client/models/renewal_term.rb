...
module SwaggerClient
  # The term of renewal.  1. The startDate is not required for renewal terms. The default is the endDate of the previous term. 2. Use the endDate or the period to specify the length of the term. 
  class RenewalTerm
    # Specify only when the renewalSetting is 'RENEW_WITH_SPECIFIC_TERM'.
