...
module SwaggerClient
  ...
  class ProxyGetExport
    ...
    attr_accessor :convert_to_currencies
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ConvertToCurrencies')
        self.convert_to_currencies = attributes[:'ConvertToCurrencies']
      end
    ...
    def valid?
      format_validator = EnumAttributeValidator.new('String', ["csv", "html", "Excel"])
    ...
    def format=(format)
      validator = EnumAttributeValidator.new('String', ["csv", "html", "Excel"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          convert_to_currencies == o.convert_to_currencies &&
    ...
    def hash
      [convert_to_currencies, created_by_id, created_date, encrypted, file_id, format, id, name, query, size, status, status_reason, updated_by_id, updated_date, zip].hash
    end
