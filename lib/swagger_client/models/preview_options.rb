...
module SwaggerClient
  ...
  class PreviewOptions
    # The options on how the preview through date is calculated. Available for preview only. The 'TermEnd' option is invalid when any subscription included in this order is evergreen.    If set the value of this field to 'SpecificDate', you must specify a specific date in the 'specificPreviewThruDate' field. 
    attr_accessor :preview_thru_type

    attr_accessor :preview_types
    ...
    attr_accessor :specific_preview_thru_date
    ...
    def self.swagger_types
      {
        :'preview_thru_type' => :'String',
        :'preview_types' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previewThruType')
        self.preview_thru_type = attributes[:'previewThruType']
      end

      if attributes.has_key?(:'previewTypes')
        if (value = attributes[:'previewTypes']).is_a?(Array)
          self.preview_types = value
        end
      end

      if attributes.has_key?(:'specificPreviewThruDate')
        self.specific_preview_thru_date = attributes[:'specificPreviewThruDate']
      end
    ...
    def valid?
      preview_thru_type_validator = EnumAttributeValidator.new('String', ["SpecificDate", "TermEnd"])
      return false unless preview_thru_type_validator.valid?(@preview_thru_type)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] preview_thru_type Object to be assigned
    def preview_thru_type=(preview_thru_type)
      validator = EnumAttributeValidator.new('String', ["SpecificDate", "TermEnd"])
      unless validator.valid?(preview_thru_type)
        fail ArgumentError, "invalid value for 'preview_thru_type', must be one of #{validator.allowable_values}."
      end
      @preview_thru_type = preview_thru_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          preview_thru_type == o.preview_thru_type &&
          preview_types == o.preview_types &&
          specific_preview_thru_date == o.specific_preview_thru_date
    end
    ...
    def hash
      [preview_thru_type, preview_types, specific_preview_thru_date].hash
    end
