...
module SwaggerClient
  ...
  class GETDMTaxItemType
    ...
    attr_accessor :source_tax_item_id
    ...
    attr_accessor :tax_code_description
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sourceTaxItemId')
        self.source_tax_item_id = attributes[:'sourceTaxItemId']
      end
      ...
      if attributes.has_key?(:'taxCodeDescription')
        self.tax_code_description = attributes[:'taxCodeDescription']
      end

      if attributes.has_key?(:'taxDate')
        self.tax_date = attributes[:'taxDate']
      end
      ...
      if attributes.has_key?(:'taxRateDescription')
        self.tax_rate_description = attributes[:'taxRateDescription']
      end

      if attributes.has_key?(:'taxRateType')
        self.tax_rate_type = attributes[:'taxRateType']
      end
    ...
    def valid?
      tax_rate_type_validator = EnumAttributeValidator.new('String', ["Percentage", "FlatFee"])
      return false unless tax_rate_type_validator.valid?(@tax_rate_type)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] tax_rate_type Object to be assigned
    def tax_rate_type=(tax_rate_type)
      validator = EnumAttributeValidator.new('String', ["Percentage", "FlatFee"])
      unless validator.valid?(tax_rate_type)
        fail ArgumentError, "invalid value for 'tax_rate_type', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_tax_item_id == o.source_tax_item_id &&
          tax_amount == o.tax_amount &&
          tax_code == o.tax_code &&
          tax_code_description == o.tax_code_description &&
          tax_date == o.tax_date &&
          tax_rate == o.tax_rate &&
          tax_rate_description == o.tax_rate_description &&
    ...
    def hash
      [applied_amount, credit_amount, exempt_amount, finance_information, id, jurisdiction, location_code, name, payment_amount, refund_amount, source_tax_item_id, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type, unapplied_amount].hash
    end
