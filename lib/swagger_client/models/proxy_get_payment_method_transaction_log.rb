...
module SwaggerClient
  ...
  class ProxyGetPaymentMethodTransactionLog
    ...
    def hash
      [gateway, gateway_reason_code, gateway_reason_code_description, gateway_transaction_type, id, payment_method_id, payment_method_type, request_string, response_string, transaction_date, transaction_id].hash
    end
