...
module SwaggerClient
  ...
  class ProxyCreateProduct
    ...
    attr_accessor :allow_feature_changes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AllowFeatureChanges')
        self.allow_feature_changes = attributes[:'AllowFeatureChanges']
      end
    ...
    def list_invalid_properties
      ...
      if @effective_end_date.nil?
        invalid_properties.push("invalid value for 'effective_end_date', effective_end_date cannot be nil.")
      end

      if @effective_start_date.nil?
        invalid_properties.push("invalid value for 'effective_start_date', effective_start_date cannot be nil.")
      end
    ...
    def valid?
      return false if @effective_end_date.nil?
      return false if @effective_start_date.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_feature_changes == o.allow_feature_changes &&
          category == o.category &&
    ...
    def hash
      [allow_feature_changes, category, description, effective_end_date, effective_start_date, name, sku].hash
    end
