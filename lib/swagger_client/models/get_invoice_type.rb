...
module SwaggerClient
  ...
  class GETInvoiceType
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'invoice_date' => :'Date',
        :'invoice_files' => :'Array<GETInvoiceFileType>',
        :'invoice_items' => :'Array<GETInvoicesInvoiceItemType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invoiceFiles')
        if (value = attributes[:'invoiceFiles']).is_a?(Array)
          self.invoice_files = value
        end
      end
    ...
    def hash
      [account_id, account_name, account_number, amount, balance, body, created_by, credit_balance_adjustment_amount, custom_field__c, due_date, id, invoice_date, invoice_files, invoice_items, invoice_number, invoice_target_date, status].hash
    end
