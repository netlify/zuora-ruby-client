...
module SwaggerClient
  ...
  class PostBillingPreviewRunParam
    ...
    def list_invalid_properties
      ...
      if !@batch.nil? && @batch.to_s.length > 255
        invalid_properties.push("invalid value for 'batch', the character length must be smaller than or equal to 255.")
      end
    ...
    def valid?
      return false if !@batch.nil? && @batch.to_s.length > 255
    ...
    def batch=(batch)
      ...
      if !batch.nil? && batch.to_s.length > 255
        fail ArgumentError, "invalid value for 'batch', the character length must be smaller than or equal to 255."
      end
    ...
    def hash
      [assume_renewal, batch, charge_type_to_exclude, including_evergreen_subscription, target_date].hash
    end
