...
module SwaggerClient
  ...
  class ProxyGetTaxationItem
    ...
    def hash
      [accounting_code, created_by_id, created_date, exempt_amount, id, invoice_item_id, jurisdiction, location_code, name, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type, updated_by_id, updated_date].hash
    end
