...
module SwaggerClient
  ...
  class POSTBillingPreviewInvoiceItem
    ...
    def hash
      [charge_amount, charge_date, charge_description, charge_id, charge_name, charge_number, charge_type, id, processing_type, product_name, quantity, service_end_date, service_start_date, subscription_id, subscription_name, subscription_number, tax_amount, unit_of_measure].hash
    end
