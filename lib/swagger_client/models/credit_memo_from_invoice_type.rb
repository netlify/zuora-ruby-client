...
module SwaggerClient
  ...
  class CreditMemoFromInvoiceType
    ...
    attr_accessor :auto_apply_to_invoice_upon_posting
    ...
    attr_accessor :tax_auto_calculation
    ...
    def self.swagger_types
      {
        :'auto_apply_to_invoice_upon_posting' => :'BOOLEAN',
        :'comment' => :'String',
        :'custom_field__c' => :'String',
        :'effective_date' => :'Date',
        :'exclude_from_auto_apply_rules' => :'BOOLEAN',
        :'invoice_id' => :'String',
        :'items' => :'Array<CreditMemoItemFromInvoiceItemType>',
        :'reason_code' => :'String',
        :'tax_auto_calculation' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'autoApplyToInvoiceUponPosting')
        self.auto_apply_to_invoice_upon_posting = attributes[:'autoApplyToInvoiceUponPosting']
      end
      ...
      if attributes.has_key?(:'taxAutoCalculation')
        self.tax_auto_calculation = attributes[:'taxAutoCalculation']
      else
        self.tax_auto_calculation = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          auto_apply_to_invoice_upon_posting == o.auto_apply_to_invoice_upon_posting &&
          comment == o.comment &&
          ...
          tax_auto_calculation == o.tax_auto_calculation
    end
    ...
    def hash
      [auto_apply_to_invoice_upon_posting, comment, custom_field__c, effective_date, exclude_from_auto_apply_rules, invoice_id, items, reason_code, tax_auto_calculation].hash
    end
