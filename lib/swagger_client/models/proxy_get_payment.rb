...
module SwaggerClient
  ...
  class ProxyGetPayment
    ...
    def valid?
      ...
      transferred_to_accounting_validator = EnumAttributeValidator.new('String', ["Processing", "Error", "Ignore"])
    ...
    def transferred_to_accounting=(transferred_to_accounting)
      validator = EnumAttributeValidator.new('String', ["Processing", "Error", "Ignore"])
