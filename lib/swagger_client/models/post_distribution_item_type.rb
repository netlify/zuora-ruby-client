...
module SwaggerClient
  ...
  class POSTDistributionItemType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'newAmount')
        self.new_amount = attributes[:'newAmount']
      end
    ...
    def list_invalid_properties
      ...
      if @new_amount.nil?
        invalid_properties.push("invalid value for 'new_amount', new_amount cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @new_amount.nil?
      return true
    end
    ...
    def hash
      [accounting_period_name, new_amount].hash
    end
