...
module SwaggerClient
  ...
  class GETCalloutHistoryVOType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attemptedNum')
        self.attempted_num = attributes[:'attemptedNum']
      end
      ...
      if attributes.has_key?(:'eventCategory')
        self.event_category = attributes[:'eventCategory']
      end
      ...
      if attributes.has_key?(:'requestMethod')
        self.request_method = attributes[:'requestMethod']
      end
      ...
      if attributes.has_key?(:'responseContent')
        self.response_content = attributes[:'responseContent']
      end
    ...
    def hash
      [attempted_num, create_time, event_category, event_context, notification, request_method, request_url, response_code, response_content].hash
    end
