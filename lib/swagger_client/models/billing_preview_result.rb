...
module SwaggerClient
  ...
  class BillingPreviewResult
    ...
    attr_accessor :credit_memo_items
    ...
    def self.swagger_types
      {
        :'account_id' => :'String',
        :'credit_memo_items' => :'Array<POSTBillingPreviewCreditMemoItem>',
        :'invoice_items' => :'Array<POSTBillingPreviewInvoiceItem>',
        :'success' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditMemoItems')
        if (value = attributes[:'creditMemoItems']).is_a?(Array)
          self.credit_memo_items = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_memo_items == o.credit_memo_items &&
    ...
    def hash
      [account_id, credit_memo_items, invoice_items, success].hash
    end
