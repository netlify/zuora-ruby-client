...
module SwaggerClient
  ...
  class POSTOrderPreviewRequestType
    ...
    def self.swagger_types
      {
        ...
        :'preview_account_info' => :'PreviewAccountInfo',
        :'preview_options' => :'PreviewOptions',
        :'subscriptions' => :'Array<POSTOrderPreviewRequestTypeSubscriptions>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previewOptions')
        self.preview_options = attributes[:'previewOptions']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          preview_options == o.preview_options &&
    ...
    def hash
      [custom_fields, existing_account_number, order_date, order_number, preview_account_info, preview_options, subscriptions].hash
    end
