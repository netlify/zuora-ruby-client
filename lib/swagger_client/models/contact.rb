...
module SwaggerClient
  ...
  class Contact
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'otherPhoneType')
        self.other_phone_type = attributes[:'otherPhoneType']
      end
      ...
      if attributes.has_key?(:'taxRegion')
        self.tax_region = attributes[:'taxRegion']
      end
    ...
    def list_invalid_properties
      ...
      if !@fax.nil? && @fax.to_s.length > 40
        invalid_properties.push("invalid value for 'fax', the character length must be smaller than or equal to 40.")
      end
      ...
      if !@home_phone.nil? && @home_phone.to_s.length > 40
        invalid_properties.push("invalid value for 'home_phone', the character length must be smaller than or equal to 40.")
      end
      ...
      if !@mobile_phone.nil? && @mobile_phone.to_s.length > 40
        invalid_properties.push("invalid value for 'mobile_phone', the character length must be smaller than or equal to 40.")
      end

      if !@nickname.nil? && @nickname.to_s.length > 100
        invalid_properties.push("invalid value for 'nickname', the character length must be smaller than or equal to 100.")
      end

      if !@other_phone.nil? && @other_phone.to_s.length > 40
        invalid_properties.push("invalid value for 'other_phone', the character length must be smaller than or equal to 40.")
      end

      if !@personal_email.nil? && @personal_email.to_s.length > 80
        invalid_properties.push("invalid value for 'personal_email', the character length must be smaller than or equal to 80.")
      end
      ...
      if !@state.nil? && @state.to_s.length > 40
        invalid_properties.push("invalid value for 'state', the character length must be smaller than or equal to 40.")
      end

      if !@tax_region.nil? && @tax_region.to_s.length > 32
        invalid_properties.push("invalid value for 'tax_region', the character length must be smaller than or equal to 32.")
      end

      if !@work_email.nil? && @work_email.to_s.length > 80
        invalid_properties.push("invalid value for 'work_email', the character length must be smaller than or equal to 80.")
      end

      if !@work_phone.nil? && @work_phone.to_s.length > 40
        invalid_properties.push("invalid value for 'work_phone', the character length must be smaller than or equal to 40.")
      end
    ...
    def valid?
      ...
      return false if !@fax.nil? && @fax.to_s.length > 40
      return false if @first_name.nil?
      return false if @first_name.to_s.length > 100
      return false if !@home_phone.nil? && @home_phone.to_s.length > 40
      return false if @last_name.nil?
      return false if @last_name.to_s.length > 100
      return false if !@mobile_phone.nil? && @mobile_phone.to_s.length > 40
      return false if !@nickname.nil? && @nickname.to_s.length > 100
      return false if !@other_phone.nil? && @other_phone.to_s.length > 40
      other_phone_type_validator = EnumAttributeValidator.new('String', ["Work", "Mobile", "Home", "Other"])
      return false unless other_phone_type_validator.valid?(@other_phone_type)
      return false if !@personal_email.nil? && @personal_email.to_s.length > 80
      return false if !@postal_code.nil? && @postal_code.to_s.length > 20
      return false if !@state.nil? && @state.to_s.length > 40
      return false if !@tax_region.nil? && @tax_region.to_s.length > 32
      return false if !@work_email.nil? && @work_email.to_s.length > 80
      return false if !@work_phone.nil? && @work_phone.to_s.length > 40
      return true
    end
    ...
    def fax=(fax)
      ...
      if !fax.nil? && fax.to_s.length > 40
        fail ArgumentError, "invalid value for 'fax', the character length must be smaller than or equal to 40."
      end
    ...
    def home_phone=(home_phone)
      ...
      if !home_phone.nil? && home_phone.to_s.length > 40
        fail ArgumentError, "invalid value for 'home_phone', the character length must be smaller than or equal to 40."
      end
    ...
    def mobile_phone=(mobile_phone)
      ...
      if !mobile_phone.nil? && mobile_phone.to_s.length > 40
        fail ArgumentError, "invalid value for 'mobile_phone', the character length must be smaller than or equal to 40."
      end
    ...
    def nickname=(nickname)
      ...
      if !nickname.nil? && nickname.to_s.length > 100
        fail ArgumentError, "invalid value for 'nickname', the character length must be smaller than or equal to 100."
      end
    ...
    def other_phone=(other_phone)
      ...
      if !other_phone.nil? && other_phone.to_s.length > 40
        fail ArgumentError, "invalid value for 'other_phone', the character length must be smaller than or equal to 40."
      end
    ...
    # @param [Object] other_phone_type Object to be assigned
    def other_phone_type=(other_phone_type)
      validator = EnumAttributeValidator.new('String', ["Work", "Mobile", "Home", "Other"])
      unless validator.valid?(other_phone_type)
        fail ArgumentError, "invalid value for 'other_phone_type', must be one of #{validator.allowable_values}."
      end
    ...
    def personal_email=(personal_email)
      ...
      if !personal_email.nil? && personal_email.to_s.length > 80
        fail ArgumentError, "invalid value for 'personal_email', the character length must be smaller than or equal to 80."
      end
    ...
    def state=(state)
      ...
      if !state.nil? && state.to_s.length > 40
        fail ArgumentError, "invalid value for 'state', the character length must be smaller than or equal to 40."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] tax_region Value to be assigned
    def tax_region=(tax_region)

      if !tax_region.nil? && tax_region.to_s.length > 32
        fail ArgumentError, "invalid value for 'tax_region', the character length must be smaller than or equal to 32."
      end
    ...
    def work_email=(work_email)
      ...
      if !work_email.nil? && work_email.to_s.length > 80
        fail ArgumentError, "invalid value for 'work_email', the character length must be smaller than or equal to 80."
      end
    ...
    def work_phone=(work_phone)
      ...
      if !work_phone.nil? && work_phone.to_s.length > 40
        fail ArgumentError, "invalid value for 'work_phone', the character length must be smaller than or equal to 40."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          other_phone_type == o.other_phone_type &&
    ...
    def hash
      [address1, address2, city, country, county, fax, first_name, home_phone, last_name, mobile_phone, nickname, other_phone, other_phone_type, personal_email, postal_code, state, tax_region, work_email, work_phone].hash
    end
