...
module SwaggerClient
  ...
  class GETProductRatePlanType
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'name' => :'String',
        :'product_rate_plan_charges' => :'Array<GETProductRatePlanChargeType>',
        :'status' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productRatePlanCharges')
        if (value = attributes[:'productRatePlanCharges']).is_a?(Array)
          self.product_rate_plan_charges = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          name == o.name &&
          product_rate_plan_charges == o.product_rate_plan_charges &&
          status == o.status
    end
    ...
    def hash
      [custom_field__c, description, effective_end_date, effective_start_date, id, name, product_rate_plan_charges, status].hash
    end
