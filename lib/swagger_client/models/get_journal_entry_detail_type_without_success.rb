...
module SwaggerClient
  ...
  class GETJournalEntryDetailTypeWithoutSuccess
    ...
    def hash
      [accounting_period_name, aggregate_currency, currency, custom_field__c, home_currency, journal_entry_date, journal_entry_items, notes, number, segments, status, time_period_end, time_period_start, transaction_type, transfer_date_time, transferred_by, transferred_to_accounting].hash
    end
