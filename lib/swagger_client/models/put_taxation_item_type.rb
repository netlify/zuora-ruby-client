...
module SwaggerClient
  ...
  class PUTTaxationItemType
    ...
    def hash
      [exempt_amount, finance_information, jurisdiction, location_code, name, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type].hash
    end
