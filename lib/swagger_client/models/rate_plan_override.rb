...
module SwaggerClient
  # The JSON object containing the information related to the 'AddProduct' type of request.
  class RatePlanOverride
    attr_accessor :charge_overrides
    ...
    def self.swagger_types
      {
        :'charge_overrides' => :'Array<ChargeOverride>',
        :'custom_fields' => :'CustomFields',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeOverrides')
        if (value = attributes[:'chargeOverrides']).is_a?(Array)
          self.charge_overrides = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          charge_overrides == o.charge_overrides &&
    ...
    def hash
      [charge_overrides, custom_fields, product_rate_plan_id, unique_token].hash
    end
