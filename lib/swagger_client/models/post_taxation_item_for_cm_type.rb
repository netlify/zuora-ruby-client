...
module SwaggerClient
  ...
  class POSTTaxationItemForCMType
    ...
    def hash
      [exempt_amount, finance_information, jurisdiction, location_code, memo_item_id, name, source_tax_item_id, tax_amount, tax_code, tax_code_description, tax_date, tax_rate, tax_rate_description, tax_rate_type].hash
    end
