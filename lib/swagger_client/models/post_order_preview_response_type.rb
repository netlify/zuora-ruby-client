...
module SwaggerClient
  ...
  class PostOrderPreviewResponseType
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previewResult')
        self.preview_result = attributes[:'previewResult']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          preview_result == o.preview_result
    end
